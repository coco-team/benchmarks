...
and ((if ((pre V158_c) >= 9) then (not B0) else true) = (pre V169_Sofar)) 
and ((pre V169_Sofar) = (V47_ast or (pre V169_Sofar))) 
...
and ((V156_H0 and V157_H1) = V47_ast) 
...
and ((V156_H0 and V157_H1) => V156_H0) 
...
and ((V156_H0 and V157_H1) => V157_H1) 
...
and ((if B0 then ((pre V158_c) - 1) else (pre V158_c)) <=(pre V158_c)) 
and (0 <=(pre V39_nB1)) 
and (0 <=(pre V40_nS)) 
and (0 <=V38_nB0) 
and (0 <=V40_nS) 
...
and ((if ((pre V44_avance1) and V44_avance1) then (if B1 then ((pre V159_c) - 1) else (pre V159_c)) else 0) <=0) 
and (0 <=(pre V38_nB0)) 
and ((pre V38_nB0) <=(if B0 then ((pre V38_nB0) + 1) else (pre V38_nB0))) 
and ((if B0 then ((pre V38_nB0) + 1) else (pre V38_nB0)) <=((pre V38_nB0) + 1)) 
