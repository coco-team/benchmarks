...
and (((((((((not e1) and (not e2)) and (not e3)) and (not e4)) and e5) and (not e6)) and (not e7)) and (not e8)) => (((not e1) and (not e2)) and (not e3))) 
...
and ((((((pre V51_shared) - 1) + (pre V50_exclusive)) - 1) + 1) <=((pre V51_shared) + (pre V50_exclusive))) 
and (((pre V51_shared) + (pre V50_exclusive)) <=(((pre V51_shared) + (pre V50_exclusive)) + 1)) 
and (((pre V51_shared) - 1) <=(((((pre V51_shared) - 1) + (pre V50_exclusive)) - 1) + 1)) 
and ((((((pre V51_shared) - 1) + (pre V50_exclusive)) - 1) + 1) <=((pre V51_shared) + (pre V50_exclusive))) 
and (((pre V51_shared) + (pre V50_exclusive)) <=(((pre V51_shared) + (pre V50_exclusive)) + 1)) 
