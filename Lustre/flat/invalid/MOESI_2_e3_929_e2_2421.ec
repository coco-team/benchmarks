...
and ((((pre V35_shared_mo) - 1) + (pre V34_exclusive_mo)) <=((pre V35_shared_mo) - (pre V37_owned_mo))) 
...
and ((if V83_garde_mo1 then ((((pre V35_shared_mo) - 1) + (pre V34_exclusive_mo)) + 1) else (pre V35_shared_mo)) <=(if V85_garde_mo3 then 1 else (pre V34_exclusive_mo))) 
