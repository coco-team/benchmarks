...
let
  OK = ((V169_Sofar => true) -> ((((pre V38_nB0) - 1) - (pre V39_nB1)) <= 30));
...
and (true = (if ((pre V158_c) >= 9) then (not B0) else true)) 
...
and (((pre V44_avance1) and V44_avance1) => V157_H1) 
and ((if (not (pre V44_avance1)) then (V42_diff1 >= 10) else (V42_diff1 > 0)) => V157_H1) 
...
and ((V47_ast and (pre V169_Sofar)) => V47_ast) 
...
and ((not (pre V46_retard1)) => V157_H1) 
...
and ((pre V158_c) = (if ((pre V43_avance0) and V43_avance0) then (if B0 then (((pre V158_c) - 1) + 1) else (pre V158_c)) else 0)) 
and ((if ((pre V43_avance0) and V43_avance0) then (if B0 then (((pre V158_c) - 1) + 1) else (pre V158_c)) else 0) = (((pre V159_c) - 1) + 1)) 
and ((((pre V159_c) - 1) + 1) = (if ((pre V44_avance1) and V44_avance1) then (if B1 then (((pre V159_c) - 1) + 1) else (pre V159_c)) else 0)) 
and ((if ((pre V44_avance1) and V44_avance1) then (if B1 then (((pre V159_c) - 1) + 1) else (pre V159_c)) else 0) = (pre V159_c)) 
and ((pre V159_c) = (if B1 then (((pre V159_c) - 1) + 1) else (pre V159_c))) 
and ((if B1 then (((pre V159_c) - 1) + 1) else (pre V159_c)) = 0) 
and (0 = (((pre V158_c) - 1) + 1)) 
and ((((pre V158_c) - 1) + 1) = (if B0 then (((pre V158_c) - 1) + 1) else (pre V158_c))) 
and ((V38_nB0 - V40_nS) = V41_diff0) 
and (((pre V158_c) - 1) <=(pre V158_c)) 
and (((pre V158_c) - 1) <=(pre V40_nS)) 
and (((pre V158_c) - 1) <=(pre V39_nB1)) 
and (((pre V158_c) - 1) <=V39_nB1) 
and (((pre V158_c) - 1) <=(if B1 then ((pre V39_nB1) + 1) else (pre V39_nB1))) 
and (((pre V158_c) - 1) <=V40_nS) 
and (((pre V158_c) - 1) <=(if S then ((pre V40_nS) + 1) else (pre V40_nS))) 
and (((pre V158_c) - 1) <=V38_nB0) 
and (((pre V158_c) - 1) <=1) 
and (((pre V158_c) - 1) <=((pre V40_nS) + 1)) 
and (((pre V158_c) - 1) <=((pre V39_nB1) + 1)) 
and (((pre V158_c) - 1) <=9) 
and (((pre V158_c) - 1) <=10) 
and (((pre V158_c) - 1) <=30) 
and ((pre V158_c) <=(pre V38_nB0)) 
and ((pre V158_c) <=(pre V39_nB1)) 
and ((pre V158_c) <=V39_nB1) 
and ((pre V158_c) <=(if B1 then ((pre V39_nB1) + 1) else (pre V39_nB1))) 
and ((pre V158_c) <=V40_nS) 
and ((pre V158_c) <=V38_nB0) 
and ((pre V158_c) <=(if B0 then ((pre V38_nB0) + 1) else (pre V38_nB0))) 
and ((pre V158_c) <=1) 
and ((pre V158_c) <=((pre V38_nB0) + 1)) 
and ((pre V158_c) <=((pre V39_nB1) + 1)) 
and ((pre V158_c) <=9) 
and ((pre V158_c) <=10) 
and ((pre V158_c) <=30) 
and (1 <=((pre V38_nB0) + 1)) 
...
and ((((pre V38_nB0) - 1) - (pre V39_nB1)) <=((pre V38_nB0) - 1)) 
and (((pre V38_nB0) - 1) <=(pre V38_nB0)) 
and ((pre V38_nB0) <=(if B0 then ((pre V38_nB0) + 1) else (pre V38_nB0))) 
and ((if B0 then ((pre V38_nB0) + 1) else (pre V38_nB0)) <=((pre V38_nB0) + 1)) 
