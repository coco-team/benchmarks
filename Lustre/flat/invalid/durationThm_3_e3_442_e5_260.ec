...
and ((((pre V68_age_of_p) - 1) - 1) = (((pre V43_age_of_p) - 1) - 1)) 
...
and ((((pre V68_age_of_p) - 1) - 1) <=(if (pre p) then (((pre V68_age_of_p) - 1) - 1) else 0)) 
and ((((pre V68_age_of_p) - 1) - 1) <=V43_age_of_p) 
and ((((pre V50_age_of_p) - 1) - 1) <=(if (pre q) then (((pre V50_age_of_p) - 1) - 1) else 0)) 
and ((((pre V50_age_of_p) - 1) - 1) <=V50_age_of_p) 
and ((((pre V68_age_of_p) - 1) - 1) <=((pre V43_age_of_p) - 1)) 
and (((pre V43_age_of_p) - 1) <=(pre V43_age_of_p)) 
and ((pre V43_age_of_p) <=0) 
and (0 <=1) 
and ((((pre V50_age_of_p) - 1) - 1) <=((pre V50_age_of_p) - 1)) 
...
and (V43_age_of_p <=0) 
and (0 <=1) 
and ((if (pre q) then (((pre V50_age_of_p) - 1) - 1) else 0) <=V50_age_of_p) 
and (V50_age_of_p <=0) 
and (0 <=1) 
and  true ));
tel.
