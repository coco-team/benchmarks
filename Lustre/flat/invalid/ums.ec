...
-- 390 implications. 
assert (true -> (((not (V48_do_AB and V49_do_BC)) = (V56_env => (((V50_no_collision and V51_exclusive_req) and V52_no_derail_AB) and V53_no_derail_BC))) 
and ((V56_env => (((V50_no_collision and V51_exclusive_req) and V52_no_derail_AB) and V53_no_derail_BC)) = ((not V46_grant_access) or V54_empty_section)) 
and (((not V46_grant_access) or V54_empty_section) = true) 
and (true = V50_no_collision) 
and (V50_no_collision = (V50_no_collision and V51_exclusive_req)) 
and ((V50_no_collision and V51_exclusive_req) = V51_exclusive_req) 
...
and (V246_X = (not on_A)) 
and ((not V54_empty_section) = V208_X) 
and (V208_X = ((on_A or on_B) or on_C)) 
...
and ((V191_alwaysBsinceA or V193_onceCsinceA) = ((not V189_afterA) or (V191_alwaysBsinceA or V193_onceCsinceA))) 
...
and ((V323_alwaysBsinceA or V325_onceCsinceA) = ((not V321_afterA) or (V323_alwaysBsinceA or V325_onceCsinceA))) 
and (((not V321_afterA) or (V323_alwaysBsinceA or V325_onceCsinceA)) = V53_no_derail_BC) 
...
and (V56_env = (V284_X and (pre V56_env))) 
and ((V284_X and (pre V56_env)) = (pre V56_env)) 
...
and ((pre V324_afterA) => (pre V203_afterA)) 
...
and ((pre V47_grant_exit) => (not (V208_X and (not (pre V208_X))))) 
and ((pre V47_grant_exit) => (V55_only_on_B or (pre V313_onceCsinceA))) 
...
and (V323_alwaysBsinceA => (V323_alwaysBsinceA or V325_onceCsinceA)) 
...
and ((V180_empty_section and ack_AB) => (V191_alwaysBsinceA or V193_onceCsinceA)) 
...
and (((not ack_AB) and V180_empty_section) => ((not (on_C and (not (pre on_C)))) or (pre V47_grant_exit))) 
...
and (V54_empty_section => ((not (on_C and (not (pre on_C)))) or (pre V47_grant_exit))) 
...
and ((pre V246_X) => ((not (V246_X and (not (pre V246_X)))) or on_B)) 
...
and (on_B => ((not (V246_X and (not (pre V246_X)))) or on_B)) 
and (on_B => (not V46_grant_access)) 
and (on_B => ((not (V265_X and (not (pre V265_X)))) or (on_A or on_C))) 
...
and (((not (ack_AB and ack_BC)) and ((not V189_afterA) or (V191_alwaysBsinceA or V193_onceCsinceA))) => (V191_alwaysBsinceA or V193_onceCsinceA)) 
...
and ((pre V206_onceCsinceA) => (V323_alwaysBsinceA or V325_onceCsinceA)) 
and ((pre V206_onceCsinceA) => (V204_alwaysBsinceA or V206_onceCsinceA)) 
and ((if V205_afterA then (V48_do_AB or (pre V206_onceCsinceA)) else true) => (V323_alwaysBsinceA or V325_onceCsinceA)) 
...
and ((pre V325_onceCsinceA) => (V323_alwaysBsinceA or V325_onceCsinceA)) 
and ((if V324_afterA then (V54_empty_section or (pre V325_onceCsinceA)) else true) => (V323_alwaysBsinceA or V325_onceCsinceA)) 
...
and ((ack_AB and (pre V311_alwaysBsinceA)) => V311_alwaysBsinceA) 
and ((ack_AB and (pre V311_alwaysBsinceA)) => V191_alwaysBsinceA) 
and (ack_AB => V191_alwaysBsinceA) 
and (on_C => (not V46_grant_access)) 
and (on_C => ((not (V265_X and (not (pre V265_X)))) or (on_A or on_C))) 
and ((on_C and (not (pre on_C))) => (not (pre on_C))) 
and (on_C => (on_A or on_C)) 
and (on_C => (not V54_empty_section)) 
and ((((not (ack_AB and ack_BC)) and ((not V189_afterA) or (V191_alwaysBsinceA or V193_onceCsinceA))) and ((not V202_afterA) or (V204_alwaysBsinceA or V206_onceCsinceA))) => (not (ack_AB and ack_BC))) 
...
and ((((not (ack_AB and ack_BC)) and ((not V189_afterA) or (V191_alwaysBsinceA or V193_onceCsinceA))) and ((not V202_afterA) or (V204_alwaysBsinceA or V206_onceCsinceA))) => (V191_alwaysBsinceA or V193_onceCsinceA)) 
and ((pre ack_BC) => (pre V204_alwaysBsinceA)) 
and ((not (on_A or on_C)) => (not (on_C and (not (pre on_C))))) 
and ((((V50_no_collision and V51_exclusive_req) and V52_no_derail_AB) and V53_no_derail_BC) => (V323_alwaysBsinceA or V325_onceCsinceA)) 
and (V181_only_on_B => ((not (V246_X and (not (pre V246_X)))) or on_B)) 
and (V181_only_on_B => (not V46_grant_access)) 
and (V181_only_on_B => ((not (V265_X and (not (pre V265_X)))) or (on_A or on_C))) 
and (V181_only_on_B => ((not (on_C and (not (pre on_C)))) or (pre V47_grant_exit))) 
and (V181_only_on_B => (not (V265_X and (not (pre V265_X))))) 
and (V181_only_on_B => on_B) 
and (V181_only_on_B => (not (on_C and (not (pre on_C))))) 
and (V47_grant_exit => ((not (on_C and (not (pre on_C)))) or (pre V47_grant_exit))) 
and (V47_grant_exit => on_B) 
and (V47_grant_exit => (on_A or on_B)) 
and (V47_grant_exit => ((not (V246_X and (not (pre V246_X)))) or on_B)) 
and (V47_grant_exit => (not V54_empty_section)) 
...
and ((on_A or on_C) => (not V46_grant_access)) 
and ((on_A or on_C) => ((not (V265_X and (not (pre V265_X)))) or (on_A or on_C))) 
...
and ((ack_BC and (pre V323_alwaysBsinceA)) => V204_alwaysBsinceA) 
...
and (V49_do_BC => (not (on_A or on_C))) 
...
and ((pre on_C) => ((not (on_C and (not (pre on_C)))) or (pre V47_grant_exit))) 
...
and ((not (pre V265_X)) => ((not (V208_X and (not (pre V208_X)))) or (pre V46_grant_access))) 
...
and (on_A => ((not (V246_X and (not (pre V246_X)))) or on_B)) 
and (on_A => (not V46_grant_access)) 
...
and (V54_empty_section => (V323_alwaysBsinceA or V325_onceCsinceA)) 
...
and (((((((((not (ack_AB and ack_BC)) and ((not V189_afterA) or (V191_alwaysBsinceA or V193_onceCsinceA))) and ((not V202_afterA) or (V204_alwaysBsinceA or V206_onceCsinceA))) and true) and ((not (V208_X and (not (pre V208_X)))) or (pre V46_grant_access))) and ((not (on_C and (not (pre on_C)))) or (pre V47_grant_exit))) and ((not (V246_X and (not (pre V246_X)))) or on_B)) and ((not (V265_X and (not (pre V265_X)))) or (on_A or on_C))) => ((not (V246_X and (not (pre V246_X)))) or on_B)) 
...
and ((pre V193_onceCsinceA) => (V55_only_on_B or (pre V313_onceCsinceA))) 
and ((pre V193_onceCsinceA) => (pre V313_onceCsinceA)) 
and ((pre V46_grant_access) => ((not (V265_X and (not (pre V265_X)))) or (on_A or on_C))) 
...
and ((pre V193_onceCsinceA) => ((not V309_afterA) or (V311_alwaysBsinceA or V313_onceCsinceA))) 
and ((pre V193_onceCsinceA) => (V191_alwaysBsinceA or V193_onceCsinceA)) 
...
and ((if V192_afterA then (V49_do_BC or (pre V193_onceCsinceA)) else true) => (V191_alwaysBsinceA or V193_onceCsinceA)) 
