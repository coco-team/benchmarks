...
let
  ...
  V36_env = (V102_X -> (V102_X or (pre V36_env)));
...
and (V36_env => (V102_X or (pre V36_env))) 
and ((V32_modified_me < 0) => V36_env) 
and ((V32_modified_me < 0) => (pre V36_env)) 
...
and ((pre V36_env) => (V102_X or (pre V36_env))) 
and ((V35_invalid_me < 0) => V36_env) 
and (((pre V33_exclusive_me) >= 1) => (V102_X or (pre V36_env))) 
...
and (((pre V33_exclusive_me) >= 1) => (pre V36_env)) 
