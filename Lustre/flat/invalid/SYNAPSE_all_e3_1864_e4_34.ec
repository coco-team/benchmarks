...
and ((if V80_garde_s3 then 0 else (pre V31_valid_s)) <=(if V79_garde_s2 then 1 else (pre V32_dirty_s))) 
and ((if V80_garde_s3 then 0 else (pre V31_valid_s)) <=1) 
and ((if V80_garde_s3 then 0 else (pre V31_valid_s)) <=2) 
