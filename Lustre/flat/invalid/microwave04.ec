...
var
  ...
  V136_p36: bool;
  V137_p37: bool;
  V138_rltTruncByConv: bool;

let
  OK = ((V94_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT >= 0
  ) and (V94_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT <= 
  256));
...
-- 1128 implications. 
assert (true -> ((((V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root >= 1) and (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root <= 3)) = ((V94_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT >= 0) and (V94_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT <= 256))) 
and (((V94_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT >= 0) and (V94_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT <= 256)) = true) 
and (true = ((V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root >= 1) and (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root <= 3))) 
and (((V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root >= 1) and (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root <= 3)) = (V94_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT <= 256)) 
and ((V94_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT <= 256) = (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root >= 1)) 
...
and ((V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root <= 3) = (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root >= 1)) 
and ((V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root >= 1) = (V94_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT >= 0)) 
and ((V94_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT >= 0) = (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root <= 3)) 
...
and (DOOR_CLOSED = (((V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root >= 1) and (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root <= 3)) and (if (not (V49_chart_microwave_mode_logic_door_closed = 0)) then true else false))) 
...
and ((not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) = (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3)) 
and ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3) = (V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root <= 3)) 
...
and (((V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root >= 1) and (V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root <= 3)) = (not V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock)) 
...
and ((if true then false else (pre V86_chart_microwave_mode_logic_rlt_evtInitStep)) = V69_rlt_eval_microwave_mode_logic_ON_rlt_fired_6) 
...
and (V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 => V61_rlt_eval_microwave_mode_logic_ON_rlt_complete_2) 
and (V86_chart_microwave_mode_logic_rlt_evtInitStep => (not V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1)) 
and ((((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2) and (V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining <= 0)) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2)) => (V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root >= 1)) 
...
and (V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 => (V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root = 3)) 
...
and (V77_rlt_enter_microwave_mode_logic_ON_rlt_fired_2 => (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3))) 
...
and (V77_rlt_enter_microwave_mode_logic_ON_rlt_fired_2 => (not (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root = 2))) 
and (V77_rlt_enter_microwave_mode_logic_ON_rlt_fired_2 => (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2))) 
...
and ((((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2) and (V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining <= 0)) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2)) => (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2))) 
...
and (V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 => (not V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1)) 
...
and (V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 => (V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root >= 1)) 
and (V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 => (not V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1)) 
and (V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 => ((if (not (V48_chart_microwave_mode_logic_clear_off = 0)) then true else false) or (not (if (not (V49_chart_microwave_mode_logic_door_closed = 0)) then true else false)))) 
...
and ((not (V48_chart_microwave_mode_logic_clear_off = 0)) => ((if (not (V48_chart_microwave_mode_logic_clear_off = 0)) then true else false) or (not (if (not (V49_chart_microwave_mode_logic_door_closed = 0)) then true else false)))) 
...
and (V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 => (V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root >= 1)) 
...
and (((V63_rlt_eval_microwave_mode_logic_ON_rlt_state_6_outports_steps_remaining > 0) and (not V61_rlt_eval_microwave_mode_logic_ON_rlt_complete_2)) => (not V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1)) 
...
and (((V87_chart_microwave_mode_logic_begin_state_states___root = 4) and ((if (not (V47_chart_microwave_mode_logic_start = 0)) then true else false) and (if (not ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) = 0)) then true else false))) => (not (pre KP_START))) 
...
and ((KP_CLEAR and (not (pre KP_CLEAR))) => (not V81_rlt_eval_microwave_mode_logic_rlt_fired_1)) 
and ((not (V48_chart_microwave_mode_logic_clear_off = 0)) => ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) = 0)) 
and ((not (V48_chart_microwave_mode_logic_clear_off = 0)) => (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3))) 
...
and (V94_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT = (((V92_chart_microwave_mode_logic_steps_remaining div 1) - (((V92_chart_microwave_mode_logic_steps_remaining div 1) div 60) * 60)) div 10)) 
...
and ((V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY * 1) = V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY) 
...
and (V92_chart_microwave_mode_logic_steps_remaining = (if ((not V81_rlt_eval_microwave_mode_logic_rlt_fired_1) and ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3))) then (if V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 then (V63_rlt_eval_microwave_mode_logic_ON_rlt_state_6_outports_steps_remaining - 1) else V63_rlt_eval_microwave_mode_logic_ON_rlt_state_6_outports_steps_remaining) else V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining)) 
...
and ((((V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY * 1) + (V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY * 10)) + (V38_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_LEFT_DIGIT_DIGIT_TO_DISPLAY * 60)) = ((((V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY * 1) + (V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY * 10)) + (V38_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_LEFT_DIGIT_DIGIT_TO_DISPLAY * 60)) * 1)) 
...
and ((if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 1 else V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode) = (if (not (V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4)) then 1 else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode)) 
...
and ((if V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 then (if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) = V71_rlt_eval_microwave_mode_logic_ON_rlt_state_11_outports_mode) 
...
and ((if V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 then (if (not (V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4)) then 1 else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode) else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode) = V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) 
and (V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode = (if V54_rlt_eval_microwave_mode_logic_ON_rlt_fired_2 then (if (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2)) then 2 else V57_rlt_eval_microwave_mode_logic_ON_rlt_state_3_outports_mode) else V57_rlt_eval_microwave_mode_logic_ON_rlt_state_3_outports_mode)) 
...
and ((if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root) = (if (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2)) then 2 else V57_rlt_eval_microwave_mode_logic_ON_rlt_state_3_outports_mode)) 
and ((if (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2)) then 2 else V57_rlt_eval_microwave_mode_logic_ON_rlt_state_3_outports_mode) = (if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode)) 
and ((if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) = (if (not (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root = 2)) then 2 else V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root)) 
and ((if (not (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root = 2)) then 2 else V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root) = (if (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2)) then 2 else V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root)) 
and ((if (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2)) then 2 else V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root) = 2) 
and (2 = (if (not (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root = 2)) then 2 else V88_chart_microwave_mode_logic_begin_state_outports_mode)) 
...
and ((if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V71_rlt_eval_microwave_mode_logic_ON_rlt_state_11_outports_mode) = (if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root)) 
...
and ((if V81_rlt_eval_microwave_mode_logic_rlt_fired_1 then V78_rlt_enter_microwave_mode_logic_ON_rlt_state_4_states___root else V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root) = V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root) 
...
and (V85_rlt_enter_microwave_mode_logic_rlt_state_2_states___root = (if (not (V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4)) then 4 else V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root)) 
and ((if (not (V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4)) then 4 else V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root) = (if (not (V87_chart_microwave_mode_logic_begin_state_states___root = 4)) then 4 else V87_chart_microwave_mode_logic_begin_state_states___root)) 
...
and ((if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 4 else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root) = 4) 
...
and (0 <=((V92_chart_microwave_mode_logic_steps_remaining div 1) div 60)) 
and (0 <=(((V92_chart_microwave_mode_logic_steps_remaining div 1) div 60) * 60)) 
and (0 <=V94_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT) 
and (0 <=(if V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step then 0 else (if KP_CLEAR then 0 else (if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (pre V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY) else (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY))))) 
and (0 <=(if KP_CLEAR then 0 else (if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (pre V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY) else (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY)))) 
...
and (0 <=(V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY * 1)) 
...
and (0 <=((V92_chart_microwave_mode_logic_steps_remaining div 1) - (((V92_chart_microwave_mode_logic_steps_remaining div 1) div 60) * 60))) 
...
and (0 <=V92_chart_microwave_mode_logic_steps_remaining) 
...
and (0 <=(((V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY * 1) + (V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY * 10)) + (V38_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_LEFT_DIGIT_DIGIT_TO_DISPLAY * 60))) 
...
and (0 <=V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode) 
...
and (0 <=(if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root)) 
...
and (0 <=(if V81_rlt_eval_microwave_mode_logic_rlt_fired_1 then V78_rlt_enter_microwave_mode_logic_ON_rlt_state_4_states___root else V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root)) 
...
and (0 <=V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) 
...
and (0 <=V85_rlt_enter_microwave_mode_logic_rlt_state_2_states___root) 
...
and ((if V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step then 0 else (if KP_CLEAR then 0 else (if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY) else (pre V38_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_LEFT_DIGIT_DIGIT_TO_DISPLAY)))) <=((V92_chart_microwave_mode_logic_steps_remaining div 1) div 60)) 
and ((if V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step then 0 else (if KP_CLEAR then 0 else (if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY) else (pre V38_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_LEFT_DIGIT_DIGIT_TO_DISPLAY)))) <=(((V92_chart_microwave_mode_logic_steps_remaining div 1) div 60) * 60)) 
...
and (V38_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_LEFT_DIGIT_DIGIT_TO_DISPLAY <=256) 
...
and (((V92_chart_microwave_mode_logic_steps_remaining div 1) div 60) <=(if V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 then (V63_rlt_eval_microwave_mode_logic_ON_rlt_state_6_outports_steps_remaining - 1) else V63_rlt_eval_microwave_mode_logic_ON_rlt_state_6_outports_steps_remaining)) 
and (((V92_chart_microwave_mode_logic_steps_remaining div 1) div 60) <=10) 
and (((V92_chart_microwave_mode_logic_steps_remaining div 1) div 60) <=60) 
and (((V92_chart_microwave_mode_logic_steps_remaining div 1) div 60) <=256) 
and (V94_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT <=((V92_chart_microwave_mode_logic_steps_remaining div 1) - (((V92_chart_microwave_mode_logic_steps_remaining div 1) div 60) * 60))) 
and (V94_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT <=5) 
and (V94_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT <=(if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))) 
and (V94_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT <=(if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))) 
and (V94_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT <=6) 
and (V94_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT <=(if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))) 
and (V94_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT <=(if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10))))) 
and (V94_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT <=7) 
and (V94_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT <=(if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))) 
and (V94_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT <=(if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))) 
and (V94_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT <=8) 
and (V94_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT <=(if KP_8 then 8 else (if KP_9 then 9 else 10))) 
and (V94_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT <=(if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10))) 
and (V94_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT <=9) 
and (V94_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT <=(if KP_9 then 9 else 10)) 
and (V94_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT <=(if (KP_9 and (not (pre KP_9))) then 9 else 10)) 
and (V94_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT <=10) 
and (V94_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT <=60) 
and (V94_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT <=256) 
and ((if V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step then 0 else (if KP_CLEAR then 0 else (if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (pre V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY) else (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY)))) <=(if V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock then (if V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step then 0 else (if KP_CLEAR then 0 else (if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (pre V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY) else (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY)))) else (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY))) 
and ((if V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step then 0 else (if KP_CLEAR then 0 else (if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (pre V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY) else (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY)))) <=(V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY * 10)) 
and ((if V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step then 0 else (if KP_CLEAR then 0 else (if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (pre V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY) else (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY)))) <=(if V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 then (V63_rlt_eval_microwave_mode_logic_ON_rlt_state_6_outports_steps_remaining - 1) else V63_rlt_eval_microwave_mode_logic_ON_rlt_state_6_outports_steps_remaining)) 
...
and ((if V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step then 0 else (if KP_CLEAR then 0 else (if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (pre V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY) else (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY)))) <=V92_chart_microwave_mode_logic_steps_remaining) 
...
and ((if V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step then 0 else (if KP_CLEAR then 0 else (if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (pre V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY) else (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY)))) <=(if V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock then ((((V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY * 1) + (V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY * 10)) + (V38_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_LEFT_DIGIT_DIGIT_TO_DISPLAY * 60)) * 1) else (pre V25_STEPS_TO_COOK))) 
and ((if V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step then 0 else (if KP_CLEAR then 0 else (if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (pre V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY) else (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY)))) <=V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining) 
and ((if V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step then 0 else (if KP_CLEAR then 0 else (if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (pre V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY) else (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY)))) <=(((V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY * 1) + (V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY * 10)) + (V38_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_LEFT_DIGIT_DIGIT_TO_DISPLAY * 60))) 
...
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=(if (not ((V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root >= 1) and (V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root <= 3))) then 1 else V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root)) 
...
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=(if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root)) 
...
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=3) 
...
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=V85_rlt_enter_microwave_mode_logic_rlt_state_2_states___root) 
...
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=256) 
...
and ((V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY * 1) <=9) 
and ((V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY * 1) <=(if KP_9 then 9 else 10)) 
and ((V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY * 1) <=(if (KP_9 and (not (pre KP_9))) then 9 else 10)) 
and ((V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY * 1) <=10) 
and ((V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY * 1) <=60) 
and (((V92_chart_microwave_mode_logic_steps_remaining div 1) - (((V92_chart_microwave_mode_logic_steps_remaining div 1) div 60) * 60)) <=60) 
and (((V92_chart_microwave_mode_logic_steps_remaining div 1) - (((V92_chart_microwave_mode_logic_steps_remaining div 1) div 60) * 60)) <=256) 
and (((V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY * 1) + (V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY * 10)) <=256) 
...
and (V49_chart_microwave_mode_logic_door_closed <=V76_rlt_enter_microwave_mode_logic_ON_rlt_state_2_outports_mode) 
...
and (1 <=(if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root)) 
...
and (V88_chart_microwave_mode_logic_begin_state_outports_mode <=(if V81_rlt_eval_microwave_mode_logic_rlt_fired_1 then V78_rlt_enter_microwave_mode_logic_ON_rlt_state_4_states___root else V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root)) 
...
and ((if V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 then (if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) <=V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode) 
...
and ((if V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 then (if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) <=(if V81_rlt_eval_microwave_mode_logic_rlt_fired_1 then V78_rlt_enter_microwave_mode_logic_ON_rlt_state_4_states___root else V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root)) 
...
and ((if V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 then (if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) <=V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) 
...
and (V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode <=(if V54_rlt_eval_microwave_mode_logic_ON_rlt_fired_2 then (if (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2)) then 2 else V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root) else V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root)) 
and (V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode <=V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) 
and (V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode <=(if V86_chart_microwave_mode_logic_rlt_evtInitStep then V85_rlt_enter_microwave_mode_logic_rlt_state_2_states___root else (if ((not V81_rlt_eval_microwave_mode_logic_rlt_fired_1) and ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3))) then (if V69_rlt_eval_microwave_mode_logic_ON_rlt_fired_6 then (if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) else V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root))) 
and (V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode <=(if V81_rlt_eval_microwave_mode_logic_rlt_fired_1 then V78_rlt_enter_microwave_mode_logic_ON_rlt_state_4_states___root else V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root)) 
...
and ((if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root) <=3) 
and ((if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root) <=(if V86_chart_microwave_mode_logic_rlt_evtInitStep then V85_rlt_enter_microwave_mode_logic_rlt_state_2_states___root else (if ((not V81_rlt_eval_microwave_mode_logic_rlt_fired_1) and ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3))) then (if V69_rlt_eval_microwave_mode_logic_ON_rlt_fired_6 then (if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) else V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root))) 
and ((if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root) <=(pre V90_chart_microwave_mode_logic_final_state_states___root)) 
and ((if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root) <=V85_rlt_enter_microwave_mode_logic_rlt_state_2_states___root) 
and ((if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root) <=5) 
and ((if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root) <=6) 
and ((if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root) <=7) 
and ((if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root) <=8) 
and ((if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root) <=9) 
...
and ((if KP_2 then 2 else (if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))) <=(if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))))) 
and ((if KP_2 then 2 else (if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))) <=(if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))) 
and ((if KP_2 then 2 else (if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))) <=(if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))) 
and ((if KP_2 then 2 else (if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))) <=(if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))) 
and ((if KP_2 then 2 else (if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))) <=(if KP_8 then 8 else (if KP_9 then 9 else 10))) 
and ((if KP_2 then 2 else (if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))) <=(if KP_9 then 9 else 10)) 
...
and ((if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) else (pre V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY)) <=(if KP_9 then 9 else 10)) 
and (3 <=V85_rlt_enter_microwave_mode_logic_rlt_state_2_states___root) 
and (3 <=5) 
and (3 <=6) 
and (3 <=7) 
and (3 <=8) 
...
and ((if ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3)) then 0 else V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root) <=(if V81_rlt_eval_microwave_mode_logic_rlt_fired_1 then V78_rlt_enter_microwave_mode_logic_ON_rlt_state_4_states___root else V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root)) 
...
and ((if V54_rlt_eval_microwave_mode_logic_ON_rlt_fired_2 then (if (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2)) then 2 else V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root) else V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root) <=V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) 
...
and ((if V81_rlt_eval_microwave_mode_logic_rlt_fired_1 then V78_rlt_enter_microwave_mode_logic_ON_rlt_state_4_states___root else V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root) <=V87_chart_microwave_mode_logic_begin_state_states___root) 
and ((if V81_rlt_eval_microwave_mode_logic_rlt_fired_1 then V78_rlt_enter_microwave_mode_logic_ON_rlt_state_4_states___root else V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root) <=(pre V90_chart_microwave_mode_logic_final_state_states___root)) 
and (V85_rlt_enter_microwave_mode_logic_rlt_state_2_states___root <=5) 
and (V85_rlt_enter_microwave_mode_logic_rlt_state_2_states___root <=6) 
and (V85_rlt_enter_microwave_mode_logic_rlt_state_2_states___root <=7) 
and (V85_rlt_enter_microwave_mode_logic_rlt_state_2_states___root <=8) 
and (V85_rlt_enter_microwave_mode_logic_rlt_state_2_states___root <=9) 
...
and ((if V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 then (V63_rlt_eval_microwave_mode_logic_ON_rlt_state_6_outports_steps_remaining - 1) else V63_rlt_eval_microwave_mode_logic_ON_rlt_state_6_outports_steps_remaining) <=V92_chart_microwave_mode_logic_steps_remaining) 
and (V92_chart_microwave_mode_logic_steps_remaining <=(if V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 then 0 else V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining)) 
...
and (V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining <=(((V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY * 1) + (V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY * 10)) + (V38_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_LEFT_DIGIT_DIGIT_TO_DISPLAY * 60))) 
...
and ((V38_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_LEFT_DIGIT_DIGIT_TO_DISPLAY * 60) <=(((V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY * 1) + (V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY * 10)) + (V38_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_LEFT_DIGIT_DIGIT_TO_DISPLAY * 60))) 
...
and ((pre V96_microwave_microwave_mode_logic_mode) <=3) 
and (3 <=(if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))) 
...
and (10 <=60) 
and (60 <=256) 
and (((V92_chart_microwave_mode_logic_steps_remaining div 1) div 60) <=(((V92_chart_microwave_mode_logic_steps_remaining div 1) div 60) * 60)) 
and ((((V92_chart_microwave_mode_logic_steps_remaining div 1) div 60) * 60) <=V92_chart_microwave_mode_logic_steps_remaining) 
and (V92_chart_microwave_mode_logic_steps_remaining <=(if V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 then 0 else V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining)) 
and ((if V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 then 0 else V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining) <=V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining) 
and (V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining <=(((V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY * 1) + (V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY * 10)) + (V38_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_LEFT_DIGIT_DIGIT_TO_DISPLAY * 60))) 
and (V94_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT <=(if V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 then (V63_rlt_eval_microwave_mode_logic_ON_rlt_state_6_outports_steps_remaining - 1) else V63_rlt_eval_microwave_mode_logic_ON_rlt_state_6_outports_steps_remaining)) 
and ((if V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 then (V63_rlt_eval_microwave_mode_logic_ON_rlt_state_6_outports_steps_remaining - 1) else V63_rlt_eval_microwave_mode_logic_ON_rlt_state_6_outports_steps_remaining) <=V92_chart_microwave_mode_logic_steps_remaining) 
and (V92_chart_microwave_mode_logic_steps_remaining <=(if V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 then 0 else V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining)) 
and ((if V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 then 0 else V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining) <=V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining) 
and (V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining <=(((V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY * 1) + (V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY * 10)) + (V38_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_LEFT_DIGIT_DIGIT_TO_DISPLAY * 60))) 
...
and (10 <=60) 
and (60 <=256) 
and ((V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY * 1) <=((V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY * 1) + (V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY * 10))) 
and (((V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY * 1) + (V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY * 10)) <=(((V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY * 1) + (V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY * 10)) + (V38_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_LEFT_DIGIT_DIGIT_TO_DISPLAY * 60))) 
and (((V92_chart_microwave_mode_logic_steps_remaining div 1) - (((V92_chart_microwave_mode_logic_steps_remaining div 1) div 60) * 60)) <=V92_chart_microwave_mode_logic_steps_remaining) 
and (V92_chart_microwave_mode_logic_steps_remaining <=(if V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 then 0 else V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining)) 
and ((if V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 then 0 else V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining) <=V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining) 
and (V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining <=(((V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY * 1) + (V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY * 10)) + (V38_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_LEFT_DIGIT_DIGIT_TO_DISPLAY * 60))) 
...
and (10 <=60) 
and (60 <=256) 
and (V49_chart_microwave_mode_logic_door_closed <=1) 
and (1 <=(if (not ((V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root >= 1) and (V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root <= 3))) then 1 else V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root)) 
and ((if (not ((V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root >= 1) and (V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root <= 3))) then 1 else V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root) <=(pre V96_microwave_microwave_mode_logic_mode)) 
and ((pre V96_microwave_microwave_mode_logic_mode) <=3) 
and (3 <=(if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))) 
and ((if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))))) <=(if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))) 
...
and (10 <=60) 
and (60 <=256) 
and (V48_chart_microwave_mode_logic_clear_off <=1) 
and (1 <=(if (not ((V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root >= 1) and (V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root <= 3))) then 1 else V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root)) 
and ((if (not ((V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root >= 1) and (V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root <= 3))) then 1 else V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root) <=(pre V96_microwave_microwave_mode_logic_mode)) 
and ((pre V96_microwave_microwave_mode_logic_mode) <=3) 
and (3 <=(if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))) 
...
and (10 <=60) 
and (60 <=256) 
and ((if (V20_START_PRESSED = false) then 0 else 1) <=1) 
and (1 <=(if (not ((V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root >= 1) and (V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root <= 3))) then 1 else V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root)) 
and ((if (not ((V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root >= 1) and (V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root <= 3))) then 1 else V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root) <=(pre V96_microwave_microwave_mode_logic_mode)) 
and ((pre V96_microwave_microwave_mode_logic_mode) <=3) 
and (3 <=(if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))) 
...
and ((if V86_chart_microwave_mode_logic_rlt_evtInitStep then (if (not (V87_chart_microwave_mode_logic_begin_state_states___root = 4)) then 1 else V88_chart_microwave_mode_logic_begin_state_outports_mode) else (if ((not V81_rlt_eval_microwave_mode_logic_rlt_fired_1) and ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3))) then (if V69_rlt_eval_microwave_mode_logic_ON_rlt_fired_6 then (if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V71_rlt_eval_microwave_mode_logic_ON_rlt_state_11_outports_mode) else V71_rlt_eval_microwave_mode_logic_ON_rlt_state_11_outports_mode) else V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode)) <=(if V77_rlt_enter_microwave_mode_logic_ON_rlt_fired_2 then (if (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) then 3 else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root) else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root)) 
and ((if V77_rlt_enter_microwave_mode_logic_ON_rlt_fired_2 then (if (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) then 3 else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root) else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root) <=3) 
and (3 <=(if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))) 
and ((if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))))) <=(if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))) 
and ((if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10))))))) <=(if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10))))))) 
and ((if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))) <=(if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))) 
...
and (10 <=60) 
and (60 <=256) 
and (V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode <=(if V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1 then (if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 1 else V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode) else V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode)) 
and ((if V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1 then (if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 1 else V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode) else V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode) <=V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode) 
...
and (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root <=(if V86_chart_microwave_mode_logic_rlt_evtInitStep then V85_rlt_enter_microwave_mode_logic_rlt_state_2_states___root else (if ((not V81_rlt_eval_microwave_mode_logic_rlt_fired_1) and ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3))) then (if V69_rlt_eval_microwave_mode_logic_ON_rlt_fired_6 then (if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) else V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root))) 
and ((if V86_chart_microwave_mode_logic_rlt_evtInitStep then V85_rlt_enter_microwave_mode_logic_rlt_state_2_states___root else (if ((not V81_rlt_eval_microwave_mode_logic_rlt_fired_1) and ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3))) then (if V69_rlt_eval_microwave_mode_logic_ON_rlt_fired_6 then (if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) else V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root)) <=V85_rlt_enter_microwave_mode_logic_rlt_state_2_states___root) 
and (V85_rlt_enter_microwave_mode_logic_rlt_state_2_states___root <=(if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))))) 
...
and (10 <=60) 
and (60 <=256) 
and ((if V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 then (if ((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root >= 1) and (V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root <= 3)) then 0 else V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root) else V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root) <=(if V54_rlt_eval_microwave_mode_logic_ON_rlt_fired_2 then (if (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2)) then 2 else V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root) else V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root)) 
and ((if V54_rlt_eval_microwave_mode_logic_ON_rlt_fired_2 then (if (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2)) then 2 else V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root) else V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root) <=(if V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1 then (if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 4 else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root) else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root)) 
and ((if V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1 then (if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 4 else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root) else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root) <=V85_rlt_enter_microwave_mode_logic_rlt_state_2_states___root) 
and (V85_rlt_enter_microwave_mode_logic_rlt_state_2_states___root <=(if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))))) 
and ((if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))) <=(if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10))))))) 
...
and ((pre V90_chart_microwave_mode_logic_final_state_states___root) <=V85_rlt_enter_microwave_mode_logic_rlt_state_2_states___root) 
and (V85_rlt_enter_microwave_mode_logic_rlt_state_2_states___root <=(if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))))) 
and ((if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))) <=(if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10))))))) 
and ((if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))) <=(if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))) 
and ((if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10))))) <=(if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10))))) 
