...
and (((V25_realistic and (0 <= V22_speed)) and (V22_speed < 16)) => ((- 4) <= diff)) 
and (((V25_realistic and (0 <= V22_speed)) and (V22_speed < 16)) => (if (pre V23_plus) then (diff >= 1) else true)) 
...
and ((V25_realistic and (0 <= V22_speed)) => ((- 4) <= diff)) 
and ((V25_realistic and (0 <= V22_speed)) => (0 <= V22_speed)) 
and (V25_realistic => ((- 4) <= diff)) 
and (V25_realistic => (if (pre V23_plus) then (diff >= 1) else true)) 
...
and (((V25_realistic and (0 <= V22_speed)) and (V22_speed < 16)) => V98_Sofar) 
