...
and (((((((not e1) and (not e2)) and (not e3)) and (not e4)) and e5) and (not e6)) => (((not e1) and (not e2)) and (not e3))) 
...
and ((((not e1) and e2) and (not e3)) => e2) 
...
and ((((pre V51_shared) - 1) - (pre V50_exclusive)) <=((((pre V51_shared) - 1) - (pre V50_exclusive)) + 1)) 
and ((((pre V51_shared) - 1) - (pre V50_exclusive)) <=(if V104_garde3 then ((((pre V51_shared) - 1) - (pre V50_exclusive)) + 1) else (pre V51_shared))) 
and ((((pre V51_shared) - 1) - (pre V50_exclusive)) <=(if e3 then (if V104_garde3 then ((((pre V51_shared) - 1) - (pre V50_exclusive)) + 1) else (pre V51_shared)) else (if e5 then (if V106_garde5 then 0 else (pre V51_shared)) else (if e7 then (if V108_garde7 then ((pre V51_shared) + 2) else (pre V51_shared)) else (if e8 then (if V109_garde8 then (((pre V51_shared) + (pre V50_exclusive)) + 1) else (pre V51_shared)) else (pre V51_shared)))))) 
and ((((pre V51_shared) - 1) - (pre V50_exclusive)) <=(if e2 then (if V103_garde2 then ((pre V51_shared) + 2) else (pre V51_shared)) else (if e3 then (if V104_garde3 then ((((pre V51_shared) - 1) - (pre V50_exclusive)) + 1) else (pre V51_shared)) else (if e5 then (if V106_garde5 then 0 else (pre V51_shared)) else (if e7 then (if V108_garde7 then ((pre V51_shared) + 2) else (pre V51_shared)) else (if e8 then (if V109_garde8 then (((pre V51_shared) + (pre V50_exclusive)) + 1) else (pre V51_shared)) else (pre V51_shared))))))) 
...
and ((((pre V51_shared) - 1) - (pre V50_exclusive)) <=((pre V51_shared) - 1)) 
and (((pre V51_shared) - 1) <=(if V106_garde5 then 0 else (pre V51_shared))) 
...
and (((((pre V51_shared) - 1) - (pre V50_exclusive)) + 1) <=(if V104_garde3 then ((((pre V51_shared) - 1) - (pre V50_exclusive)) + 1) else (pre V51_shared))) 
and ((if V104_garde3 then ((((pre V51_shared) - 1) - (pre V50_exclusive)) + 1) else (pre V51_shared)) <=(pre V51_shared)) 
and ((pre V51_shared) <=((pre V51_shared) + (pre V50_exclusive))) 
and (((pre V51_shared) + (pre V50_exclusive)) <=(((pre V51_shared) + (pre V50_exclusive)) + 1)) 
and ((if e3 then (if V104_garde3 then ((((pre V51_shared) - 1) - (pre V50_exclusive)) + 1) else (pre V51_shared)) else (if e5 then (if V106_garde5 then 0 else (pre V51_shared)) else (if e7 then (if V108_garde7 then ((pre V51_shared) + 2) else (pre V51_shared)) else (if e8 then (if V109_garde8 then (((pre V51_shared) + (pre V50_exclusive)) + 1) else (pre V51_shared)) else (pre V51_shared))))) <=(if e7 then (if V108_garde7 then ((pre V51_shared) + 2) else (pre V51_shared)) else (if e8 then (if V109_garde8 then (((pre V51_shared) + (pre V50_exclusive)) + 1) else (pre V51_shared)) else (pre V51_shared)))) 
