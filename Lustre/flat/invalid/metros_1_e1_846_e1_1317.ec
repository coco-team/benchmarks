...
-- 183 implications. 
assert (true -> (((not (((pre V43_avance0) and V45_retard0) or ((pre V45_retard0) and V43_avance0))) = (V170_Sofar => (pre V47_pOK))) 
...
and (0 <=((pre V40_nS) + 1)) 
and (0 <=((pre V39_nB1) + 1)) 
and (0 <=(if B0 then (((pre V159_c) + 1) + 1) else (pre V159_c))) 
and (0 <=V38_nB0) 
and (0 <=(if B0 then (((pre V38_nB0) + 1) + 1) else (pre V38_nB0))) 
and (0 <=(((pre V159_c) + 1) + 1)) 
and (0 <=(((pre V38_nB0) + 1) + 1)) 
and (0 <=9) 
and (0 <=10) 
and (0 <=32767) 
...
and ((if ((pre V43_avance0) and V43_avance0) then (if B0 then (((pre V159_c) + 1) + 1) else (pre V159_c)) else 0) <=V38_nB0) 
...
and ((if B0 then (((pre V159_c) + 1) + 1) else (pre V159_c)) <=(if B0 then (((pre V38_nB0) + 1) + 1) else (pre V38_nB0))) 
...
and ((if B0 then (((pre V38_nB0) + 1) + 1) else (pre V38_nB0)) <=(((pre V38_nB0) + 1) + 1)) 
and ((((pre V159_c) + 1) + 1) <=(((pre V38_nB0) + 1) + 1)) 
and (9 <=10) 
and (10 <=32767) 
and  true ));
tel.
