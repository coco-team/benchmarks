...
let
  OK = (true -> ((if (not V18_COOKING) then (if (V101_MWI_FcnMaxI_In11 > 0) 
  ...
  * 10));
  ...
  V103_p5 = (true -> ((if (not V19_SUSPENDED) then (if (V100_MWI_FcnMaxI_In12 > 
  0) then V100_MWI_FcnMaxI_In12 else 0) else 639) > 0));
  V104_p6 = (true -> ((not V17_SETUP) or ((if (not (not V17_SETUP)) then (if (
  V99_MWI_FcnMaxI_In13 > 0) then V99_MWI_FcnMaxI_In13 else 0) else 639) > 0)));
  V105_p7 = (true -> ((not V18_COOKING) or ((if (not (not V18_COOKING)) then 
  (if (V97_MWI_FcnMaxI_In16 > 0) then V97_MWI_FcnMaxI_In16 else 0) else 639) > 
  0)));
  V106_p8 = (true -> ((not V19_SUSPENDED) or ((if (not (not V19_SUSPENDED)) 
  then (if (V98_MWI_FcnMaxI_In15 > 0) then V98_MWI_FcnMaxI_In15 else 0) else 
  639) > 0)));
  V107_p9 = (true -> ((not V18_COOKING) or DOOR_CLOSED));
  V108_p10 = (true -> ((not V18_COOKING) or ((if (not (not V18_COOKING)) then 
  (if (V97_MWI_FcnMaxI_In16 > 0) then V97_MWI_FcnMaxI_In16 else 0) else 639) > 
  0)));
  V109_p11 = ((not KP_CLEAR) or (not V18_COOKING));
  V110_p12 = (
...
and ((2 = V96_microwave_microwave_mode_logic_mode) = (V68_rlt_eval_microwave_mode_logic_ON_rlt_state_10_states___root = 2)) 
...
and ((V64_rlt_eval_microwave_mode_logic_ON_rlt_state_7_states___root = 2) = V18_COOKING) 
...
and ((V101_MWI_FcnMaxI_In11 > 0) => ((if (not V18_COOKING) then (if (V101_MWI_FcnMaxI_In11 > 0) then V101_MWI_FcnMaxI_In11 else 0) else 639) > 0)) 
...
and ((V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2) => ((if (not V18_COOKING) then (if (V101_MWI_FcnMaxI_In11 > 0) then V101_MWI_FcnMaxI_In11 else 0) else 639) > 0)) 
...
and (V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1 => ((if (not V18_COOKING) then (if (V101_MWI_FcnMaxI_In11 > 0) then V101_MWI_FcnMaxI_In11 else 0) else 639) > 0)) 
...
and ((V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2) => (2 = V96_microwave_microwave_mode_logic_mode)) 
...
and ((pre V86_chart_microwave_mode_logic_rlt_evtInitStep) => (V101_MWI_FcnMaxI_In11 > 0)) 
and ((pre V86_chart_microwave_mode_logic_rlt_evtInitStep) => ((if (not V18_COOKING) then (if (V101_MWI_FcnMaxI_In11 > 0) then V101_MWI_FcnMaxI_In11 else 0) else 639) > 0)) 
and ((pre V86_chart_microwave_mode_logic_rlt_evtInitStep) => (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1)) 
and ((pre V86_chart_microwave_mode_logic_rlt_evtInitStep) => (not V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1)) 
...
and ((((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2) and (V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining <= 0)) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2)) => (V101_MWI_FcnMaxI_In11 > 0)) 
and ((((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2) and (V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining <= 0)) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2)) => ((if (not V18_COOKING) then (if (V101_MWI_FcnMaxI_In11 > 0) then V101_MWI_FcnMaxI_In11 else 0) else 639) > 0)) 
...
and (V74_rlt_enter_microwave_mode_logic_ON_rlt_fired_1 => (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3))) 
and (V74_rlt_enter_microwave_mode_logic_ON_rlt_fired_1 => (not V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1)) 
and (V74_rlt_enter_microwave_mode_logic_ON_rlt_fired_1 => (not V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1)) 
...
and ((not ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) = 0)) => (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3))) 
...
and ((V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3) => (((V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root >= 1) and (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root <= 3)) and (not V74_rlt_enter_microwave_mode_logic_ON_rlt_fired_1))) 
...
and ((V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4) => (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1)) 
...
and (((if (not (V47_chart_microwave_mode_logic_start = 0)) then true else false) and (if (not ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) = 0)) then true else false)) => (V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root <= 3)) 
...
and ((((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2) and (V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining <= 0)) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2)) => (((V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root >= 1) and (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root <= 3)) and (not V74_rlt_enter_microwave_mode_logic_ON_rlt_fired_1))) 
and (V86_chart_microwave_mode_logic_rlt_evtInitStep => (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3))) 
and ((((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2) and (V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining <= 0)) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2)) => V61_rlt_eval_microwave_mode_logic_ON_rlt_complete_2) 
...
and ((V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root = 2) => (V101_MWI_FcnMaxI_In11 > 0)) 
and ((V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root = 2) => ((if (not V18_COOKING) then (if (V101_MWI_FcnMaxI_In11 > 0) then V101_MWI_FcnMaxI_In11 else 0) else 639) > 0)) 
...
and ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2) => ((if (not V18_COOKING) then (if (V101_MWI_FcnMaxI_In11 > 0) then V101_MWI_FcnMaxI_In11 else 0) else 639) > 0)) 
...
and ((((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2) and (V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining <= 0)) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2)) => (pre V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step)) 
...
and (V86_chart_microwave_mode_logic_rlt_evtInitStep => (V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root <= 3)) 
and ((((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2) and (V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining <= 0)) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2)) => ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3))) 
...
and (V77_rlt_enter_microwave_mode_logic_ON_rlt_fired_2 => (not (V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 or V61_rlt_eval_microwave_mode_logic_ON_rlt_complete_2))) 
and ((((if (not (V48_chart_microwave_mode_logic_clear_off = 0)) then true else false) or (not (if (not (V49_chart_microwave_mode_logic_door_closed = 0)) then true else false))) and (not (V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 or V61_rlt_eval_microwave_mode_logic_ON_rlt_complete_2))) => (not (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root = 2))) 
...
and ((2 = V96_microwave_microwave_mode_logic_mode) => ((if (not V18_COOKING) then (if (V101_MWI_FcnMaxI_In11 > 0) then V101_MWI_FcnMaxI_In11 else 0) else 639) > 0)) 
and ((2 = V96_microwave_microwave_mode_logic_mode) => (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1)) 
and ((2 = V96_microwave_microwave_mode_logic_mode) => (not V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1)) 
and ((2 = V96_microwave_microwave_mode_logic_mode) => (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3))) 
...
and (((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root = 3) and ((if (not (V48_chart_microwave_mode_logic_clear_off = 0)) then true else false) and (not V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1))) => KP_CLEAR) 
...
and ((V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3) => ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) = 0)) 
and ((((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2) and (V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining <= 0)) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2)) => (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3))) 
...
and (((if (not (V48_chart_microwave_mode_logic_clear_off = 0)) then true else false) and (not V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1)) => (not V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1)) 
...
and (V101_MWI_FcnMaxI_In11 = ((pre V45_rlt__Arrow1) - 1)) 
...
and (0 <=(if (V101_MWI_FcnMaxI_In11 > 0) then V101_MWI_FcnMaxI_In11 else 0)) 
and (0 <=(if (not V18_COOKING) then (if (V101_MWI_FcnMaxI_In11 > 0) then V101_MWI_FcnMaxI_In11 else 0) else 639)) 
and (0 <=(pre V45_rlt__Arrow1)) 
...
and ((if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))))) <=(if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))) 
and ((if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))))) <=(if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))) 
and ((if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))))) <=(if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))) 
and ((if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))))) <=(if KP_8 then 8 else (if KP_9 then 9 else 10))) 
and ((if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))))) <=(if KP_9 then 9 else 10)) 
...
and ((if ((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root >= 1) and (V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root <= 3)) then 0 else V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root) <=(if V54_rlt_eval_microwave_mode_logic_ON_rlt_fired_2 then (if (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2)) then 2 else V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root) else V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root)) 
and ((if ((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root >= 1) and (V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root <= 3)) then 0 else V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root) <=(if V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1 then (if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 4 else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root) else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root)) 
...
and (7 <=(if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))) 
and (8 <=9) 
...
and ((if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))) <=(if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))) 
and ((if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))) <=(if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))) 
and ((if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))) <=(if KP_8 then 8 else (if KP_9 then 9 else 10))) 
and ((if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))) <=(if KP_9 then 9 else 10)) 
...
and ((if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))) <=(if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))) 
and ((if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))) <=(if KP_8 then 8 else (if KP_9 then 9 else 10))) 
and ((if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))) <=(if KP_9 then 9 else 10)) 
...
and ((if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))) <=(if KP_8 then 8 else (if KP_9 then 9 else 10))) 
and ((if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))) <=(if KP_9 then 9 else 10)) 
and ((if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))) <=(if KP_8 then 8 else (if KP_9 then 9 else 10))) 
and ((if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))) <=(if KP_9 then 9 else 10)) 
and ((if KP_8 then 8 else (if KP_9 then 9 else 10)) <=(if KP_9 then 9 else 10)) 
and ((if (V101_MWI_FcnMaxI_In11 > 0) then V101_MWI_FcnMaxI_In11 else 0) <=(pre V45_rlt__Arrow1)) 
...
and (10 <=60) 
and (60 <=639) 
and (V101_MWI_FcnMaxI_In11 <=(if (V101_MWI_FcnMaxI_In11 > 0) then V101_MWI_FcnMaxI_In11 else 0)) 
and ((if (V101_MWI_FcnMaxI_In11 > 0) then V101_MWI_FcnMaxI_In11 else 0) <=(if (not V18_COOKING) then (if (V101_MWI_FcnMaxI_In11 > 0) then V101_MWI_FcnMaxI_In11 else 0) else 639)) 
and ((if (not V18_COOKING) then (if (V101_MWI_FcnMaxI_In11 > 0) then V101_MWI_FcnMaxI_In11 else 0) else 639) <=639) 
and ((pre V45_rlt__Arrow1) <=639) 
and  true ));
tel.
