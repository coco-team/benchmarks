...
and (((etat1 and etat2) or (etat1 and etat3)) => (V39_env => ((V37_o1 + V38_o2) <= V136_First))) 
...
and (0 <=V38_o2) 
and (0 <=(if etat3 then (if V91_garde3 then ((pre V38_o2) + 1) else (pre V38_o2)) else (pre V38_o2))) 
and (0 <=(V37_o1 + V38_o2)) 
and (0 <=(if V90_garde2 then ((pre V37_o1) + 1) else (pre V37_o1))) 
and (0 <=(if V91_garde3 then ((pre V38_o2) + 1) else (pre V38_o2))) 
and (0 <=1) 
and (0 <=((pre V37_o1) + 1)) 
and (0 <=((pre V38_o2) + 1)) 
...
and (V37_o1 <=(V37_o1 + V38_o2)) 
and (V38_o2 <=(V37_o1 + V38_o2)) 
and (1 <=((pre V38_o2) + 1)) 
and (1 <=((pre V35_b) + 1)) 
