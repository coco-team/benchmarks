...
let
  ...
  V104_Sofar = (V99_X -> (V99_X and (pre V104_Sofar)));
    --%PROPERTY OK=true;
...
and ((V99_X and (pre V104_Sofar)) => V104_Sofar) 
...
and (V104_Sofar => ((not ((((((etat_mo1 and etat_mo2) or (etat_mo1 and etat_mo3)) or (etat_mo1 and etat_mo4)) or (etat_mo2 and etat_mo3)) or (etat_mo2 and etat_mo4)) or (etat_mo3 and etat_mo4))) and (init_invalid_mo > 0))) 
and ((etat_mo2 and etat_mo4) => etat_mo4) 
and (V104_Sofar => (init_invalid_mo > 0)) 
and ((V99_X and (pre V104_Sofar)) => (pre V104_Sofar)) 
...
and ((if V84_garde_mo3 then 0 else (pre V37_owned_mo)) = (if V83_garde_mo2 then ((pre V34_exclusive_mo) - 1) else (pre V34_exclusive_mo))) 
and ((if V83_garde_mo2 then ((pre V34_exclusive_mo) - 1) else (pre V34_exclusive_mo)) = 0) 
and (0 = (if V84_garde_mo3 then 0 else (pre V35_shared_mo))) 
...
and ((if V84_garde_mo3 then 0 else (pre V37_owned_mo)) <=(if V85_garde_mo4 then 0 else (pre V33_modified_mo))) 
...
and ((pre V36_invalid_mo) <=((((pre V36_invalid_mo) + (pre V33_modified_mo)) + (pre V34_exclusive_mo)) + (pre V35_shared_mo))) 
...
and ((pre V33_modified_mo) <=((pre V37_owned_mo) + (pre V33_modified_mo))) 
and (((pre V37_owned_mo) + (pre V33_modified_mo)) <=(((pre V35_shared_mo) + (pre V34_exclusive_mo)) + 1)) 
and ((if etat_mo3 then (if V84_garde_mo3 then 0 else (pre V35_shared_mo)) else (if etat_mo4 then (if V85_garde_mo4 then 0 else (pre V35_shared_mo)) else (pre V35_shared_mo))) <=(if etat_mo4 then (if V85_garde_mo4 then 0 else (pre V35_shared_mo)) else (pre V35_shared_mo))) 
