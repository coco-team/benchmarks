...
and ((etat_me1 and etat_me4) => (V36_env => (((((if (V32_modified_me < 0) then (- V32_modified_me) else V32_modified_me) + (if (V33_exclusive_me < 0) then (- V33_exclusive_me) else V33_exclusive_me)) + (if (V34_shared_me < 0) then (- V34_shared_me) else V34_shared_me)) + (if (V35_invalid_me < 0) then (- V35_invalid_me) else V35_invalid_me)) <= 3))) 
...
and ((((pre V34_shared_me) - 1) + (pre V33_exclusive_me)) <=(if etat_me3 then (if V87_garde_me3 then 0 else (pre V32_modified_me)) else (if etat_me4 then (if V88_garde_me4 then 0 else (pre V32_modified_me)) else (pre V32_modified_me)))) 
and ((((pre V34_shared_me) - 1) + (pre V33_exclusive_me)) <=(if etat_me4 then (if V88_garde_me4 then 0 else (pre V32_modified_me)) else (pre V32_modified_me))) 
and ((((pre V34_shared_me) - 1) + (pre V33_exclusive_me)) <=(if V88_garde_me4 then 0 else (pre V32_modified_me))) 
...
and (((if (V32_modified_me < 0) then (- V32_modified_me) else V32_modified_me) + (if (V33_exclusive_me < 0) then (- V33_exclusive_me) else V33_exclusive_me)) <=3) 
...
and ((((pre V34_shared_me) - 1) + (pre V33_exclusive_me)) <=((((pre V34_shared_me) - 1) + (pre V33_exclusive_me)) - (pre V32_modified_me))) 
and (((((pre V34_shared_me) - 1) + (pre V33_exclusive_me)) - (pre V32_modified_me)) <=(pre V34_shared_me)) 
