...
and ((pre V26_bump) => (V91_X or (pre V33_env))) 
...
and ((if (V30_move and V32_meter) then (((pre V28_speed) - 1) + 1) else (pre V28_speed)) <=(if (V30_move and V32_meter) then ((pre V27_dist) + 1) else (pre V27_dist))) 
...
and ((if (V30_move and V32_meter) then (((pre V28_speed) - 1) + 1) else (pre V28_speed)) <=((pre V27_dist) + 1)) 
...
and ((if (V30_move and V32_meter) then (((pre V28_speed) - 1) + 1) else (pre V28_speed)) <=10) 
