...
and (((pre V31_shared_me) - (pre V30_exclusive_me)) <=(if etat_me2 then (if V74_garde_me2 then (pre V31_shared_me) else (pre V31_shared_me)) else (if etat_me3 then (if V75_garde_me3 then 0 else (pre V31_shared_me)) else (if etat_me4 then (if V76_garde_me4 then 0 else (pre V31_shared_me)) else (pre V31_shared_me))))) 
and (((pre V31_shared_me) - (pre V30_exclusive_me)) <=(if etat_me3 then (if V75_garde_me3 then 0 else (pre V31_shared_me)) else (if etat_me4 then (if V76_garde_me4 then 0 else (pre V31_shared_me)) else (pre V31_shared_me)))) 
and (((pre V31_shared_me) - (pre V30_exclusive_me)) <=(if etat_me4 then (if V76_garde_me4 then 0 else (pre V31_shared_me)) else (pre V31_shared_me))) 
and (((pre V31_shared_me) - (pre V30_exclusive_me)) <=(if V76_garde_me4 then 0 else (pre V31_shared_me))) 
and (((pre V31_shared_me) - (pre V30_exclusive_me)) <=0) 
and (((pre V31_shared_me) - (pre V30_exclusive_me)) <=(if V73_garde_me1 then 0 else (pre V30_exclusive_me))) 
and (((pre V31_shared_me) - (pre V30_exclusive_me)) <=(pre V30_exclusive_me)) 
and (((pre V31_shared_me) - (pre V30_exclusive_me)) <=V30_exclusive_me) 
and (((pre V31_shared_me) - (pre V30_exclusive_me)) <=(if etat_me1 then (if V73_garde_me1 then 0 else (pre V30_exclusive_me)) else (if etat_me2 then (if V74_garde_me2 then ((pre V30_exclusive_me) - 1) else (pre V30_exclusive_me)) else (if etat_me3 then (if V75_garde_me3 then 1 else (pre V30_exclusive_me)) else (if etat_me4 then (if V76_garde_me4 then 1 else (pre V30_exclusive_me)) else (pre V30_exclusive_me)))))) 
and (((pre V31_shared_me) - (pre V30_exclusive_me)) <=(if etat_me2 then (if V74_garde_me2 then ((pre V30_exclusive_me) - 1) else (pre V30_exclusive_me)) else (if etat_me3 then (if V75_garde_me3 then 1 else (pre V30_exclusive_me)) else (if etat_me4 then (if V76_garde_me4 then 1 else (pre V30_exclusive_me)) else (pre V30_exclusive_me))))) 
and (((pre V31_shared_me) - (pre V30_exclusive_me)) <=(if etat_me3 then (if V75_garde_me3 then 1 else (pre V30_exclusive_me)) else (if etat_me4 then (if V76_garde_me4 then 1 else (pre V30_exclusive_me)) else (pre V30_exclusive_me)))) 
and (((pre V31_shared_me) - (pre V30_exclusive_me)) <=(if etat_me4 then (if V76_garde_me4 then 1 else (pre V30_exclusive_me)) else (pre V30_exclusive_me))) 
and (((pre V31_shared_me) - (pre V30_exclusive_me)) <=(if V76_garde_me4 then 1 else (pre V30_exclusive_me))) 
...
and ((if etat_me4 then (if V76_garde_me4 then 1 else (pre V30_exclusive_me)) else (pre V30_exclusive_me)) <=(if V76_garde_me4 then 1 else (pre V30_exclusive_me))) 
and ((if V76_garde_me4 then 1 else (pre V30_exclusive_me)) <=1) 
and (((pre V31_shared_me) - (pre V30_exclusive_me)) <=(((pre V31_shared_me) - (pre V30_exclusive_me)) - (pre V29_modified_me))) 
and ((((pre V31_shared_me) - (pre V30_exclusive_me)) - (pre V29_modified_me)) <=1) 
