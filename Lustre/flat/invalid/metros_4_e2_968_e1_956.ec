...
and ((if ((pre V43_avance0) and V43_avance0) then (if B0 then (((pre V158_c) - 1) + 1) else (pre V158_c)) else 0) = (((pre V158_c) - 1) + 1)) 
and ((((pre V158_c) - 1) + 1) = (if ((pre V44_avance1) and V44_avance1) then (if B1 then (((pre V159_c) - 1) + 1) else (pre V159_c)) else 0)) 
...
and ((pre V158_c) <=(if B0 then (((pre V38_nB0) + 1) + 1) else (pre V38_nB0))) 
and ((pre V158_c) <=(((pre V38_nB0) + 1) + 1)) 
and ((pre V158_c) <=9) 
and ((pre V158_c) <=10) 
and ((pre V158_c) <=30) 
