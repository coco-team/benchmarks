...
and ((not (((((((etat_mo1 and etat_mo2) and etat_mo1) and etat_mo3) or (etat_mo1 and etat_mo4)) or (etat_mo2 and etat_mo3)) or (etat_mo2 and etat_mo4)) or (etat_mo3 and etat_mo4))) = V99_X) 
...
and ((etat_mo1 and etat_mo4) => ((((((etat_mo1 and etat_mo2) and etat_mo1) and etat_mo3) or (etat_mo1 and etat_mo4)) or (etat_mo2 and etat_mo3)) or (etat_mo2 and etat_mo4))) 
and ((etat_mo1 and etat_mo4) => (((((((etat_mo1 and etat_mo2) and etat_mo1) and etat_mo3) or (etat_mo1 and etat_mo4)) or (etat_mo2 and etat_mo3)) or (etat_mo2 and etat_mo4)) or (etat_mo3 and etat_mo4))) 
and ((etat_mo1 and etat_mo4) => etat_mo4) 
and (((((etat_mo1 and etat_mo2) and etat_mo1) and etat_mo3) or (etat_mo1 and etat_mo4)) => ((((((etat_mo1 and etat_mo2) and etat_mo1) and etat_mo3) or (etat_mo1 and etat_mo4)) or (etat_mo2 and etat_mo3)) or (etat_mo2 and etat_mo4))) 
...
and ((if V85_garde_mo3 then 0 else (pre V33_modified_mo)) = (if V85_garde_mo3 then 0 else (pre V35_shared_mo))) 
...
and ((pre V33_modified_mo) <=(if V85_garde_mo3 then 1 else (pre V34_exclusive_mo))) 
...
and (((pre V33_modified_mo) + (pre V34_exclusive_mo)) <=(if V85_garde_mo3 then 1 else (pre V34_exclusive_mo))) 
...
and ((V33_modified_mo + V34_exclusive_mo) <=(if V85_garde_mo3 then 1 else (pre V34_exclusive_mo))) 
and ((V33_modified_mo + V34_exclusive_mo) <=((pre V33_modified_mo) + 1)) 
and ((V33_modified_mo + V34_exclusive_mo) <=((pre V35_shared_mo) + 1)) 
and ((V33_modified_mo + V34_exclusive_mo) <=(((pre V35_shared_mo) + 1) + (pre V37_owned_mo))) 
and ((if V85_garde_mo3 then 1 else (pre V34_exclusive_mo)) <=((pre V35_shared_mo) + 1)) 
and ((if V85_garde_mo3 then 1 else (pre V34_exclusive_mo)) <=(((pre V35_shared_mo) + 1) + (pre V37_owned_mo))) 
and ((if V85_garde_mo3 then 1 else (pre V34_exclusive_mo)) <=(((pre V35_shared_mo) + (pre V34_exclusive_mo)) + 1)) 
