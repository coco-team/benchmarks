...
-- 94 implications. 
assert (true -> ((V89_garde1 = ((pre V34_i) >= 1)) 
and (V104_X = (not (((etat1 and etat2) or (etat1 and etat3)) or (etat2 and etat3)))) 
...
and ((((V37_o1 - 1) + V38_o2) <= V136_First) => (V39_env => (((V37_o1 - 1) + V38_o2) <= V136_First))) 
...
and ((etat1 and etat2) => (V39_env => (((V37_o1 - 1) + V38_o2) <= V136_First))) 
...
and ((if V91_garde3 then ((pre V35_b) - 1) else (pre V35_b)) = (if etat2 then (if V90_garde2 then ((pre V35_b) - 1) else (pre V35_b)) else (if V91_garde3 then ((pre V35_b) - 1) else (pre V35_b)))) 
and ((if etat2 then (if V90_garde2 then ((pre V35_b) - 1) else (pre V35_b)) else (if V91_garde3 then ((pre V35_b) - 1) else (pre V35_b))) = (if V90_garde2 then ((pre V35_b) - 1) else (pre V35_b))) 
and (V136_First = V127_First) 
and ((pre V36_a) = (pre V136_First)) 
and ((pre V136_First) = (pre V127_First)) 
and ((V37_o1 - 1) <=(pre V37_o1)) 
and ((V37_o1 - 1) <=V37_o1) 
and ((V37_o1 - 1) <=(if etat2 then (if V90_garde2 then ((pre V37_o1) + 1) else (pre V37_o1)) else (pre V37_o1))) 
and ((V37_o1 - 1) <=(if V90_garde2 then ((pre V37_o1) + 1) else (pre V37_o1))) 
and ((V37_o1 - 1) <=((pre V37_o1) + 1)) 
and (0 <=(if V91_garde3 then ((pre V35_b) - 1) else (pre V35_b))) 
and (0 <=(pre V37_o1)) 
and (0 <=V38_o2) 
and (0 <=V37_o1) 
...
and (0 <=((pre V37_o1) + 1)) 
and (0 <=((pre V35_b) + 1)) 
and ((if V91_garde3 then ((pre V35_b) - 1) else (pre V35_b)) <=(if etat1 then (if V89_garde1 then ((pre V35_b) + 1) else (pre V35_b)) else (if etat2 then (if V90_garde2 then ((pre V35_b) - 1) else (pre V35_b)) else (if V91_garde3 then ((pre V35_b) - 1) else (pre V35_b))))) 
and (1 <=((pre V37_o1) + 1)) 
and (1 <=((pre V35_b) + 1)) 
and ((V37_o1 - 1) <=((V37_o1 - 1) + V38_o2)) 
and (((pre V35_b) - 1) <=(if V91_garde3 then ((pre V35_b) - 1) else (pre V35_b))) 
and ((if V91_garde3 then ((pre V35_b) - 1) else (pre V35_b)) <=(pre V35_b)) 
