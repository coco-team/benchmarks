...
and ((if ((pre V43_avance0) and V43_avance0) then (if B0 then (((pre V158_c) + 1) - 1) else (pre V158_c)) else 0) = (if B1 then (((pre V159_c) + 1) - 1) else (pre V159_c))) 
...
and (((pre V159_c) + 1) = 1) 
and (1 = ((pre V158_c) + 1)) 
and ((((pre V159_c) + 1) - 1) <=(pre V40_nS)) 
and ((((pre V159_c) + 1) - 1) <=(pre V39_nB1)) 
and ((((pre V159_c) + 1) - 1) <=V40_nS) 
and ((((pre V159_c) + 1) - 1) <=(if S then ((pre V40_nS) + 1) else (pre V40_nS))) 
and ((((pre V159_c) + 1) - 1) <=V38_nB0) 
and ((((pre V159_c) + 1) - 1) <=V39_nB1) 
and ((((pre V159_c) + 1) - 1) <=(if B1 then ((pre V39_nB1) + 1) else (pre V39_nB1))) 
and ((((pre V159_c) + 1) - 1) <=((pre V159_c) + 1)) 
and ((((pre V159_c) + 1) - 1) <=((pre V40_nS) + 1)) 
and ((((pre V159_c) + 1) - 1) <=((pre V39_nB1) + 1)) 
and ((((pre V159_c) + 1) - 1) <=9) 
and ((((pre V159_c) + 1) - 1) <=10) 
and ((((pre V159_c) + 1) - 1) <=30) 
and (((pre V159_c) + 1) <=((pre V40_nS) + 1)) 
and (((pre V159_c) + 1) <=((pre V39_nB1) + 1)) 
and (((pre V159_c) + 1) <=9) 
and (((pre V159_c) + 1) <=10) 
and (((pre V159_c) + 1) <=30) 
and ((- 10) <=(((pre V159_c) + 1) - 1)) 
and ((((pre V159_c) + 1) - 1) <=(pre V38_nB0)) 
