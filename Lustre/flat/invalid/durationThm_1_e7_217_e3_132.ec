...
and (((((V14_k >= 1) and (V15_m >= 1)) and ((V45_age_of_p >= V14_k) => q)) and ((V52_age_of_p >= V15_m) => r)) => (V55_X or (pre V16_env))) 
...
and (((pre V45_age_of_p) - 1) <=(pre V45_age_of_p)) 
and (((pre V52_age_of_p) - 1) <=(if (pre q) then ((pre V52_age_of_p) - 1) else 0)) 
and ((if (pre q) then ((pre V52_age_of_p) - 1) else 0) <=V52_age_of_p) 
and (V52_age_of_p <=0) 
and (0 <=1) 
and (((pre V45_age_of_p) - 1) <=(if (pre p) then ((pre V68_age_of_p) - 1) else 0)) 
and ((if (pre p) then ((pre V68_age_of_p) - 1) else 0) <=V45_age_of_p) 
and (V45_age_of_p <=0) 
and (0 <=1) 
and ((pre V52_age_of_p) <=0) 
and (0 <=1) 
and ((pre V45_age_of_p) <=0) 
and (0 <=1) 
and  true ));
tel.
