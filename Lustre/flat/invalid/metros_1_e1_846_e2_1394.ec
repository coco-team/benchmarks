...
-- 172 implications. 
assert (true -> (((not (((pre V43_avance0) and V45_retard0) or ((pre V45_retard0) and V43_avance0))) = (if ((pre V159_c) >= 9) then (not B0) else true)) 
...
and (true = (V38_nB0 < 1)) 
and ((V38_nB0 < 1) = (not (pre V43_avance0))) 
and ((not (pre V43_avance0)) = (V41_diff0 < 32767)) 
and (V48_ast = (V157_H0 and V158_H1)) 
and ((V157_H0 and V158_H1) = (V48_ast and (V38_nB0 < 1))) 
...
and (V165_X = V170_Sofar) 
and (V170_Sofar = (((V48_ast and (V38_nB0 < 1)) and (V39_nB1 < 1)) and (V40_nS < 1))) 
...
and (V43_avance0 = false) 
and (false = (if (not (pre V43_avance0)) then (V41_diff0 >= 10) else (V41_diff0 > 0))) 
and ((if (not (pre V43_avance0)) then (V41_diff0 >= 10) else (V41_diff0 > 0)) = ((pre V43_avance0) and V43_avance0)) 
and (((pre V43_avance0) and V43_avance0) = (V41_diff0 > 0)) 
and ((V41_diff0 > 0) = ((pre V43_avance0) and V45_retard0)) 
and (((pre V43_avance0) and V45_retard0) = (pre V43_avance0)) 
and ((pre V43_avance0) = ((pre V45_retard0) and V43_avance0)) 
and (((pre V45_retard0) and V43_avance0) = (V41_diff0 >= 10)) 
and ((V41_diff0 >= 10) = ((pre V159_c) >= 9)) 
and (((pre V159_c) >= 9) = (((pre V43_avance0) and V45_retard0) or ((pre V45_retard0) and V43_avance0))) 
and (V48_ast => V158_H1) 
and (V48_ast => V157_H0) 
...
and ((not (pre V44_avance1)) => (if ((pre V160_c) >= 9) then (not B1) else true)) 
and ((V42_diff1 >= 10) => (if (not (pre V44_avance1)) then (V42_diff1 >= 10) else (V42_diff1 > 0))) 
and (((pre V160_c) >= 9) => (pre V44_avance1)) 
and (((pre V160_c) >= 9) => (if (pre V46_retard1) then (not S) else true)) 
...
and (((if (pre V45_retard0) then (not S) else true) and (if ((pre V159_c) >= 9) then (not B0) else true)) => (if (pre V46_retard1) then (not S) else true)) 
and ((not (pre V45_retard0)) => (not (pre V46_retard1))) 
...
and ((V42_diff1 <= (- 10)) => (if ((pre V160_c) >= 9) then (not B1) else true)) 
and ((if (not (pre V46_retard1)) then (V42_diff1 <= (- 10)) else (V42_diff1 < 0)) => (V42_diff1 < 0)) 
and ((if (not (pre V46_retard1)) then (V42_diff1 <= (- 10)) else (V42_diff1 < 0)) => V45_retard0) 
...
and ((if (not (pre V44_avance1)) then (V42_diff1 >= 10) else (V42_diff1 > 0)) => (if (pre V46_retard1) then (not S) else true)) 
and ((V42_diff1 >= 10) => (if (pre V46_retard1) then (not S) else true)) 
and ((V165_X and (pre V170_Sofar)) => V165_X) 
and ((V40_nS < 1) => V157_H0) 
and ((pre V170_Sofar) => (not (pre V45_retard0))) 
...
and ((V165_X and (pre V170_Sofar)) => (pre V170_Sofar)) 
and (V165_X => V48_ast) 
...
and ((V165_X and (pre V170_Sofar)) => (not (pre V45_retard0))) 
and ((V165_X and (pre V170_Sofar)) => V48_ast) 
and ((V165_X and (pre V170_Sofar)) => ((if (pre V46_retard1) then (not S) else true) and (if ((pre V160_c) >= 9) then (not B1) else true))) 
and ((V165_X and (pre V170_Sofar)) => ((if (pre V45_retard0) then (not S) else true) and (if ((pre V159_c) >= 9) then (not B0) else true))) 
and (V165_X => (V40_nS < 1)) 
...
and (V38_nB0 = (((pre V38_nB0) - 1) + 1)) 
and ((((pre V38_nB0) - 1) + 1) = (if B0 then (((pre V38_nB0) - 1) + 1) else (pre V38_nB0))) 
and ((if B0 then (((pre V38_nB0) - 1) + 1) else (pre V38_nB0)) = (if ((pre V43_avance0) and V43_avance0) then (if B0 then (((pre V159_c) + 1) + 1) else (pre V159_c)) else 0)) 
and ((if ((pre V43_avance0) and V43_avance0) then (if B0 then (((pre V159_c) + 1) + 1) else (pre V159_c)) else 0) = (pre V159_c)) 
and ((pre V159_c) = 0) 
and (0 = (pre V38_nB0)) 
and ((V39_nB1 - V40_nS) = V42_diff1) 
and (1 = ((pre V159_c) + 1)) 
and (V41_diff0 <=(V39_nB1 - V40_nS)) 
and (V38_nB0 <=(if ((pre V44_avance1) and V44_avance1) then (if B1 then (((pre V160_c) + 1) + 1) else (pre V160_c)) else 0)) 
and (V38_nB0 <=(pre V40_nS)) 
and (V38_nB0 <=(pre V39_nB1)) 
and (V38_nB0 <=V40_nS) 
and (V38_nB0 <=(if S then ((pre V40_nS) + 1) else (pre V40_nS))) 
and (V38_nB0 <=V39_nB1) 
and (V38_nB0 <=(if B1 then ((pre V39_nB1) + 1) else (pre V39_nB1))) 
and (V38_nB0 <=1) 
and (V38_nB0 <=((pre V40_nS) + 1)) 
and (V38_nB0 <=((pre V39_nB1) + 1)) 
and (V38_nB0 <=(if B0 then (((pre V159_c) + 1) + 1) else (pre V159_c))) 
and (V38_nB0 <=(((pre V159_c) + 1) + 1)) 
and (V38_nB0 <=9) 
and (V38_nB0 <=10) 
and (V38_nB0 <=32767) 
and ((pre V160_c) <=(if B1 then (((pre V160_c) + 1) + 1) else (pre V160_c))) 
and (1 <=((pre V40_nS) + 1)) 
and (1 <=((pre V39_nB1) + 1)) 
and (1 <=(((pre V159_c) + 1) + 1)) 
and (1 <=9) 
and (1 <=10) 
and (1 <=32767) 
and ((((pre V159_c) + 1) + 1) <=9) 
and ((((pre V159_c) + 1) + 1) <=10) 
and ((((pre V159_c) + 1) + 1) <=32767) 
and ((- 10) <=((pre V38_nB0) - 1)) 
and (((pre V38_nB0) - 1) <=V38_nB0) 
and (V38_nB0 <=(pre V160_c)) 
...
and ((pre V160_c) <=((pre V160_c) + 1)) 
and (((pre V160_c) + 1) <=(((pre V160_c) + 1) + 1)) 
and ((if ((pre V44_avance1) and V44_avance1) then (if B1 then (((pre V160_c) + 1) + 1) else (pre V160_c)) else 0) <=(if B1 then (((pre V160_c) + 1) + 1) else (pre V160_c))) 
and ((if B1 then (((pre V160_c) + 1) + 1) else (pre V160_c)) <=(((pre V160_c) + 1) + 1)) 
...
and (1 <=((pre V160_c) + 1)) 
and (((pre V160_c) + 1) <=(((pre V160_c) + 1) + 1)) 
and ((if B0 then (((pre V159_c) + 1) + 1) else (pre V159_c)) <=(((pre V159_c) + 1) + 1)) 
