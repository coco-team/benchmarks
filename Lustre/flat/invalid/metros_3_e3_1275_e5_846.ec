...
and (V47_ast => V157_H1) 
and ((not (pre V45_retard0)) => V156_H0) 
...
and ((V41_diff0 >= 10) => (if (pre V45_retard0) then (not S) else true)) 
...
and ((((pre V158_c) - 1) - 1) <=((pre V158_c) - 1)) 
and ((((pre V159_c) - 1) - 1) <=(if B1 then (((pre V159_c) - 1) - 1) else (pre V159_c))) 
and ((((pre V159_c) - 1) - 1) <=(if ((pre V44_avance1) and V44_avance1) then (if B1 then (((pre V159_c) - 1) - 1) else (pre V159_c)) else 0)) 
and ((if B0 then (((pre V158_c) - 1) - 1) else (pre V158_c)) <=(pre V158_c)) 
and ((if B1 then (((pre V159_c) - 1) - 1) else (pre V159_c)) <=(pre V159_c)) 
and (0 <=(pre V38_nB0)) 
and (0 <=(pre V40_nS)) 
and (0 <=V40_nS) 
...
and ((if B0 then (((pre V158_c) - 1) - 1) else (pre V158_c)) <=(if ((pre V43_avance0) and V43_avance0) then (if B0 then (((pre V158_c) - 1) - 1) else (pre V158_c)) else 0)) 
and ((if ((pre V43_avance0) and V43_avance0) then (if B0 then (((pre V158_c) - 1) - 1) else (pre V158_c)) else 0) <=0) 
and (0 <=(pre V39_nB1)) 
and ((pre V39_nB1) <=(if B1 then ((pre V39_nB1) + 1) else (pre V39_nB1))) 
and ((if B1 then ((pre V39_nB1) + 1) else (pre V39_nB1)) <=((pre V39_nB1) + 1)) 
and ((((pre V159_c) - 1) - 1) <=((pre V159_c) - 1)) 
...
and ((pre V39_nB1) <=(if B1 then ((pre V39_nB1) + 1) else (pre V39_nB1))) 
and ((if B1 then ((pre V39_nB1) + 1) else (pre V39_nB1)) <=((pre V39_nB1) + 1)) 
and ((if B1 then (((pre V159_c) - 1) - 1) else (pre V159_c)) <=(if ((pre V44_avance1) and V44_avance1) then (if B1 then (((pre V159_c) - 1) - 1) else (pre V159_c)) else 0)) 
and ((if ((pre V44_avance1) and V44_avance1) then (if B1 then (((pre V159_c) - 1) - 1) else (pre V159_c)) else 0) <=0) 
and (0 <=(pre V39_nB1)) 
and ((pre V39_nB1) <=(if B1 then ((pre V39_nB1) + 1) else (pre V39_nB1))) 
and ((if B1 then ((pre V39_nB1) + 1) else (pre V39_nB1)) <=((pre V39_nB1) + 1)) 
