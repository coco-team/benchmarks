...
and (((pre V158_c) >= 9) => (if (pre V45_retard0) then (not S) else true)) 
...
and ((not B1) => (if ((pre V159_c) >= 9) then (not B1) else true)) 
and ((V38_nB0 - V40_nS) = V41_diff0) 
and ((V39_nB1 - V40_nS) = V42_diff1) 
and ((- 10) <=0) 
and ((- 10) <=(pre V158_c)) 
and ((- 10) <=(if ((pre V43_avance0) and V43_avance0) then (if B0 then (((pre V158_c) + 1) + 1) else (pre V158_c)) else 0)) 
and ((- 10) <=(pre V159_c)) 
and ((- 10) <=(if ((pre V44_avance1) and V44_avance1) then (if B1 then (((pre V159_c) + 1) + 1) else (pre V159_c)) else 0)) 
and ((- 10) <=(pre V40_nS)) 
and ((- 10) <=(pre V39_nB1)) 
and ((- 10) <=V38_nB0) 
and ((- 10) <=V40_nS) 
and ((- 10) <=(if S then ((pre V40_nS) + 1) else (pre V40_nS))) 
and ((- 10) <=(if B0 then (((pre V158_c) + 1) + 1) else (pre V158_c))) 
and ((- 10) <=V39_nB1) 
and ((- 10) <=(if B1 then ((pre V39_nB1) + 1) else (pre V39_nB1))) 
and ((- 10) <=1) 
and ((- 10) <=((pre V158_c) + 1)) 
and ((- 10) <=((pre V159_c) + 1)) 
and ((- 10) <=((pre V40_nS) + 1)) 
and ((- 10) <=((pre V39_nB1) + 1)) 
and ((- 10) <=(if B1 then (((pre V159_c) + 1) + 1) else (pre V159_c))) 
and ((- 10) <=(((pre V158_c) + 1) + 1)) 
and ((- 10) <=(((pre V159_c) + 1) + 1)) 
and ((- 10) <=9) 
and ((- 10) <=10) 
and ((- 10) <=30) 
and (0 <=(if ((pre V43_avance0) and V43_avance0) then (if B0 then (((pre V158_c) + 1) + 1) else (pre V158_c)) else 0)) 
and (0 <=(pre V159_c)) 
and (0 <=(if ((pre V44_avance1) and V44_avance1) then (if B1 then (((pre V159_c) + 1) + 1) else (pre V159_c)) else 0)) 
and (0 <=(pre V38_nB0)) 
and (0 <=(pre V40_nS)) 
and (0 <=(pre V39_nB1)) 
and (0 <=V38_nB0) 
...
and (0 <=((pre V40_nS) + 1)) 
and (0 <=((pre V39_nB1) + 1)) 
and (0 <=(if B1 then (((pre V159_c) + 1) + 1) else (pre V159_c))) 
...
and ((if B0 then ((pre V38_nB0) + 1) else (pre V38_nB0)) <=((pre V38_nB0) + 1)) 
and (0 <=(pre V158_c)) 
and ((pre V158_c) <=(if B0 then (((pre V158_c) + 1) + 1) else (pre V158_c))) 
and ((if B0 then (((pre V158_c) + 1) + 1) else (pre V158_c)) <=(((pre V158_c) + 1) + 1)) 
and ((if ((pre V43_avance0) and V43_avance0) then (if B0 then (((pre V158_c) + 1) + 1) else (pre V158_c)) else 0) <=(if B0 then (((pre V158_c) + 1) + 1) else (pre V158_c))) 
and ((if B0 then (((pre V158_c) + 1) + 1) else (pre V158_c)) <=(((pre V158_c) + 1) + 1)) 
and ((pre V159_c) <=((pre V159_c) + 1)) 
and (((pre V159_c) + 1) <=(((pre V159_c) + 1) + 1)) 
and ((if ((pre V44_avance1) and V44_avance1) then (if B1 then (((pre V159_c) + 1) + 1) else (pre V159_c)) else 0) <=(if B1 then (((pre V159_c) + 1) + 1) else (pre V159_c))) 
and ((if B1 then (((pre V159_c) + 1) + 1) else (pre V159_c)) <=(((pre V159_c) + 1) + 1)) 
...
and ((if B1 then ((pre V39_nB1) + 1) else (pre V39_nB1)) <=((pre V39_nB1) + 1)) 
and (1 <=((pre V158_c) + 1)) 
and (((pre V158_c) + 1) <=(((pre V158_c) + 1) + 1)) 
and (9 <=10) 
and (10 <=30) 
and  true ));
tel.
