...
let
  ...
  V47_pOK = (true -> (not ((((pre V43_avance0) and V45_retard0) and (pre 
...
-- 184 implications. 
assert (true -> (((not ((((pre V43_avance0) and V45_retard0) and (pre V45_retard0)) and V43_avance0)) = (V170_Sofar => (pre V47_pOK))) 
and ((V170_Sofar => (pre V47_pOK)) = (pre V47_pOK)) 
and ((pre V47_pOK) = true) 
and (V48_ast = (V157_H0 and V158_H1)) 
and (V165_X = V170_Sofar) 
and (V170_Sofar = ((((V48_ast and (V38_nB0 < 1)) and (V39_nB1 < 1)) and (V40_nS < 1)) and (V41_diff0 < 32767))) 
and (((((V48_ast and (V38_nB0 < 1)) and (V39_nB1 < 1)) and (V40_nS < 1)) and (V41_diff0 < 32767)) = (((V48_ast and (V38_nB0 < 1)) and (V39_nB1 < 1)) and (V40_nS < 1))) 
...
and (false = (((pre V43_avance0) and V45_retard0) and (pre V45_retard0))) 
and ((((pre V43_avance0) and V45_retard0) and (pre V45_retard0)) = ((pre V43_avance0) and V45_retard0)) 
and (((pre V43_avance0) and V45_retard0) = ((((pre V43_avance0) and V45_retard0) and (pre V45_retard0)) and V43_avance0)) 
...
and (((pre V159_c) >= 9) => (pre V43_avance0)) 
and (V48_ast => V157_H0) 
...
and (((pre V43_avance0) and V43_avance0) => (if (pre V45_retard0) then (not S) else true)) 
...
and ((not (pre V43_avance0)) => (if ((pre V159_c) >= 9) then (not B0) else true)) 
...
and ((pre V43_avance0) => (if (pre V45_retard0) then (not S) else true)) 
...
and ((pre V170_Sofar) => V48_ast) 
and ((pre V170_Sofar) => (if (pre V46_retard1) then (not S) else true)) 
and ((pre V170_Sofar) => (if (pre V45_retard0) then (not S) else true)) 
and ((pre V170_Sofar) => ((if (pre V46_retard1) then (not S) else true) and (if ((pre V160_c) >= 9) then (not B1) else true))) 
...
and ((pre V170_Sofar) => (V41_diff0 < 32767)) 
and ((pre V170_Sofar) => V157_H0) 
and ((pre V170_Sofar) => (not (pre V43_avance0))) 
and ((pre V170_Sofar) => (not (pre V44_avance1))) 
and ((V42_diff1 > 0) => (not (pre V46_retard1))) 
and ((V42_diff1 > 0) => (if (pre V46_retard1) then (not S) else true)) 
...
and (0 <=(if ((pre V43_avance0) and V43_avance0) then (if B0 then (((pre V159_c) + 1) + 1) else (pre V159_c)) else 0)) 
and (0 <=(pre V160_c)) 
and (0 <=(if ((pre V44_avance1) and V44_avance1) then (if B1 then (((pre V160_c) + 1) + 1) else (pre V160_c)) else 0)) 
and (0 <=(pre V40_nS)) 
and (0 <=(pre V39_nB1)) 
and (0 <=(pre V38_nB0)) 
and (0 <=V40_nS) 
...
and (0 <=(if B1 then (((pre V160_c) + 1) + 1) else (pre V160_c))) 
and (0 <=1) 
and (0 <=((pre V160_c) + 1)) 
and (0 <=((pre V40_nS) + 1)) 
and (0 <=((pre V39_nB1) + 1)) 
...
and ((- 10) <=0) 
and (0 <=(pre V159_c)) 
and ((pre V159_c) <=(if B0 then (((pre V159_c) + 1) + 1) else (pre V159_c))) 
and ((if B0 then (((pre V159_c) + 1) + 1) else (pre V159_c)) <=(((pre V159_c) + 1) + 1)) 
and ((if ((pre V43_avance0) and V43_avance0) then (if B0 then (((pre V159_c) + 1) + 1) else (pre V159_c)) else 0) <=(if B0 then (((pre V159_c) + 1) + 1) else (pre V159_c))) 
and ((if B0 then (((pre V159_c) + 1) + 1) else (pre V159_c)) <=(((pre V159_c) + 1) + 1)) 
...
and ((if B1 then ((pre V39_nB1) + 1) else (pre V39_nB1)) <=((pre V39_nB1) + 1)) 
and (1 <=((pre V159_c) + 1)) 
and (((pre V159_c) + 1) <=(((pre V159_c) + 1) + 1)) 
