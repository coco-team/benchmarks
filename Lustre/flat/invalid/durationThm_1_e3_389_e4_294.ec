...
and (V68_age_of_p = (((pre V52_age_of_p) + 1) - 1)) 
and ((((pre V52_age_of_p) + 1) - 1) = (if (pre p) then (((pre V45_age_of_p) + 1) - 1) else 0)) 
and ((if (pre p) then (((pre V45_age_of_p) + 1) - 1) else 0) = (pre V52_age_of_p)) 
and ((pre V52_age_of_p) = (((pre V68_age_of_p) + 1) - 1)) 
and ((((pre V68_age_of_p) + 1) - 1) = 0) 
and (0 = (pre V68_age_of_p)) 
and ((pre V68_age_of_p) = (if (pre p) then (((pre V68_age_of_p) + 1) - 1) else 0)) 
and ((if (pre p) then (((pre V68_age_of_p) + 1) - 1) else 0) = (pre V45_age_of_p)) 
and ((pre V45_age_of_p) = V45_age_of_p) 
and (V45_age_of_p = (if (pre q) then (((pre V52_age_of_p) + 1) - 1) else 0)) 
and ((if (pre q) then (((pre V52_age_of_p) + 1) - 1) else 0) = V52_age_of_p) 
and (V52_age_of_p = (((pre V45_age_of_p) + 1) - 1)) 
and (((pre V45_age_of_p) + 1) = ((pre V52_age_of_p) + 1)) 
and (((pre V52_age_of_p) + 1) = 1) 
and (1 = ((pre V68_age_of_p) + 1)) 
and (V68_age_of_p <=((pre V45_age_of_p) + 1)) 
and  true ));
tel.
