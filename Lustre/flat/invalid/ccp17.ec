...
let
  OK = ((not V230_zz198) or V227_zz195);
  ...
  V23_OKb = ((not V230_zz198) or V232_zz200);
  V25_OKa = ((not (not V241_zz209)) or (not V231_zz199));
...
and ((V178_zz146 <= 8) = ((not V230_zz198) or V227_zz195)) 
and (((not V230_zz198) or V227_zz195) = ((V103_zz71 >= 3) and (V103_zz71 <= 6))) 
...
and ((V222_zz190 = (0 / 10)) = V227_zz195) 
...
and (((V77_zz45 = 5) and ((not ((if ((V203_zz171 = false) = false) then 0 else 1) = 0)) and (not V75_zz43))) => ((if ((V212_zz180 = true) = false) then 0 else 1) = 0)) 
and (((V77_zz45 = 5) and ((not ((if ((V203_zz171 = false) = false) then 0 else 1) = 0)) and (not V75_zz43))) => (not (V87_zz55 = 4))) 
...
and ((V229_zz197 or V228_zz196) => (not (V64_zz32 = 5))) 
and ((V229_zz197 or V228_zz196) => (not (V121_zz89 = 8))) 
and ((V229_zz197 or V228_zz196) => (V222_zz190 = (0 / 10))) 
...
and ((V70_zz38 = 6) => (not V230_zz198)) 
and ((V116_zz84 = 6) => (not V63_zz31)) 
and ((V116_zz84 = 6) => (V127_zz95 >= 3)) 
and ((V162_zz130 = 6) => (not (V95_zz63 = 4))) 
...
and ((V253_zz221 < (0 / 10)) => (V222_zz190 = (0 / 10))) 
...
and ((if ((not V80_zz48) and (V82_zz50 = 4)) then false else V71_zz39) => (if V56_zz24 then true else V58_zz26)) 
...
and (V209_zz177 => (not (V81_zz49 = 4))) 
and ((pre V249_zz217) => (not V75_zz43)) 
and (V209_zz177 => ((if ((V217_zz185 = true) = false) then 0 else 1) = 0)) 
...
and (((not V80_zz48) and (V82_zz50 = 4)) => V241_zz209) 
...
and (V131_zz99 => (not ((if ((V218_zz186 = true) = false) then 0 else 1) = 0))) 
...
and ((V129_zz97 = 8) => (not V230_zz198)) 
...
and ((if ((not V80_zz48) and (V82_zz50 = 4)) then false else V71_zz39) => decelSet) 
...
and (V80_zz48 => (not V171_zz139)) 
and (((V140_zz108 >= 3) and (V140_zz108 <= 6)) => (not V171_zz139)) 
...
and ((V229_zz197 or V228_zz196) => (not V248_zz216)) 
and ((V222_zz190 = (0 / 10)) => (not (V64_zz32 = 5))) 
and ((V222_zz190 = (0 / 10)) => (not V249_zz217)) 
...
and ((V131_zz99 or V126_zz94) => (not (V64_zz32 = 5))) 
and ((V131_zz99 or V126_zz94) => (V136_zz104 or V132_zz100)) 
and ((V123_zz91 = 8) => (not V171_zz139)) 
...
and (((((not cancel) and (not brakePedal)) and V213_zz181) and V214_zz182) => V213_zz181) 
...
and ((not V230_zz198) => (not V171_zz139)) 
...
and ((not ((if ((V218_zz186 = true) = false) then 0 else 1) = 0)) => (not cancel)) 
...
and ((if ((not V80_zz48) and (V82_zz50 = 4)) then false else V71_zz39) => (not ((if ((V217_zz185 = true) = false) then 0 else 1) = 0))) 
...
and (V229_zz197 => ((not ((V178_zz146 >= 2) and (V178_zz146 <= 8))) and ((V147_zz115 >= 2) and (V147_zz115 <= 8)))) 
and ((V133_zz101 <= 6) => (not (V147_zz115 = 7))) 
and ((V179_zz147 <= 6) => (not (V121_zz89 = 8))) 
and ((V179_zz147 <= 6) => (not (V147_zz115 = 7))) 
and (V229_zz197 => (V229_zz197 or V228_zz196)) 
and (V229_zz197 => (not (V70_zz38 = 6))) 
and (V229_zz197 => (not (V64_zz32 = 5))) 
and (V229_zz197 => (not V249_zz217)) 
and (V229_zz197 => (not V80_zz48)) 
and (V229_zz197 => (not ((V138_zz106 >= 3) and (V138_zz106 <= 6)))) 
and (V229_zz197 => (not (V81_zz49 = 4))) 
...
and (V169_zz137 <=(if V171_zz139 then V153_zz121 else V172_zz140)) 
...
and (V169_zz137 <=(if V176_zz144 then V150_zz118 else V178_zz146)) 
