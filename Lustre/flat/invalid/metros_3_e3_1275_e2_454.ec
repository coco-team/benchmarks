...
and ((if B0 then (((pre V38_nB0) - 1) + 1) else (pre V38_nB0)) = (pre V158_c)) 
and ((pre V158_c) = (if ((pre V43_avance0) and V43_avance0) then (if B0 then ((pre V158_c) - 1) else (pre V158_c)) else 0)) 
and ((if ((pre V43_avance0) and V43_avance0) then (if B0 then ((pre V158_c) - 1) else (pre V158_c)) else 0) = (pre V38_nB0)) 
and ((pre V38_nB0) = 0) 
...
and (((pre V38_nB0) - 1) <=(if B0 then ((pre V158_c) - 1) else (pre V158_c))) 
and ((if B0 then ((pre V158_c) - 1) else (pre V158_c)) <=V38_nB0) 
...
and ((if ((pre V44_avance1) and V44_avance1) then (if B1 then ((pre V159_c) - 1) else (pre V159_c)) else 0) <=V38_nB0) 
and (V38_nB0 <=(pre V40_nS)) 
and ((pre V40_nS) <=(if S then ((pre V40_nS) + 1) else (pre V40_nS))) 
and ((if S then ((pre V40_nS) + 1) else (pre V40_nS)) <=((pre V40_nS) + 1)) 
and (((pre V38_nB0) - (pre V39_nB1)) <=(pre V159_c)) 
and ((pre V159_c) <=V38_nB0) 
and (V38_nB0 <=(pre V40_nS)) 
and ((pre V40_nS) <=(if S then ((pre V40_nS) + 1) else (pre V40_nS))) 
and ((if S then ((pre V40_nS) + 1) else (pre V40_nS)) <=((pre V40_nS) + 1)) 
