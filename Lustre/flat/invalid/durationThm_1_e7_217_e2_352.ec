...
and (((pre V52_age_of_p) - 1) = ((pre V68_age_of_p) - 1)) 
and (((pre V68_age_of_p) - 1) = ((pre V45_age_of_p) - 1)) 
and (V68_age_of_p = (((pre V45_age_of_p) - 1) + 1)) 
...
and ((if (pre p) then (((pre V68_age_of_p) - 1) + 1) else 0) = (((pre V52_age_of_p) - 1) + 1)) 
and ((((pre V52_age_of_p) - 1) + 1) = (pre V45_age_of_p)) 
...
and (V52_age_of_p = (((pre V68_age_of_p) - 1) + 1)) 
and (((pre V52_age_of_p) - 1) <=V68_age_of_p) 
and (V68_age_of_p <=1) 
and  true ));
tel.
