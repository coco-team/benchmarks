...
let
  ...
  V160_c = (0 -> (if ((pre V43_avance0) and V43_avance0) then (if B0 then ((pre 
  V160_c) + 1) else (pre V160_c)) else 0));
  V161_c = (0 -> (if ((pre V44_avance1) and V44_avance1) then (if B1 then ((pre 
  V161_c) + 1) else (pre V161_c)) else 0));
...
-- 137 implications. 
assert (true -> ((V47_ast = (V158_H0 and V159_H1)) 
...
and (((pre V160_c) >= 9) => ((- 10) <= (pre V41_diff0))) 
...
and ((not B1) => (if ((pre V161_c) >= 9) then (not B1) else true)) 
...
and (0 <=(if ((pre V44_avance1) and V44_avance1) then (if B1 then ((pre V161_c) + 1) else (pre V161_c)) else 0)) 
and (0 <=(pre V160_c)) 
and (0 <=(if ((pre V43_avance0) and V43_avance0) then (if B0 then ((pre V160_c) + 1) else (pre V160_c)) else 0)) 
and (0 <=(pre V40_nS)) 
and (0 <=(pre V38_nB0)) 
and (0 <=V40_nS) 
and (0 <=(if S then ((pre V40_nS) + 1) else (pre V40_nS))) 
and (0 <=V39_nB1) 
and (0 <=(if B0 then ((pre V160_c) + 1) else (pre V160_c))) 
and (0 <=V38_nB0) 
...
and (0 <=10) 
and (0 <=20) 
and ((pre V161_c) <=(if B1 then ((pre V161_c) + 1) else (pre V161_c))) 
and ((pre V161_c) <=((pre V161_c) + 1)) 
and ((if ((pre V44_avance1) and V44_avance1) then (if B1 then ((pre V161_c) + 1) else (pre V161_c)) else 0) <=V39_nB1) 
and ((pre V160_c) <=(if B0 then ((pre V160_c) + 1) else (pre V160_c))) 
and ((pre V160_c) <=((pre V160_c) + 1)) 
and ((if ((pre V43_avance0) and V43_avance0) then (if B0 then ((pre V160_c) + 1) else (pre V160_c)) else 0) <=V38_nB0) 
and ((if B1 then ((pre V161_c) + 1) else (pre V161_c)) <=((pre V161_c) + 1)) 
and ((if B0 then ((pre V160_c) + 1) else (pre V160_c)) <=((pre V160_c) + 1)) 
and (1 <=((pre V160_c) + 1)) 
and (1 <=((pre V40_nS) + 1)) 
and (1 <=((pre V38_nB0) + 1)) 
and (1 <=9) 
...
and ((- 10) <=0) 
and (0 <=(pre V161_c)) 
and ((pre V161_c) <=(pre V39_nB1)) 
and ((pre V39_nB1) <=(if B1 then ((pre V39_nB1) + 1) else (pre V39_nB1))) 
and ((if B1 then ((pre V39_nB1) + 1) else (pre V39_nB1)) <=((pre V39_nB1) + 1)) 
and ((if ((pre V44_avance1) and V44_avance1) then (if B1 then ((pre V161_c) + 1) else (pre V161_c)) else 0) <=(if B1 then ((pre V161_c) + 1) else (pre V161_c))) 
and ((if B1 then ((pre V161_c) + 1) else (pre V161_c)) <=(if B1 then ((pre V39_nB1) + 1) else (pre V39_nB1))) 
and ((if B1 then ((pre V39_nB1) + 1) else (pre V39_nB1)) <=((pre V39_nB1) + 1)) 
and ((pre V160_c) <=(pre V38_nB0)) 
and ((pre V38_nB0) <=(if B0 then ((pre V38_nB0) + 1) else (pre V38_nB0))) 
and ((if B0 then ((pre V38_nB0) + 1) else (pre V38_nB0)) <=((pre V38_nB0) + 1)) 
and ((if ((pre V43_avance0) and V43_avance0) then (if B0 then ((pre V160_c) + 1) else (pre V160_c)) else 0) <=(if B0 then ((pre V160_c) + 1) else (pre V160_c))) 
and ((if B0 then ((pre V160_c) + 1) else (pre V160_c)) <=(if B0 then ((pre V38_nB0) + 1) else (pre V38_nB0))) 
and ((if B0 then ((pre V38_nB0) + 1) else (pre V38_nB0)) <=((pre V38_nB0) + 1)) 
...
and ((if S then ((pre V40_nS) + 1) else (pre V40_nS)) <=((pre V40_nS) + 1)) 
and (1 <=((pre V161_c) + 1)) 
and (((pre V161_c) + 1) <=((pre V39_nB1) + 1)) 
and (((pre V160_c) + 1) <=((pre V38_nB0) + 1)) 
and (9 <=10) 
and (10 <=20) 
and  true ));
tel.
