...
and (((pre V45_retard0) and V43_avance0) = ((pre V159_c) >= 9)) 
...
and ((V41_diff0 > 0) => ((if (pre V45_retard0) then (not S) else true) and (if ((pre V159_c) >= 9) then (not B0) else true))) 
...
and ((((pre V160_c) - 1) + 1) = (if ((pre V44_avance1) and V44_avance1) then (if B1 then (((pre V160_c) - 1) + 1) else (pre V160_c)) else 0)) 
and ((if ((pre V44_avance1) and V44_avance1) then (if B1 then (((pre V160_c) - 1) + 1) else (pre V160_c)) else 0) = (if B0 then (((pre V159_c) - 1) + 1) else (pre V159_c))) 
and ((if B0 then (((pre V159_c) - 1) + 1) else (pre V159_c)) = (if ((pre V43_avance0) and V43_avance0) then (if B0 then (((pre V159_c) - 1) + 1) else (pre V159_c)) else 0)) 
and ((if ((pre V43_avance0) and V43_avance0) then (if B0 then (((pre V159_c) - 1) + 1) else (pre V159_c)) else 0) = (pre V159_c)) 
and ((pre V159_c) = 0) 
and (0 = (pre V160_c)) 
and ((pre V160_c) = (((pre V159_c) - 1) + 1)) 
and ((((pre V159_c) - 1) + 1) = (if B1 then (((pre V160_c) - 1) + 1) else (pre V160_c))) 
and ((V39_nB1 - V40_nS) = V42_diff1) 
and ((V38_nB0 - V40_nS) = V41_diff0) 
and ((((pre V160_c) - 1) + 1) <=(pre V39_nB1)) 
and ((((pre V160_c) - 1) + 1) <=(pre V38_nB0)) 
and ((((pre V160_c) - 1) + 1) <=V40_nS) 
and ((((pre V160_c) - 1) + 1) <=V39_nB1) 
and ((((pre V160_c) - 1) + 1) <=(if B1 then ((pre V39_nB1) + 1) else (pre V39_nB1))) 
and ((((pre V160_c) - 1) + 1) <=1) 
and ((((pre V160_c) - 1) + 1) <=((pre V39_nB1) + 1)) 
and ((((pre V160_c) - 1) + 1) <=((pre V38_nB0) + 1)) 
and ((((pre V160_c) - 1) + 1) <=V38_nB0) 
and ((((pre V160_c) - 1) + 1) <=(if B0 then (((pre V38_nB0) + 1) + 1) else (pre V38_nB0))) 
and ((((pre V160_c) - 1) + 1) <=(((pre V38_nB0) + 1) + 1)) 
and ((((pre V160_c) - 1) + 1) <=9) 
and ((((pre V160_c) - 1) + 1) <=10) 
and ((((pre V160_c) - 1) + 1) <=32767) 
...
and (1 <=32767) 
and ((- 10) <=((pre V159_c) - 1)) 
and (((pre V159_c) - 1) <=(((pre V160_c) - 1) + 1)) 
and ((((pre V160_c) - 1) + 1) <=(pre V40_nS)) 
