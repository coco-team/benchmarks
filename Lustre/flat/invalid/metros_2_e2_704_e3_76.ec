...
and (V47_ast => V159_H1) 
and ((((- 10) <= (pre V41_diff0)) and ((pre V41_diff0) <= 20)) => (pre V170_Sofar)) 
and ((((- 10) <= (pre V41_diff0)) and ((pre V41_diff0) <= 20)) => (V170_Sofar => (((- 10) <= (pre V41_diff0)) and ((pre V41_diff0) <= 20)))) 
and ((not (pre V45_retard0)) => ((if (pre V46_retard1) then (not S) else true) and (if ((pre V161_c) >= 9) then (not B1) else true))) 
and ((not (pre V45_retard0)) => (V47_ast and (pre V170_Sofar))) 
and ((not (pre V45_retard0)) => (not (pre V46_retard1))) 
and ((not (pre V45_retard0)) => (((- 10) <= (pre V41_diff0)) and ((pre V41_diff0) <= 20))) 
and ((not (pre V45_retard0)) => V170_Sofar) 
...
and (V38_nB0 <=(if B1 then (((pre V161_c) - 1) + 1) else (pre V161_c))) 
and ((if B1 then (((pre V161_c) - 1) + 1) else (pre V161_c)) <=(pre V40_nS)) 
and ((pre V40_nS) <=(if S then ((pre V40_nS) + 1) else (pre V40_nS))) 
and ((if S then ((pre V40_nS) + 1) else (pre V40_nS)) <=((pre V40_nS) + 1)) 
...
and ((pre V38_nB0) <=(if B1 then (((pre V161_c) - 1) + 1) else (pre V161_c))) 
and ((if B1 then (((pre V161_c) - 1) + 1) else (pre V161_c)) <=(pre V40_nS)) 
and ((pre V40_nS) <=(if S then ((pre V40_nS) + 1) else (pre V40_nS))) 
and ((if S then ((pre V40_nS) + 1) else (pre V40_nS)) <=((pre V40_nS) + 1)) 
