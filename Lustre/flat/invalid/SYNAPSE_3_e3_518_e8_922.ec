...
and ((((e_s1 and e_s2) and e_s1) and e_s3) => (V34_env => (((V30_invalid_s + V31_valid_s) + V32_dirty_s) = V106_First))) 
...
and ((((pre V30_invalid_s) + (pre V32_dirty_s)) + (pre V31_valid_s)) <=(pre V106_First)) 
