...
let
  OK = (V33_env => (((not (V29_modified_me > 2)) and (V30_exclusive_me >= 0)) 
  and ((V29_modified_me <= 1) or (V31_shared_me <= 1))));
...
-- 197 implications. 
assert (true -> (((((not (V29_modified_me > 2)) and (V30_exclusive_me >= 0)) and ((V29_modified_me <= 1) or (V31_shared_me <= 1))) = true) 
and (true = (V29_modified_me <= 1)) 
and ((V29_modified_me <= 1) = ((V29_modified_me <= 1) or (V31_shared_me <= 1))) 
and (((V29_modified_me <= 1) or (V31_shared_me <= 1)) = (V30_exclusive_me >= 0)) 
and ((V30_exclusive_me >= 0) = (not (V29_modified_me > 2))) 
and ((not (V29_modified_me > 2)) = ((not (V29_modified_me > 2)) and (V30_exclusive_me >= 0))) 
and (((not (V29_modified_me > 2)) and (V30_exclusive_me >= 0)) = (V33_env => (((not (V29_modified_me > 2)) and (V30_exclusive_me >= 0)) and ((V29_modified_me <= 1) or (V31_shared_me <= 1))))) 
and ((V33_env => (((not (V29_modified_me > 2)) and (V30_exclusive_me >= 0)) and ((V29_modified_me <= 1) or (V31_shared_me <= 1)))) = (V31_shared_me <= 1)) 
and (((pre V32_invalid_me) >= 1) = V74_garde_me1) 
and (V74_garde_me1 = V77_garde_me4) 
and (((not ((((((etat_me1 and etat_me2) or (etat_me1 and etat_me3)) or (etat_me1 and etat_me4)) or (etat_me2 and etat_me3)) or (etat_me2 and etat_me4)) or (etat_me3 and etat_me4))) and (V29_modified_me >= 0)) = V92_X) 
and (((pre V30_exclusive_me) >= 1) = V75_garde_me2) 
and ((V29_modified_me > 2) = false) 
and (false = ((pre V31_shared_me) >= 1)) 
and (((pre V31_shared_me) >= 1) = V76_garde_me3) 
and ((V92_X and (pre V33_env)) => V33_env) 
and (((not ((((((etat_me1 and etat_me2) or (etat_me1 and etat_me3)) or (etat_me1 and etat_me4)) or (etat_me2 and etat_me3)) or (etat_me2 and etat_me4)) or (etat_me3 and etat_me4))) and (V29_modified_me >= 0)) => (not ((((((etat_me1 and etat_me2) or (etat_me1 and etat_me3)) or (etat_me1 and etat_me4)) or (etat_me2 and etat_me3)) or (etat_me2 and etat_me4)) or (etat_me3 and etat_me4)))) 
...
and (((not ((((((etat_me1 and etat_me2) or (etat_me1 and etat_me3)) or (etat_me1 and etat_me4)) or (etat_me2 and etat_me3)) or (etat_me2 and etat_me4)) or (etat_me3 and etat_me4))) and (V29_modified_me >= 0)) => (V29_modified_me >= 0)) 
...
and (V33_env => ((not ((((((etat_me1 and etat_me2) or (etat_me1 and etat_me3)) or (etat_me1 and etat_me4)) or (etat_me2 and etat_me3)) or (etat_me2 and etat_me4)) or (etat_me3 and etat_me4))) and (V29_modified_me >= 0))) 
and ((if V75_garde_me2 then (pre V31_shared_me) else (pre V31_shared_me)) = (if V76_garde_me3 then 0 else (pre V31_shared_me))) 
and ((if V76_garde_me3 then 0 else (pre V31_shared_me)) = (pre V31_shared_me)) 
and ((pre V29_modified_me) = (if V76_garde_me3 then 0 else (pre V29_modified_me))) 
and ((if V74_garde_me1 then 0 else (pre V29_modified_me)) = (if V77_garde_me4 then 0 else (pre V29_modified_me))) 
and ((if V75_garde_me2 then ((pre V30_exclusive_me) - 1) else (pre V30_exclusive_me)) = 0) 
...
and (((((pre V31_shared_me) + (pre V30_exclusive_me)) + (pre V29_modified_me)) - 1) <=(if V74_garde_me1 then 0 else (pre V29_modified_me))) 
and ((if V74_garde_me1 then ((((pre V31_shared_me) + (pre V30_exclusive_me)) + (pre V29_modified_me)) - 1) else (pre V31_shared_me)) <=(if V75_garde_me2 then (pre V31_shared_me) else (pre V31_shared_me))) 
...
and ((if etat_me1 then (if V74_garde_me1 then ((((pre V31_shared_me) + (pre V30_exclusive_me)) + (pre V29_modified_me)) - 1) else (pre V31_shared_me)) else (if etat_me2 then (if V75_garde_me2 then (pre V31_shared_me) else (pre V31_shared_me)) else (if etat_me3 then (if V76_garde_me3 then 0 else (pre V31_shared_me)) else (if etat_me4 then (if V77_garde_me4 then 0 else (pre V31_shared_me)) else (pre V31_shared_me))))) <=(if etat_me4 then (if V77_garde_me4 then 0 else (pre V31_shared_me)) else (pre V31_shared_me))) 
and ((if etat_me1 then (if V74_garde_me1 then ((((pre V31_shared_me) + (pre V30_exclusive_me)) + (pre V29_modified_me)) - 1) else (pre V31_shared_me)) else (if etat_me2 then (if V75_garde_me2 then (pre V31_shared_me) else (pre V31_shared_me)) else (if etat_me3 then (if V76_garde_me3 then 0 else (pre V31_shared_me)) else (if etat_me4 then (if V77_garde_me4 then 0 else (pre V31_shared_me)) else (pre V31_shared_me))))) <=(if V77_garde_me4 then 0 else (pre V31_shared_me))) 
and ((if V75_garde_me2 then (pre V31_shared_me) else (pre V31_shared_me)) <=(if etat_me2 then (if V75_garde_me2 then (pre V31_shared_me) else (pre V31_shared_me)) else (if etat_me3 then (if V76_garde_me3 then 0 else (pre V31_shared_me)) else (if etat_me4 then (if V77_garde_me4 then 0 else (pre V31_shared_me)) else (pre V31_shared_me))))) 
and ((if V75_garde_me2 then (pre V31_shared_me) else (pre V31_shared_me)) <=(if etat_me3 then (if V76_garde_me3 then 0 else (pre V31_shared_me)) else (if etat_me4 then (if V77_garde_me4 then 0 else (pre V31_shared_me)) else (pre V31_shared_me)))) 
and ((if V75_garde_me2 then (pre V31_shared_me) else (pre V31_shared_me)) <=(if etat_me4 then (if V77_garde_me4 then 0 else (pre V31_shared_me)) else (pre V31_shared_me))) 
and ((if V75_garde_me2 then (pre V31_shared_me) else (pre V31_shared_me)) <=(if V77_garde_me4 then 0 else (pre V31_shared_me))) 
and ((if V75_garde_me2 then (pre V31_shared_me) else (pre V31_shared_me)) <=(if V75_garde_me2 then ((pre V30_exclusive_me) - 1) else (pre V30_exclusive_me))) 
and ((if V75_garde_me2 then (pre V31_shared_me) else (pre V31_shared_me)) <=(if V74_garde_me1 then 0 else (pre V30_exclusive_me))) 
and ((if V75_garde_me2 then (pre V31_shared_me) else (pre V31_shared_me)) <=V30_exclusive_me) 
...
and ((if etat_me1 then (if V74_garde_me1 then 0 else (pre V29_modified_me)) else (if etat_me2 then (if V75_garde_me2 then ((pre V29_modified_me) - 1) else (pre V29_modified_me)) else (if etat_me3 then (if V76_garde_me3 then 0 else (pre V29_modified_me)) else (if etat_me4 then (if V77_garde_me4 then 0 else (pre V29_modified_me)) else (pre V29_modified_me))))) <=(if V74_garde_me1 then 0 else (pre V29_modified_me))) 
and ((if V75_garde_me2 then ((pre V30_exclusive_me) - 1) else (pre V30_exclusive_me)) <=V30_exclusive_me) 
and ((if V75_garde_me2 then ((pre V30_exclusive_me) - 1) else (pre V30_exclusive_me)) <=(if etat_me1 then (if V74_garde_me1 then 0 else (pre V30_exclusive_me)) else (if etat_me2 then (if V75_garde_me2 then ((pre V30_exclusive_me) - 1) else (pre V30_exclusive_me)) else (if etat_me3 then (if V76_garde_me3 then 1 else (pre V30_exclusive_me)) else (if etat_me4 then (if V77_garde_me4 then 1 else (pre V30_exclusive_me)) else (pre V30_exclusive_me)))))) 
and ((if V75_garde_me2 then ((pre V30_exclusive_me) - 1) else (pre V30_exclusive_me)) <=(if etat_me2 then (if V75_garde_me2 then ((pre V30_exclusive_me) - 1) else (pre V30_exclusive_me)) else (if etat_me3 then (if V76_garde_me3 then 1 else (pre V30_exclusive_me)) else (if etat_me4 then (if V77_garde_me4 then 1 else (pre V30_exclusive_me)) else (pre V30_exclusive_me))))) 
...
and ((if etat_me1 then (if V74_garde_me1 then ((((pre V31_shared_me) + (pre V30_exclusive_me)) + (pre V29_modified_me)) - 1) else (pre V31_shared_me)) else (if etat_me2 then (if V75_garde_me2 then (pre V31_shared_me) else (pre V31_shared_me)) else (if etat_me3 then (if V76_garde_me3 then 0 else (pre V31_shared_me)) else (if etat_me4 then (if V77_garde_me4 then 0 else (pre V31_shared_me)) else (pre V31_shared_me))))) <=V31_shared_me) 
and (V31_shared_me <=(if V75_garde_me2 then ((pre V30_exclusive_me) - 1) else (pre V30_exclusive_me))) 
and ((if V75_garde_me2 then ((pre V30_exclusive_me) - 1) else (pre V30_exclusive_me)) <=(if V74_garde_me1 then 0 else (pre V30_exclusive_me))) 
...
and ((if etat_me4 then (if V77_garde_me4 then 0 else (pre V29_modified_me)) else (pre V29_modified_me)) <=(if V74_garde_me1 then 0 else (pre V29_modified_me))) 
and ((if V74_garde_me1 then 0 else (pre V29_modified_me)) <=(if V75_garde_me2 then ((pre V30_exclusive_me) - 1) else (pre V30_exclusive_me))) 
and ((if V75_garde_me2 then ((pre V30_exclusive_me) - 1) else (pre V30_exclusive_me)) <=(if V74_garde_me1 then 0 else (pre V30_exclusive_me))) 
and ((if V74_garde_me1 then 0 else (pre V30_exclusive_me)) <=(pre V30_exclusive_me)) 
and ((pre V30_exclusive_me) <=(if etat_me3 then (if V76_garde_me3 then 1 else (pre V30_exclusive_me)) else (if etat_me4 then (if V77_garde_me4 then 1 else (pre V30_exclusive_me)) else (pre V30_exclusive_me)))) 
and ((if etat_me3 then (if V76_garde_me3 then 1 else (pre V30_exclusive_me)) else (if etat_me4 then (if V77_garde_me4 then 1 else (pre V30_exclusive_me)) else (pre V30_exclusive_me))) <=(if etat_me4 then (if V77_garde_me4 then 1 else (pre V30_exclusive_me)) else (pre V30_exclusive_me))) 
...
and ((if V77_garde_me4 then 1 else (pre V30_exclusive_me)) <=1) 
and (1 <=2) 
and ((if V75_garde_me2 then (pre V31_shared_me) else (pre V31_shared_me)) <=((pre V31_shared_me) + (pre V30_exclusive_me))) 
...
and ((if V77_garde_me4 then 0 else (pre V31_shared_me)) <=(if V75_garde_me2 then ((pre V30_exclusive_me) - 1) else (pre V30_exclusive_me))) 
and ((if V75_garde_me2 then ((pre V30_exclusive_me) - 1) else (pre V30_exclusive_me)) <=(if V74_garde_me1 then 0 else (pre V30_exclusive_me))) 
and ((if V74_garde_me1 then 0 else (pre V30_exclusive_me)) <=(pre V30_exclusive_me)) 
and ((pre V30_exclusive_me) <=(if etat_me3 then (if V76_garde_me3 then 1 else (pre V30_exclusive_me)) else (if etat_me4 then (if V77_garde_me4 then 1 else (pre V30_exclusive_me)) else (pre V30_exclusive_me)))) 
and ((if etat_me3 then (if V76_garde_me3 then 1 else (pre V30_exclusive_me)) else (if etat_me4 then (if V77_garde_me4 then 1 else (pre V30_exclusive_me)) else (pre V30_exclusive_me))) <=(if etat_me4 then (if V77_garde_me4 then 1 else (pre V30_exclusive_me)) else (pre V30_exclusive_me))) 
...
and (V29_modified_me <=(if V75_garde_me2 then ((pre V30_exclusive_me) - 1) else (pre V30_exclusive_me))) 
and ((if V75_garde_me2 then ((pre V30_exclusive_me) - 1) else (pre V30_exclusive_me)) <=(if V74_garde_me1 then 0 else (pre V30_exclusive_me))) 
and ((if V74_garde_me1 then 0 else (pre V30_exclusive_me)) <=(pre V30_exclusive_me)) 
and ((pre V30_exclusive_me) <=(if etat_me3 then (if V76_garde_me3 then 1 else (pre V30_exclusive_me)) else (if etat_me4 then (if V77_garde_me4 then 1 else (pre V30_exclusive_me)) else (pre V30_exclusive_me)))) 
and ((if etat_me3 then (if V76_garde_me3 then 1 else (pre V30_exclusive_me)) else (if etat_me4 then (if V77_garde_me4 then 1 else (pre V30_exclusive_me)) else (pre V30_exclusive_me))) <=(if etat_me4 then (if V77_garde_me4 then 1 else (pre V30_exclusive_me)) else (pre V30_exclusive_me))) 
...
and ((if V77_garde_me4 then 1 else (pre V30_exclusive_me)) <=1) 
and (1 <=2) 
and (V30_exclusive_me <=(if etat_me1 then (if V74_garde_me1 then 0 else (pre V30_exclusive_me)) else (if etat_me2 then (if V75_garde_me2 then ((pre V30_exclusive_me) - 1) else (pre V30_exclusive_me)) else (if etat_me3 then (if V76_garde_me3 then 1 else (pre V30_exclusive_me)) else (if etat_me4 then (if V77_garde_me4 then 1 else (pre V30_exclusive_me)) else (pre V30_exclusive_me)))))) 
