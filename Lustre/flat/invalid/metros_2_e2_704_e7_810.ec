...
and (true = (pre V170_Sofar)) 
and ((pre V170_Sofar) = V170_Sofar) 
and (V170_Sofar = (if ((pre V161_c) >= 9) then (not B1) else true)) 
and ((if ((pre V161_c) >= 9) then (not B1) else true) = (V47_ast or (pre V170_Sofar))) 
...
and (((pre V44_avance1) and V44_avance1) => ((if (pre V46_retard1) then (not S) else true) and (if ((pre V161_c) >= 9) then (not B1) else true))) 
...
and ((pre V44_avance1) => ((if (pre V46_retard1) then (not S) else true) and (if ((pre V161_c) >= 9) then (not B1) else true))) 
...
and ((pre V45_retard0) => ((pre V41_diff0) <= 20)) 
and ((pre V45_retard0) => (not (pre V43_avance0))) 
and ((if (not (pre V43_avance0)) then (V41_diff0 >= 10) else (V41_diff0 > 0)) => (not (pre V45_retard0))) 
and ((if (not (pre V43_avance0)) then (V41_diff0 >= 10) else (V41_diff0 > 0)) => (if (pre V45_retard0) then (not S) else true)) 
...
and ((if B1 then (((pre V161_c) - 1) + 1) else (pre V161_c)) = 0) 
...
and ((pre V160_c) = (((pre V161_c) - 1) + 1)) 
and ((((pre V161_c) - 1) + 1) = (pre V161_c)) 
and ((pre V161_c) = (if ((pre V43_avance0) and V43_avance0) then (if B0 then (((pre V160_c) - 1) + 1) else (pre V160_c)) else 0)) 
and ((if ((pre V43_avance0) and V43_avance0) then (if B0 then (((pre V160_c) - 1) + 1) else (pre V160_c)) else 0) = (if ((pre V44_avance1) and V44_avance1) then (if B1 then (((pre V161_c) - 1) + 1) else (pre V161_c)) else 0)) 
and ((if B1 then (((pre V161_c) - 1) + 1) else (pre V161_c)) <=(pre V40_nS)) 
and ((if B1 then (((pre V161_c) - 1) + 1) else (pre V161_c)) <=(pre V39_nB1)) 
and ((if B1 then (((pre V161_c) - 1) + 1) else (pre V161_c)) <=V39_nB1) 
and ((if B1 then (((pre V161_c) - 1) + 1) else (pre V161_c)) <=(if B1 then ((pre V39_nB1) + 1) else (pre V39_nB1))) 
and ((if B1 then (((pre V161_c) - 1) + 1) else (pre V161_c)) <=V38_nB0) 
and ((if B1 then (((pre V161_c) - 1) + 1) else (pre V161_c)) <=V40_nS) 
and ((if B1 then (((pre V161_c) - 1) + 1) else (pre V161_c)) <=(if S then ((pre V40_nS) + 1) else (pre V40_nS))) 
and ((if B1 then (((pre V161_c) - 1) + 1) else (pre V161_c)) <=1) 
and ((if B1 then (((pre V161_c) - 1) + 1) else (pre V161_c)) <=((pre V40_nS) + 1)) 
and ((if B1 then (((pre V161_c) - 1) + 1) else (pre V161_c)) <=((pre V39_nB1) + 1)) 
and ((if B1 then (((pre V161_c) - 1) + 1) else (pre V161_c)) <=9) 
and ((if B1 then (((pre V161_c) - 1) + 1) else (pre V161_c)) <=10) 
and ((if B1 then (((pre V161_c) - 1) + 1) else (pre V161_c)) <=20) 
and (1 <=((pre V40_nS) + 1)) 
and (1 <=((pre V39_nB1) + 1)) 
and (1 <=9) 
and (1 <=10) 
and (1 <=20) 
and ((- 10) <=((pre V160_c) - 1)) 
and (((pre V160_c) - 1) <=(if B1 then (((pre V161_c) - 1) + 1) else (pre V161_c))) 
and ((if B1 then (((pre V161_c) - 1) + 1) else (pre V161_c)) <=(pre V38_nB0)) 
