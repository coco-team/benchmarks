...
and (0 <=2) 
and ((if V107_garde5 then 0 else (pre V51_shared)) <=(if e2 then (if V104_garde2 then ((pre V51_shared) + 2) else (pre V51_shared)) else (if e3 then (if V105_garde3 then (((pre V51_shared) + (pre V50_exclusive)) + 1) else (pre V51_shared)) else (if e5 then (if V107_garde5 then 0 else (pre V51_shared)) else (if e7 then (if V109_garde7 then ((pre V51_shared) + 2) else (pre V51_shared)) else (if e8 then (if V110_garde8 then (((pre V51_shared) + (pre V50_exclusive)) + 1) else (pre V51_shared)) else (pre V51_shared))))))) 
and ((if V107_garde5 then 0 else (pre V51_shared)) <=((pre V51_shared) + (pre V50_exclusive))) 
...
and ((if V107_garde5 then 0 else (pre V51_shared)) <=(if e8 then (if V110_garde8 then (((pre V51_shared) + (pre V50_exclusive)) + 1) else (pre V51_shared)) else (pre V51_shared))) 
and ((if V107_garde5 then 0 else (pre V51_shared)) <=(if e3 then (if V105_garde3 then (((pre V51_shared) + (pre V50_exclusive)) + 1) else (pre V51_shared)) else (if e5 then (if V107_garde5 then 0 else (pre V51_shared)) else (if e7 then (if V109_garde7 then ((pre V51_shared) + 2) else (pre V51_shared)) else (if e8 then (if V110_garde8 then (((pre V51_shared) + (pre V50_exclusive)) + 1) else (pre V51_shared)) else (pre V51_shared)))))) 
and ((if V107_garde5 then 0 else (pre V51_shared)) <=(if V110_garde8 then (((pre V51_shared) + (pre V50_exclusive)) + 1) else (pre V51_shared))) 
and ((if V107_garde5 then 0 else (pre V51_shared)) <=(if e7 then (if V109_garde7 then ((pre V51_shared) + 2) else (pre V51_shared)) else (if e8 then (if V110_garde8 then (((pre V51_shared) + (pre V50_exclusive)) + 1) else (pre V51_shared)) else (pre V51_shared)))) 
and ((if V107_garde5 then 0 else (pre V51_shared)) <=(((pre V51_shared) + (pre V50_exclusive)) + 1)) 
...
and ((pre V50_exclusive) <=(if V106_garde4 then ((pre V49_dirty) + 1) else (pre V49_dirty))) 
...
and (0 <=(if V107_garde5 then 0 else (pre V51_shared))) 
and ((if V107_garde5 then 0 else (pre V51_shared)) <=(if V104_garde2 then ((pre V51_shared) + 2) else (pre V51_shared))) 
...
and ((if e5 then (if V107_garde5 then ((pre V50_exclusive) + 1) else (pre V50_exclusive)) else (if e8 then (if V110_garde8 then 0 else (pre V50_exclusive)) else (pre V50_exclusive))) <=(pre V50_exclusive)) 
