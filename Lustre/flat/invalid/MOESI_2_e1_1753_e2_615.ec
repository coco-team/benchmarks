...
let
  ...
  V35_shared_mo) - 1) + (pre V34_exclusive_mo)) + 1) else (pre V35_shared_mo)) 
  else (if etat_mo3 then (if V85_garde_mo3 then 0 else (pre V35_shared_mo)) 
  else (if etat_mo4 then (if V86_garde_mo4 then 0 else (pre V35_shared_mo)) 
  else (pre V35_shared_mo)))));
...
-- 242 implications. 
assert (true -> ((V85_garde_mo3 = true) 
and (true = ((((pre V35_shared_mo) + 1) + (pre V37_owned_mo)) >= 1)) 
...
and (V83_garde_mo1 = V86_garde_mo4) 
...
and ((etat_mo1 and etat_mo4) => ((((((etat_mo1 and etat_mo2) or (etat_mo1 and etat_mo3)) or (etat_mo1 and etat_mo4)) or (etat_mo2 and etat_mo3)) or (etat_mo2 and etat_mo4)) or (etat_mo3 and etat_mo4))) 
...
and ((etat_mo1 and etat_mo4) => etat_mo4) 
...
and ((etat_mo1 and etat_mo2) => ((((((etat_mo1 and etat_mo2) or (etat_mo1 and etat_mo3)) or (etat_mo1 and etat_mo4)) or (etat_mo2 and etat_mo3)) or (etat_mo2 and etat_mo4)) or (etat_mo3 and etat_mo4))) 
and ((etat_mo2 and etat_mo4) => ((((((etat_mo1 and etat_mo2) or (etat_mo1 and etat_mo3)) or (etat_mo1 and etat_mo4)) or (etat_mo2 and etat_mo3)) or (etat_mo2 and etat_mo4)) or (etat_mo3 and etat_mo4))) 
and ((etat_mo2 and etat_mo4) => etat_mo4) 
and ((etat_mo1 and etat_mo2) => (((etat_mo1 and etat_mo2) or (etat_mo1 and etat_mo3)) or (etat_mo1 and etat_mo4))) 
...
and (((((((pre V36_invalid_mo) + (pre V33_modified_mo)) + (pre V34_exclusive_mo)) + (pre V35_shared_mo)) + (pre V37_owned_mo)) - 1) = (if V85_garde_mo3 then ((((((pre V36_invalid_mo) + (pre V33_modified_mo)) + (pre V34_exclusive_mo)) + (pre V35_shared_mo)) + (pre V37_owned_mo)) - 1) else (pre V36_invalid_mo))) 
...
and ((if V85_garde_mo3 then 0 else (pre V33_modified_mo)) = 0) 
and (0 = (if V85_garde_mo3 then 0 else (pre V37_owned_mo))) 
and ((if V85_garde_mo3 then 0 else (pre V37_owned_mo)) = (if V84_garde_mo2 then ((pre V34_exclusive_mo) - 1) else (pre V34_exclusive_mo))) 
...
and ((if V83_garde_mo1 then 0 else (pre V33_modified_mo)) = (if V86_garde_mo4 then 0 else (pre V33_modified_mo))) 
and ((if V84_garde_mo2 then ((pre V33_modified_mo) + 1) else (pre V33_modified_mo)) = ((pre V33_modified_mo) + (pre V34_exclusive_mo))) 
...
and (((((((pre V36_invalid_mo) + (pre V33_modified_mo)) + (pre V34_exclusive_mo)) + (pre V35_shared_mo)) + (pre V37_owned_mo)) - 1) <=(if V86_garde_mo4 then ((((((pre V36_invalid_mo) + (pre V33_modified_mo)) + (pre V34_exclusive_mo)) + (pre V35_shared_mo)) + (pre V37_owned_mo)) - 1) else (pre V36_invalid_mo))) 
and ((if V85_garde_mo3 then 0 else (pre V33_modified_mo)) <=(if V86_garde_mo4 then 0 else (pre V37_owned_mo))) 
and ((if V85_garde_mo3 then 0 else (pre V33_modified_mo)) <=(if etat_mo3 then (if V85_garde_mo3 then 0 else (pre V35_shared_mo)) else (if etat_mo4 then (if V86_garde_mo4 then 0 else (pre V35_shared_mo)) else (pre V35_shared_mo)))) 
and ((if V85_garde_mo3 then 0 else (pre V33_modified_mo)) <=(if V86_garde_mo4 then 0 else (pre V35_shared_mo))) 
and ((if V85_garde_mo3 then 0 else (pre V33_modified_mo)) <=(if etat_mo4 then (if V86_garde_mo4 then 0 else (pre V35_shared_mo)) else (pre V35_shared_mo))) 
and ((if V85_garde_mo3 then 0 else (pre V33_modified_mo)) <=(pre V35_shared_mo)) 
and ((if V85_garde_mo3 then 0 else (pre V33_modified_mo)) <=V37_owned_mo) 
and ((if V85_garde_mo3 then 0 else (pre V33_modified_mo)) <=(if etat_mo3 then (if V85_garde_mo3 then 0 else (pre V33_modified_mo)) else (if etat_mo4 then (if V86_garde_mo4 then 0 else (pre V33_modified_mo)) else (pre V33_modified_mo)))) 
and ((if V85_garde_mo3 then 0 else (pre V33_modified_mo)) <=(if V83_garde_mo1 then 0 else (pre V33_modified_mo))) 
and ((if V85_garde_mo3 then 0 else (pre V33_modified_mo)) <=(if etat_mo4 then (if V86_garde_mo4 then 0 else (pre V33_modified_mo)) else (pre V33_modified_mo))) 
and ((if V85_garde_mo3 then 0 else (pre V33_modified_mo)) <=(pre V33_modified_mo)) 
and ((if V85_garde_mo3 then 0 else (pre V33_modified_mo)) <=V35_shared_mo) 
and ((if V85_garde_mo3 then 0 else (pre V33_modified_mo)) <=(if etat_mo1 then (if V83_garde_mo1 then ((((pre V35_shared_mo) - 1) + (pre V34_exclusive_mo)) + 1) else (pre V35_shared_mo)) else (if etat_mo3 then (if V85_garde_mo3 then 0 else (pre V35_shared_mo)) else (if etat_mo4 then (if V86_garde_mo4 then 0 else (pre V35_shared_mo)) else (pre V35_shared_mo))))) 
and ((if V85_garde_mo3 then 0 else (pre V33_modified_mo)) <=(if V83_garde_mo1 then ((((pre V35_shared_mo) - 1) + (pre V34_exclusive_mo)) + 1) else (pre V35_shared_mo))) 
and ((if V85_garde_mo3 then 0 else (pre V33_modified_mo)) <=(if V83_garde_mo1 then 0 else (pre V34_exclusive_mo))) 
and ((if V85_garde_mo3 then 0 else (pre V33_modified_mo)) <=V33_modified_mo) 
and ((if V85_garde_mo3 then 0 else (pre V33_modified_mo)) <=(if etat_mo1 then (if V83_garde_mo1 then 0 else (pre V33_modified_mo)) else (if etat_mo2 then (if V84_garde_mo2 then ((pre V33_modified_mo) + 1) else (pre V33_modified_mo)) else (if etat_mo3 then (if V85_garde_mo3 then 0 else (pre V33_modified_mo)) else (if etat_mo4 then (if V86_garde_mo4 then 0 else (pre V33_modified_mo)) else (pre V33_modified_mo)))))) 
and ((if V85_garde_mo3 then 0 else (pre V33_modified_mo)) <=(if etat_mo2 then (if V84_garde_mo2 then ((pre V33_modified_mo) + 1) else (pre V33_modified_mo)) else (if etat_mo3 then (if V85_garde_mo3 then 0 else (pre V33_modified_mo)) else (if etat_mo4 then (if V86_garde_mo4 then 0 else (pre V33_modified_mo)) else (pre V33_modified_mo))))) 
and ((if V85_garde_mo3 then 0 else (pre V33_modified_mo)) <=(pre V34_exclusive_mo)) 
and ((if V85_garde_mo3 then 0 else (pre V33_modified_mo)) <=((((pre V35_shared_mo) - 1) + (pre V34_exclusive_mo)) + 1)) 
and ((if V85_garde_mo3 then 0 else (pre V33_modified_mo)) <=(if V84_garde_mo2 then ((pre V33_modified_mo) + 1) else (pre V33_modified_mo))) 
and ((if V85_garde_mo3 then 0 else (pre V33_modified_mo)) <=(((pre V33_modified_mo) + (pre V34_exclusive_mo)) + (pre V35_shared_mo))) 
and ((if V85_garde_mo3 then 0 else (pre V33_modified_mo)) <=(if etat_mo4 then (if V86_garde_mo4 then 1 else (pre V34_exclusive_mo)) else (pre V34_exclusive_mo))) 
and ((if V85_garde_mo3 then 0 else (pre V33_modified_mo)) <=(if V86_garde_mo4 then 1 else (pre V34_exclusive_mo))) 
and ((if V85_garde_mo3 then 0 else (pre V33_modified_mo)) <=V34_exclusive_mo) 
and ((if V85_garde_mo3 then 0 else (pre V33_modified_mo)) <=(if etat_mo1 then (if V83_garde_mo1 then 0 else (pre V34_exclusive_mo)) else (if etat_mo2 then (if V84_garde_mo2 then ((pre V34_exclusive_mo) - 1) else (pre V34_exclusive_mo)) else (if etat_mo3 then (if V85_garde_mo3 then 1 else (pre V34_exclusive_mo)) else (if etat_mo4 then (if V86_garde_mo4 then 1 else (pre V34_exclusive_mo)) else (pre V34_exclusive_mo)))))) 
and ((if V85_garde_mo3 then 0 else (pre V33_modified_mo)) <=(V33_modified_mo + V34_exclusive_mo)) 
and ((if V85_garde_mo3 then 0 else (pre V33_modified_mo)) <=((V33_modified_mo + V34_exclusive_mo) + V35_shared_mo)) 
and ((if V85_garde_mo3 then 0 else (pre V33_modified_mo)) <=(if etat_mo2 then (if V84_garde_mo2 then ((pre V34_exclusive_mo) - 1) else (pre V34_exclusive_mo)) else (if etat_mo3 then (if V85_garde_mo3 then 1 else (pre V34_exclusive_mo)) else (if etat_mo4 then (if V86_garde_mo4 then 1 else (pre V34_exclusive_mo)) else (pre V34_exclusive_mo))))) 
and ((if V85_garde_mo3 then 0 else (pre V33_modified_mo)) <=(if etat_mo3 then (if V85_garde_mo3 then 1 else (pre V34_exclusive_mo)) else (if etat_mo4 then (if V86_garde_mo4 then 1 else (pre V34_exclusive_mo)) else (pre V34_exclusive_mo)))) 
...
and ((if etat_mo3 then (if V85_garde_mo3 then 0 else (pre V35_shared_mo)) else (if etat_mo4 then (if V86_garde_mo4 then 0 else (pre V35_shared_mo)) else (pre V35_shared_mo))) <=(if etat_mo1 then (if V83_garde_mo1 then ((((pre V35_shared_mo) - 1) + (pre V34_exclusive_mo)) + 1) else (pre V35_shared_mo)) else (if etat_mo3 then (if V85_garde_mo3 then 0 else (pre V35_shared_mo)) else (if etat_mo4 then (if V86_garde_mo4 then 0 else (pre V35_shared_mo)) else (pre V35_shared_mo))))) 
...
and ((pre V33_modified_mo) <=(if V84_garde_mo2 then ((pre V33_modified_mo) + 1) else (pre V33_modified_mo))) 
and ((pre V33_modified_mo) <=(((pre V33_modified_mo) + (pre V34_exclusive_mo)) + (pre V35_shared_mo))) 
...
and ((pre V34_exclusive_mo) <=(if V84_garde_mo2 then ((pre V33_modified_mo) + 1) else (pre V33_modified_mo))) 
...
and ((if etat_mo4 then (if V86_garde_mo4 then 1 else (pre V34_exclusive_mo)) else (pre V34_exclusive_mo)) <=(if etat_mo3 then (if V85_garde_mo3 then 1 else (pre V34_exclusive_mo)) else (if etat_mo4 then (if V86_garde_mo4 then 1 else (pre V34_exclusive_mo)) else (pre V34_exclusive_mo)))) 
...
and (((((((pre V36_invalid_mo) + (pre V33_modified_mo)) + (pre V34_exclusive_mo)) + (pre V35_shared_mo)) + (pre V37_owned_mo)) - 1) <=(if etat_mo3 then (if V85_garde_mo3 then ((((((pre V36_invalid_mo) + (pre V33_modified_mo)) + (pre V34_exclusive_mo)) + (pre V35_shared_mo)) + (pre V37_owned_mo)) - 1) else (pre V36_invalid_mo)) else (if etat_mo4 then (if V86_garde_mo4 then ((((((pre V36_invalid_mo) + (pre V33_modified_mo)) + (pre V34_exclusive_mo)) + (pre V35_shared_mo)) + (pre V37_owned_mo)) - 1) else (pre V36_invalid_mo)) else (pre V36_invalid_mo)))) 
and ((if etat_mo3 then (if V85_garde_mo3 then ((((((pre V36_invalid_mo) + (pre V33_modified_mo)) + (pre V34_exclusive_mo)) + (pre V35_shared_mo)) + (pre V37_owned_mo)) - 1) else (pre V36_invalid_mo)) else (if etat_mo4 then (if V86_garde_mo4 then ((((((pre V36_invalid_mo) + (pre V33_modified_mo)) + (pre V34_exclusive_mo)) + (pre V35_shared_mo)) + (pre V37_owned_mo)) - 1) else (pre V36_invalid_mo)) else (pre V36_invalid_mo))) <=(if etat_mo4 then (if V86_garde_mo4 then ((((((pre V36_invalid_mo) + (pre V33_modified_mo)) + (pre V34_exclusive_mo)) + (pre V35_shared_mo)) + (pre V37_owned_mo)) - 1) else (pre V36_invalid_mo)) else (pre V36_invalid_mo))) 
and ((if etat_mo4 then (if V86_garde_mo4 then ((((((pre V36_invalid_mo) + (pre V33_modified_mo)) + (pre V34_exclusive_mo)) + (pre V35_shared_mo)) + (pre V37_owned_mo)) - 1) else (pre V36_invalid_mo)) else (pre V36_invalid_mo)) <=(pre V36_invalid_mo)) 
...
and ((if V86_garde_mo4 then ((((((pre V36_invalid_mo) + (pre V33_modified_mo)) + (pre V34_exclusive_mo)) + (pre V35_shared_mo)) + (pre V37_owned_mo)) - 1) else (pre V36_invalid_mo)) <=(if etat_mo4 then (if V86_garde_mo4 then ((((((pre V36_invalid_mo) + (pre V33_modified_mo)) + (pre V34_exclusive_mo)) + (pre V35_shared_mo)) + (pre V37_owned_mo)) - 1) else (pre V36_invalid_mo)) else (pre V36_invalid_mo))) 
and ((if etat_mo4 then (if V86_garde_mo4 then ((((((pre V36_invalid_mo) + (pre V33_modified_mo)) + (pre V34_exclusive_mo)) + (pre V35_shared_mo)) + (pre V37_owned_mo)) - 1) else (pre V36_invalid_mo)) else (pre V36_invalid_mo)) <=(pre V36_invalid_mo)) 
and ((pre V36_invalid_mo) <=((pre V36_invalid_mo) + (pre V33_modified_mo))) 
and (((pre V36_invalid_mo) + (pre V33_modified_mo)) <=(((pre V36_invalid_mo) + (pre V33_modified_mo)) + (pre V34_exclusive_mo))) 
and ((((pre V36_invalid_mo) + (pre V33_modified_mo)) + (pre V34_exclusive_mo)) <=((((pre V33_modified_mo) + (pre V34_exclusive_mo)) + (pre V35_shared_mo)) + (pre V36_invalid_mo))) 
and (((((pre V33_modified_mo) + (pre V34_exclusive_mo)) + (pre V35_shared_mo)) + (pre V36_invalid_mo)) <=(((((pre V33_modified_mo) + (pre V34_exclusive_mo)) + (pre V35_shared_mo)) + (pre V36_invalid_mo)) + (pre V37_owned_mo))) 
and (((pre V35_shared_mo) - 1) <=(((pre V35_shared_mo) - 1) + (pre V34_exclusive_mo))) 
and ((((pre V35_shared_mo) - 1) + (pre V34_exclusive_mo)) <=(if V85_garde_mo3 then 0 else (pre V33_modified_mo))) 
and ((if V85_garde_mo3 then 0 else (pre V33_modified_mo)) <=(if etat_mo3 then (if V85_garde_mo3 then 0 else (pre V37_owned_mo)) else (if etat_mo4 then (if V86_garde_mo4 then 0 else (pre V37_owned_mo)) else (pre V37_owned_mo)))) 
and ((if etat_mo3 then (if V85_garde_mo3 then 0 else (pre V37_owned_mo)) else (if etat_mo4 then (if V86_garde_mo4 then 0 else (pre V37_owned_mo)) else (pre V37_owned_mo))) <=(if etat_mo4 then (if V86_garde_mo4 then 0 else (pre V37_owned_mo)) else (pre V37_owned_mo))) 
...
and (((pre V37_owned_mo) + (pre V33_modified_mo)) <=(if V85_garde_mo3 then 1 else (pre V34_exclusive_mo))) 
and ((if V85_garde_mo3 then 1 else (pre V34_exclusive_mo)) <=((pre V35_shared_mo) + 1)) 
and (((pre V35_shared_mo) + 1) <=(((pre V35_shared_mo) + 1) + (pre V37_owned_mo))) 
and (((pre V34_exclusive_mo) - 1) <=(((pre V35_shared_mo) - 1) + (pre V34_exclusive_mo))) 
and ((((pre V35_shared_mo) - 1) + (pre V34_exclusive_mo)) <=(if V85_garde_mo3 then 0 else (pre V33_modified_mo))) 
and ((if V85_garde_mo3 then 0 else (pre V33_modified_mo)) <=(if etat_mo3 then (if V85_garde_mo3 then 0 else (pre V37_owned_mo)) else (if etat_mo4 then (if V86_garde_mo4 then 0 else (pre V37_owned_mo)) else (pre V37_owned_mo)))) 
and ((if etat_mo3 then (if V85_garde_mo3 then 0 else (pre V37_owned_mo)) else (if etat_mo4 then (if V86_garde_mo4 then 0 else (pre V37_owned_mo)) else (pre V37_owned_mo))) <=(if etat_mo4 then (if V86_garde_mo4 then 0 else (pre V37_owned_mo)) else (pre V37_owned_mo))) 
and ((if etat_mo4 then (if V86_garde_mo4 then 0 else (pre V37_owned_mo)) else (pre V37_owned_mo)) <=(pre V37_owned_mo)) 
...
and ((if V85_garde_mo3 then 1 else (pre V34_exclusive_mo)) <=((pre V35_shared_mo) + 1)) 
and (((pre V35_shared_mo) + 1) <=(((pre V35_shared_mo) + 1) + (pre V37_owned_mo))) 
and ((if etat_mo3 then (if V85_garde_mo3 then 0 else (pre V35_shared_mo)) else (if etat_mo4 then (if V86_garde_mo4 then 0 else (pre V35_shared_mo)) else (pre V35_shared_mo))) <=(if etat_mo4 then (if V86_garde_mo4 then 0 else (pre V35_shared_mo)) else (pre V35_shared_mo))) 
and ((if etat_mo4 then (if V86_garde_mo4 then 0 else (pre V35_shared_mo)) else (pre V35_shared_mo)) <=(pre V35_shared_mo)) 
and ((pre V35_shared_mo) <=(if V83_garde_mo1 then ((((pre V35_shared_mo) - 1) + (pre V34_exclusive_mo)) + 1) else (pre V35_shared_mo))) 
and ((if V83_garde_mo1 then ((((pre V35_shared_mo) - 1) + (pre V34_exclusive_mo)) + 1) else (pre V35_shared_mo)) <=((((pre V35_shared_mo) - 1) + (pre V34_exclusive_mo)) + 1)) 
and (((((pre V35_shared_mo) - 1) + (pre V34_exclusive_mo)) + 1) <=(((pre V33_modified_mo) + (pre V34_exclusive_mo)) + (pre V35_shared_mo))) 
and ((((pre V33_modified_mo) + (pre V34_exclusive_mo)) + (pre V35_shared_mo)) <=(if V85_garde_mo3 then 1 else (pre V34_exclusive_mo))) 
and ((if V85_garde_mo3 then 1 else (pre V34_exclusive_mo)) <=((pre V35_shared_mo) + 1)) 
and (((pre V35_shared_mo) + 1) <=(((pre V35_shared_mo) + 1) + (pre V37_owned_mo))) 
...
and ((if V85_garde_mo3 then 1 else (pre V34_exclusive_mo)) <=((pre V35_shared_mo) + 1)) 
and (((pre V35_shared_mo) + 1) <=(((pre V35_shared_mo) + 1) + (pre V37_owned_mo))) 
and ((if etat_mo3 then (if V85_garde_mo3 then 0 else (pre V33_modified_mo)) else (if etat_mo4 then (if V86_garde_mo4 then 0 else (pre V33_modified_mo)) else (pre V33_modified_mo))) <=(if etat_mo4 then (if V86_garde_mo4 then 0 else (pre V33_modified_mo)) else (pre V33_modified_mo))) 
...
and ((if V85_garde_mo3 then 1 else (pre V34_exclusive_mo)) <=((pre V35_shared_mo) + 1)) 
and (((pre V35_shared_mo) + 1) <=(((pre V35_shared_mo) + 1) + (pre V37_owned_mo))) 
and ((if V83_garde_mo1 then 0 else (pre V33_modified_mo)) <=(if etat_mo4 then (if V86_garde_mo4 then 0 else (pre V33_modified_mo)) else (pre V33_modified_mo))) 
and ((if etat_mo4 then (if V86_garde_mo4 then 0 else (pre V33_modified_mo)) else (pre V33_modified_mo)) <=(pre V33_modified_mo)) 
and ((pre V33_modified_mo) <=((pre V37_owned_mo) + (pre V33_modified_mo))) 
and (((pre V37_owned_mo) + (pre V33_modified_mo)) <=(if V85_garde_mo3 then 1 else (pre V34_exclusive_mo))) 
and ((if V85_garde_mo3 then 1 else (pre V34_exclusive_mo)) <=((pre V35_shared_mo) + 1)) 
and (((pre V35_shared_mo) + 1) <=(((pre V35_shared_mo) + 1) + (pre V37_owned_mo))) 
and (V35_shared_mo <=(if etat_mo1 then (if V83_garde_mo1 then ((((pre V35_shared_mo) - 1) + (pre V34_exclusive_mo)) + 1) else (pre V35_shared_mo)) else (if etat_mo3 then (if V85_garde_mo3 then 0 else (pre V35_shared_mo)) else (if etat_mo4 then (if V86_garde_mo4 then 0 else (pre V35_shared_mo)) else (pre V35_shared_mo))))) 
and ((if etat_mo1 then (if V83_garde_mo1 then ((((pre V35_shared_mo) - 1) + (pre V34_exclusive_mo)) + 1) else (pre V35_shared_mo)) else (if etat_mo3 then (if V85_garde_mo3 then 0 else (pre V35_shared_mo)) else (if etat_mo4 then (if V86_garde_mo4 then 0 else (pre V35_shared_mo)) else (pre V35_shared_mo)))) <=(if V83_garde_mo1 then ((((pre V35_shared_mo) - 1) + (pre V34_exclusive_mo)) + 1) else (pre V35_shared_mo))) 
and ((if V83_garde_mo1 then ((((pre V35_shared_mo) - 1) + (pre V34_exclusive_mo)) + 1) else (pre V35_shared_mo)) <=((((pre V35_shared_mo) - 1) + (pre V34_exclusive_mo)) + 1)) 
and (((((pre V35_shared_mo) - 1) + (pre V34_exclusive_mo)) + 1) <=(((pre V33_modified_mo) + (pre V34_exclusive_mo)) + (pre V35_shared_mo))) 
and ((((pre V33_modified_mo) + (pre V34_exclusive_mo)) + (pre V35_shared_mo)) <=(if V85_garde_mo3 then 1 else (pre V34_exclusive_mo))) 
and ((if V85_garde_mo3 then 1 else (pre V34_exclusive_mo)) <=((pre V35_shared_mo) + 1)) 
...
and ((pre V34_exclusive_mo) <=((((pre V35_shared_mo) - 1) + (pre V34_exclusive_mo)) + 1)) 
and (((((pre V35_shared_mo) - 1) + (pre V34_exclusive_mo)) + 1) <=(((pre V33_modified_mo) + (pre V34_exclusive_mo)) + (pre V35_shared_mo))) 
and ((((pre V33_modified_mo) + (pre V34_exclusive_mo)) + (pre V35_shared_mo)) <=(if V85_garde_mo3 then 1 else (pre V34_exclusive_mo))) 
and ((if V85_garde_mo3 then 1 else (pre V34_exclusive_mo)) <=((pre V35_shared_mo) + 1)) 
and (((pre V35_shared_mo) + 1) <=(((pre V35_shared_mo) + 1) + (pre V37_owned_mo))) 
...
and ((if etat_mo1 then (if V83_garde_mo1 then 0 else (pre V33_modified_mo)) else (if etat_mo2 then (if V84_garde_mo2 then ((pre V33_modified_mo) + 1) else (pre V33_modified_mo)) else (if etat_mo3 then (if V85_garde_mo3 then 0 else (pre V33_modified_mo)) else (if etat_mo4 then (if V86_garde_mo4 then 0 else (pre V33_modified_mo)) else (pre V33_modified_mo))))) <=(if V84_garde_mo2 then ((pre V33_modified_mo) + 1) else (pre V33_modified_mo))) 
and ((if V84_garde_mo2 then ((pre V33_modified_mo) + 1) else (pre V33_modified_mo)) <=(((pre V33_modified_mo) + (pre V34_exclusive_mo)) + (pre V35_shared_mo))) 
and ((((pre V33_modified_mo) + (pre V34_exclusive_mo)) + (pre V35_shared_mo)) <=(if V85_garde_mo3 then 1 else (pre V34_exclusive_mo))) 
and ((if V85_garde_mo3 then 1 else (pre V34_exclusive_mo)) <=((pre V35_shared_mo) + 1)) 
and (((pre V35_shared_mo) + 1) <=(((pre V35_shared_mo) + 1) + (pre V37_owned_mo))) 
...
and ((if V86_garde_mo4 then 1 else (pre V34_exclusive_mo)) <=(if V85_garde_mo3 then 1 else (pre V34_exclusive_mo))) 
and ((if V85_garde_mo3 then 1 else (pre V34_exclusive_mo)) <=((pre V35_shared_mo) + 1)) 
and (((pre V35_shared_mo) + 1) <=(((pre V35_shared_mo) + 1) + (pre V37_owned_mo))) 
...
and ((if etat_mo3 then (if V85_garde_mo3 then 1 else (pre V34_exclusive_mo)) else (if etat_mo4 then (if V86_garde_mo4 then 1 else (pre V34_exclusive_mo)) else (pre V34_exclusive_mo))) <=(if V85_garde_mo3 then 1 else (pre V34_exclusive_mo))) 
and ((if V85_garde_mo3 then 1 else (pre V34_exclusive_mo)) <=((pre V35_shared_mo) + 1)) 
and (((pre V35_shared_mo) + 1) <=(((pre V35_shared_mo) + 1) + (pre V37_owned_mo))) 
and ((V33_modified_mo + V34_exclusive_mo) <=((V33_modified_mo + V34_exclusive_mo) + V35_shared_mo)) 
and (((V33_modified_mo + V34_exclusive_mo) + V35_shared_mo) <=(if V85_garde_mo3 then 1 else (pre V34_exclusive_mo))) 
and ((if V85_garde_mo3 then 1 else (pre V34_exclusive_mo)) <=((pre V35_shared_mo) + 1)) 
and (((pre V35_shared_mo) + 1) <=(((pre V35_shared_mo) + 1) + (pre V37_owned_mo))) 
and ((if etat_mo2 then (if V84_garde_mo2 then ((pre V34_exclusive_mo) - 1) else (pre V34_exclusive_mo)) else (if etat_mo3 then (if V85_garde_mo3 then 1 else (pre V34_exclusive_mo)) else (if etat_mo4 then (if V86_garde_mo4 then 1 else (pre V34_exclusive_mo)) else (pre V34_exclusive_mo)))) <=(if etat_mo3 then (if V85_garde_mo3 then 1 else (pre V34_exclusive_mo)) else (if etat_mo4 then (if V86_garde_mo4 then 1 else (pre V34_exclusive_mo)) else (pre V34_exclusive_mo)))) 
and ((if etat_mo3 then (if V85_garde_mo3 then 1 else (pre V34_exclusive_mo)) else (if etat_mo4 then (if V86_garde_mo4 then 1 else (pre V34_exclusive_mo)) else (pre V34_exclusive_mo))) <=(if V85_garde_mo3 then 1 else (pre V34_exclusive_mo))) 
