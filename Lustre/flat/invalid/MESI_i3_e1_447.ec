...
and (((pre V30_exclusive_me) >= 1) = V74_garde_me2) 
and (V75_garde_me3 = ((pre V31_shared_me) >= 1)) 
and ((V91_X and (pre V33_env)) => V33_env) 
and ((V31_shared_me >= 0) => (V33_env => (V31_shared_me >= 0))) 
and (V75_garde_me3 => (V31_shared_me >= 0)) 
...
and ((etat_me3 and etat_me4) => (V33_env => (V31_shared_me >= 0))) 
...
and ((etat_me2 and etat_me4) => (V33_env => (V31_shared_me >= 0))) 
...
and (V75_garde_me3 => (V33_env => (V31_shared_me >= 0))) 
...
and ((etat_me1 and etat_me2) => (V33_env => (V31_shared_me >= 0))) 
...
and ((etat_me2 and etat_me3) => (V33_env => (V31_shared_me >= 0))) 
and ((etat_me2 and etat_me3) => etat_me2) 
and ((V91_X and (pre V33_env)) => (pre V33_env)) 
and (((pre V30_exclusive_me) >= 1) => (V31_shared_me >= 0)) 
...
and ((etat_me1 and etat_me3) => (V33_env => (V31_shared_me >= 0))) 
...
and (((etat_me1 and etat_me2) or (etat_me1 and etat_me3)) => (V33_env => (V31_shared_me >= 0))) 
...
and (((((((etat_me1 and etat_me2) or (etat_me1 and etat_me3)) or (etat_me1 and etat_me4)) or (etat_me2 and etat_me3)) or (etat_me2 and etat_me4)) or (etat_me3 and etat_me4)) => (V33_env => (V31_shared_me >= 0))) 
...
and (((pre V30_exclusive_me) - 1) <=V31_shared_me) 
...
and ((if V75_garde_me3 then 1 else (pre V30_exclusive_me)) <=1) 
and (V31_shared_me <=(if V75_garde_me3 then 1 else (pre V30_exclusive_me))) 
and ((if V75_garde_me3 then 1 else (pre V30_exclusive_me)) <=1) 
