...
let
  ...
  V20_stop = ((V86_signal -> (V86_signal and (pre (not V86_signal)))) and (
...
and (((V86_signal and (not (pre V86_signal))) and (V90_signal and (not (pre V90_signal)))) => (not (TryToMove1 and (not (pre TryToMove1))))) 
and (((V86_signal and (not (pre V86_signal))) and (V90_signal and (not (pre V90_signal)))) => V20_stop) 
and ((V16_MayMove1 and (not (pre TryToMove2))) => V66_signal) 
and ((V66_signal and (not (pre V66_signal))) => V18_start1) 
and (V21_moving => (if V58_on then true else (if V20_stop then false else (pre V21_moving)))) 
...
and ((not V18_start1) => (((((not V18_start1) and (not V19_start2)) or ((not V19_start2) and (not V20_stop))) or ((not V18_start1) and (not V20_stop))) and (not ((V18_start1 and V19_start2) and V20_stop)))) 
...
and ((V18_start1 and V19_start2) => (TryToMove2 and MaySafelyMove)) 
...
and (V18_start1 => (not V20_stop)) 
and (V18_start1 => TryToMove1) 
...
and ((TryToMove2 and MaySafelyMove) => (if V21_moving then MaySafelyMove else true)) 
and ((TryToMove2 and MaySafelyMove) => (not V20_stop)) 
...
and ((not V17_MayMove2) => (((not V18_start1) and (not V19_start2)) or ((not V19_start2) and (not V20_stop)))) 
and ((V90_signal and (not (pre V90_signal))) => (((not V18_start1) and (not V19_start2)) or ((not V19_start2) and (not V20_stop)))) 
and ((V90_signal and (not (pre V90_signal))) => (not (pre V90_signal))) 
and (V16_MayMove1 => (if V21_moving then MaySafelyMove else true)) 
and (V16_MayMove1 => (not V20_stop)) 
and (V16_MayMove1 => MaySafelyMove) 
and (V20_stop => ((not V18_start1) and (not V19_start2))) 
and (((V86_signal and (not (pre V86_signal))) and (V90_signal and (not (pre V90_signal)))) => (not (pre V86_signal))) 
and (((V86_signal and (not (pre V86_signal))) and (V90_signal and (not (pre V90_signal)))) => (V86_signal and (not (pre V86_signal)))) 
and (V20_stop => V86_signal) 
and (((V86_signal and (not (pre V86_signal))) and (V90_signal and (not (pre V90_signal)))) => (not (pre V90_signal))) 
and (((V86_signal and (not (pre V86_signal))) and (V90_signal and (not (pre V90_signal)))) => (not (TryToMove2 and (not (pre TryToMove2))))) 
and (V20_stop => (not V18_start1)) 
and (V20_stop => (((((not V18_start1) and (not V19_start2)) or ((not V19_start2) and (not V20_stop))) or ((not V18_start1) and (not V20_stop))) and (not ((V18_start1 and V19_start2) and V20_stop)))) 
...
and (V20_stop => (if ((not (TryToMove1 and (not (pre TryToMove1)))) or (not (TryToMove2 and (not (pre TryToMove2))))) then ((((((not V18_start1) and (not V19_start2)) or ((not V19_start2) and (not V20_stop))) or ((not V18_start1) and (not V20_stop))) and (not ((V18_start1 and V19_start2) and V20_stop))) and (if V21_moving then MaySafelyMove else true)) else true)) 
...
and (((V86_signal and (not (pre V86_signal))) and (V90_signal and (not (pre V90_signal)))) => ((not V18_start1) and (not V19_start2))) 
and (((V86_signal and (not (pre V86_signal))) and (V90_signal and (not (pre V90_signal)))) => (V90_signal and (not (pre V90_signal)))) 
and (V20_stop => (not V17_MayMove2)) 
and ((V17_MayMove2 and (not (pre TryToMove1))) => (not (pre TryToMove1))) 
and ((V86_signal and (not (pre V86_signal))) => V86_signal) 
and ((pre TryToMove1) => (not (TryToMove1 and (not (pre TryToMove1))))) 
and (V66_signal => TryToMove1) 
