...
and ((((((pre V51_invalid) >= 1) and ((pre V52_dirty) = 0)) and ((pre V54_shared) = 0)) and ((pre V53_exclusive) = 0)) => (V56_A1 and V57_A2)) 
...
and ((if V119_garde5 then ((pre V53_exclusive) + 1) else (pre V53_exclusive)) <=((pre V53_exclusive) + 1)) 
and ((if V117_garde3 then ((((pre V54_shared) + 1) - (pre V53_exclusive)) + 1) else (pre V54_shared)) <=((pre V54_shared) + 2)) 
...
and ((pre V51_invalid) <=(pre V123_mem_invalid)) 
and (((((pre V54_shared) + 1) - (pre V53_exclusive)) + 1) <=((pre V54_shared) + 2)) 
