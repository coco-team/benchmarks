...
-- 96 implications. 
assert (true -> (((V33_env => (V28_speed < 4)) = (V28_speed < 4)) 
...
and ((pre V26_bump) => (V33_env => (V28_speed < 4))) 
and ((pre V25_stop) => (V33_env => (V28_speed < 4))) 
...
and ((m and (not s)) => m) 
and ((V29_time >= 4) => (V33_env => (V28_speed < 4))) 
...
and ((not V30_move) => (V33_env => (V28_speed < 4))) 
and ((V28_speed >= 3) => V33_env) 
and ((V28_speed >= 3) => (pre V33_env)) 
and ((m and s) => (V33_env => (V28_speed < 4))) 
and ((m and s) => m) 
and (((not V30_move) or V31_second) => (V33_env => (V28_speed < 4))) 
and (0 <=(pre V28_speed)) 
and (0 <=(pre V29_time)) 
and (0 <=V29_time) 
