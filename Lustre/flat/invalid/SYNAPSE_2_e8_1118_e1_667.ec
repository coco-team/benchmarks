...
and (V31_env => (not ((((e_s1 and e_s2) and e_s1) and e_s3) or (e_s2 and e_s3)))) 
...
and ((((pre V27_invalid_s) + (pre V29_dirty_s)) + (pre V28_valid_s)) = (((pre V27_invalid_s) + (pre V28_valid_s)) + (pre V29_dirty_s))) 
...
and (((pre V27_invalid_s) + (pre V28_valid_s)) <=(((pre V27_invalid_s) + (pre V29_dirty_s)) + (pre V28_valid_s))) 
...
and (((((pre V27_invalid_s) + 1) + (pre V29_dirty_s)) - 1) <=(((pre V27_invalid_s) + (pre V29_dirty_s)) + (pre V28_valid_s))) 
