...
and (s => (V28_speed >= 0)) 
and ((pre V26_bump) => (V28_speed >= 0)) 
and ((not V30_move) => ((not V30_move) or V31_second)) 
and ((pre V25_stop) => (V28_speed >= 0)) 
...
and (0 <=(pre V29_time)) 
and (0 <=V29_time) 
and (0 <=(if V31_second then (((pre V29_time) + 1) + 1) else (pre V29_time))) 
and (0 <=V27_dist) 
and (0 <=1) 
and (0 <=((pre V29_time) + 1)) 
and (0 <=(((pre V29_time) + 1) + 1)) 
and (0 <=3) 
and (0 <=4) 
and ((pre V29_time) <=((pre V29_time) + 1)) 
and ((if (V30_move and V32_meter) then ((pre V27_dist) + 1) else (pre V27_dist)) <=10) 
and (1 <=((pre V29_time) + 1)) 
and (1 <=(((pre V29_time) + 1) + 1)) 
and (1 <=3) 
and (1 <=4) 
and (1 <=10) 
...
and (((pre V27_dist) + 1) <=11) 
and (11 <=32767) 
and ((pre V29_time) <=(if V31_second then (((pre V29_time) + 1) + 1) else (pre V29_time))) 
and ((if V31_second then (((pre V29_time) + 1) + 1) else (pre V29_time)) <=(((pre V29_time) + 1) + 1)) 
