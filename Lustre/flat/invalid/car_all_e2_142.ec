...
and ((pre V28_speed) = (((pre V28_speed) - 1) + 1)) 
...
and ((if ((not V30_move) or V31_second) then 0 else (if (V30_move and V32_meter) then (((pre V28_speed) - 1) + 1) else (pre V28_speed))) = 0) 
...
and (V28_speed <=(if (V30_move and V32_meter) then ((pre V27_dist) + 1) else (pre V27_dist))) 
and (V28_speed <=1) 
and (V28_speed <=((pre V27_dist) + 1)) 
and (V28_speed <=3) 
and (V28_speed <=4) 
and (V28_speed <=10) 
and (V28_speed <=11) 
