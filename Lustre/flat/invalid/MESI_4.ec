...
let
  OK = ((V33_env => (V29_modified_me <= 1)) or (V31_shared_me <= 1));
...
-- 176 implications. 
assert (true -> (((V29_modified_me <= 1) = true) 
and (true = (V31_shared_me <= 1)) 
and ((V31_shared_me <= 1) = (V33_env => (V29_modified_me <= 1))) 
and ((V33_env => (V29_modified_me <= 1)) = ((V33_env => (V29_modified_me <= 1)) or (V31_shared_me <= 1))) 
and (V76_garde_me4 = V73_garde_me1) 
and (V73_garde_me1 = ((pre V32_invalid_me) >= 1)) 
and (((not ((((((etat_me1 and etat_me2) or (etat_me1 and etat_me3)) or (etat_me1 and etat_me4)) or (etat_me2 and etat_me3)) or (etat_me2 and etat_me4)) or (etat_me3 and etat_me4))) and (V29_modified_me >= 0)) = V91_X) 
and (V74_garde_me2 = ((pre V30_exclusive_me) >= 1)) 
and (false = ((pre V31_shared_me) >= 1)) 
and (((pre V31_shared_me) >= 1) = V75_garde_me3) 
