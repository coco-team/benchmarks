...
-- 43 implications. 
assert (true -> ((((((V14_k >= 1) and (V15_m >= 1)) and ((V45_age_of_p >= V14_k) => q)) and ((V52_age_of_p >= V15_m) => r)) = V55_X) 
and ((V55_X and (pre V16_env)) => V16_env) 
and (V16_env => ((((V14_k >= 1) and (V15_m >= 1)) and ((V45_age_of_p >= V14_k) => q)) and ((V52_age_of_p >= V15_m) => r))) 
and (V16_env => ((V14_k >= 1) and (V15_m >= 1))) 
...
and ((V52_age_of_p >= V15_m) => (V16_env => ((V68_age_of_p >= (V14_k + V15_m)) => r))) 
