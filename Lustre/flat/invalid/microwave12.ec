...
let
  OK = (true -> ((not V18_COOKING) or DOOR_CLOSED));
  ...
  * 10));
  ...
  V103_p10 = (true -> ((not V18_COOKING) or ((if (not (not V18_COOKING)) then 
  (if (V97_MWI_FcnMaxI_In16 > 0) then V97_MWI_FcnMaxI_In16 else 0) else 639) > 
  0)));
  V104_p11 = ((not KP_CLEAR) or (not V18_COOKING));
  V105_p12 = (
...
-- 1067 implications. 
assert (true -> ((((V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root >= 1) and (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root <= 3)) = true) 
...
and (((V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root >= 1) and (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root <= 3)) = (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root >= 1)) 
and ((V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root >= 1) = (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root <= 3)) 
...
and ((V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root >= 1) = (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root <= 3)) 
...
and (V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock = (not ((V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root >= 1) and (V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root <= 3)))) 
...
and (V73_rlt_enter_microwave_mode_logic_ON_rlt_fired_0 = ((not ((V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root >= 1) and (V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root <= 3))) and ((V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root >= 1) and (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root <= 3)))) 
and ((V87_chart_microwave_mode_logic_begin_state_states___root = 4) = V79_rlt_eval_microwave_mode_logic_rlt_fired_0) 
and ((not (V47_chart_microwave_mode_logic_start = 0)) = V20_START_PRESSED) 
and (DOOR_CLOSED = (not (V49_chart_microwave_mode_logic_door_closed = 0))) 
and ((not (V49_chart_microwave_mode_logic_door_closed = 0)) = (((V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root >= 1) and (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root <= 3)) and (if (not (V49_chart_microwave_mode_logic_door_closed = 0)) then true else false))) 
and ((V73_rlt_enter_microwave_mode_logic_ON_rlt_fired_0 and (((V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root >= 1) and (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root <= 3)) and (if (not (V49_chart_microwave_mode_logic_door_closed = 0)) then true else false))) = V74_rlt_enter_microwave_mode_logic_ON_rlt_fired_1) 
and ((not (V48_chart_microwave_mode_logic_clear_off = 0)) = V21_CLEAR_PRESSED) 
...
and (((V87_chart_microwave_mode_logic_begin_state_states___root = 4) and ((if (not (V47_chart_microwave_mode_logic_start = 0)) then true else false) and (if (not ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) = 0)) then true else false))) = V81_rlt_eval_microwave_mode_logic_rlt_fired_1) 
and (V81_rlt_eval_microwave_mode_logic_rlt_fired_1 = (V79_rlt_eval_microwave_mode_logic_rlt_fired_0 and ((V87_chart_microwave_mode_logic_begin_state_states___root = 4) and ((if (not (V47_chart_microwave_mode_logic_start = 0)) then true else false) and (if (not ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) = 0)) then true else false))))) 
and ((2 = V96_microwave_microwave_mode_logic_mode) = V18_COOKING) 
and (V18_COOKING = (V68_rlt_eval_microwave_mode_logic_ON_rlt_state_10_states___root = 2)) 
...
and ((V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2) = ((V64_rlt_eval_microwave_mode_logic_ON_rlt_state_7_states___root = 2) and ((V63_rlt_eval_microwave_mode_logic_ON_rlt_state_6_outports_steps_remaining > 0) and (not V61_rlt_eval_microwave_mode_logic_ON_rlt_complete_2)))) 
and (((V64_rlt_eval_microwave_mode_logic_ON_rlt_state_7_states___root = 2) and ((V63_rlt_eval_microwave_mode_logic_ON_rlt_state_6_outports_steps_remaining > 0) and (not V61_rlt_eval_microwave_mode_logic_ON_rlt_complete_2))) = V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5) 
...
and (((V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root >= 1) and (V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root <= 3)) = ((not V81_rlt_eval_microwave_mode_logic_rlt_fired_1) and ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3)))) 
...
and ((V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 or V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1) = V61_rlt_eval_microwave_mode_logic_ON_rlt_complete_2) 
...
and ((V54_rlt_eval_microwave_mode_logic_ON_rlt_fired_2 or V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1) = V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1) 
and (V54_rlt_eval_microwave_mode_logic_ON_rlt_fired_2 = (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) 
and ((V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2) = ((V53_rlt_eval_microwave_mode_logic_ON_rlt_state_2_states___root = 3) and (((if (not (V47_chart_microwave_mode_logic_start = 0)) then true else false) and (if (not (V49_chart_microwave_mode_logic_door_closed = 0)) then true else false)) and (not V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1)))) 
...
and (false = V69_rlt_eval_microwave_mode_logic_ON_rlt_fired_6) 
and (V69_rlt_eval_microwave_mode_logic_ON_rlt_fired_6 = ((V68_rlt_eval_microwave_mode_logic_ON_rlt_state_10_states___root = 2) and (((if (not (V48_chart_microwave_mode_logic_clear_off = 0)) then true else false) or (not (if (not (V49_chart_microwave_mode_logic_door_closed = 0)) then true else false))) and (not (V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 or V61_rlt_eval_microwave_mode_logic_ON_rlt_complete_2))))) 
and (((V68_rlt_eval_microwave_mode_logic_ON_rlt_state_10_states___root = 2) and (((if (not (V48_chart_microwave_mode_logic_clear_off = 0)) then true else false) or (not (if (not (V49_chart_microwave_mode_logic_door_closed = 0)) then true else false))) and (not (V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 or V61_rlt_eval_microwave_mode_logic_ON_rlt_complete_2)))) = (if true then false else (pre V86_chart_microwave_mode_logic_rlt_evtInitStep))) 
and ((V87_chart_microwave_mode_logic_begin_state_states___root = 4) => (1 = (pre V96_microwave_microwave_mode_logic_mode))) 
and (((V87_chart_microwave_mode_logic_begin_state_states___root = 4) and ((if (not (V47_chart_microwave_mode_logic_start = 0)) then true else false) and (if (not ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) = 0)) then true else false))) => (KP_START and (not (pre KP_START)))) 
and (((V87_chart_microwave_mode_logic_begin_state_states___root = 4) and ((if (not (V47_chart_microwave_mode_logic_start = 0)) then true else false) and (if (not ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) = 0)) then true else false))) => (1 = (pre V96_microwave_microwave_mode_logic_mode))) 
...
and ((1 = (pre V96_microwave_microwave_mode_logic_mode)) => V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock) 
and ((KP_START and (not (pre KP_START))) => (not (V47_chart_microwave_mode_logic_start = 0))) 
and ((V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root >= 1) => (not V81_rlt_eval_microwave_mode_logic_rlt_fired_1)) 
and ((KP_CLEAR and (not (pre KP_CLEAR))) => (not (V48_chart_microwave_mode_logic_clear_off = 0))) 
...
and (((V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root >= 1) and (V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root <= 3)) => (((V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root >= 1) and (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root <= 3)) and (not V74_rlt_enter_microwave_mode_logic_ON_rlt_fired_1))) 
and (((V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root >= 1) and (V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root <= 3)) => (if (not V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock) then true else (if (pre V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock) then false else (pre V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step)))) 
and (((V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root >= 1) and (V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root <= 3)) => ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) = 0)) 
and (((V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root >= 1) and (V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root <= 3)) => (not (V87_chart_microwave_mode_logic_begin_state_states___root = 4))) 
and (((V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root >= 1) and (V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root <= 3)) => ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3))) 
...
and (((V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root >= 1) and (V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root <= 3)) => (V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root >= 1)) 
...
and (V54_rlt_eval_microwave_mode_logic_ON_rlt_fired_2 => (V54_rlt_eval_microwave_mode_logic_ON_rlt_fired_2 or V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1)) 
...
and (((if (not (V48_chart_microwave_mode_logic_clear_off = 0)) then true else false) and (not V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1)) => (not (V48_chart_microwave_mode_logic_clear_off = 0))) 
and ((not V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1) => (not V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1)) 
and ((not V18_COOKING) => (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2))) 
...
and ((V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2) => (2 = V96_microwave_microwave_mode_logic_mode)) 
...
and (V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 => (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) 
and (V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 => (V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 or V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1)) 
and (V86_chart_microwave_mode_logic_rlt_evtInitStep => (not V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1)) 
and (V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1 => (V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root >= 1)) 
and (V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1 => (V54_rlt_eval_microwave_mode_logic_ON_rlt_fired_2 or V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1)) 
...
and ((pre V86_chart_microwave_mode_logic_rlt_evtInitStep) => (not V61_rlt_eval_microwave_mode_logic_ON_rlt_complete_2)) 
...
and (V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1 => (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2))) 
and (V54_rlt_eval_microwave_mode_logic_ON_rlt_fired_2 => (not V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1)) 
and ((V54_rlt_eval_microwave_mode_logic_ON_rlt_fired_2 or V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1) => (V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root >= 1)) 
and (V86_chart_microwave_mode_logic_rlt_evtInitStep => (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2))) 
and (V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1 => (((V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root >= 1) and (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root <= 3)) and (not V74_rlt_enter_microwave_mode_logic_ON_rlt_fired_1))) 
and ((V54_rlt_eval_microwave_mode_logic_ON_rlt_fired_2 or V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1) => (((V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root >= 1) and (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root <= 3)) and (not V74_rlt_enter_microwave_mode_logic_ON_rlt_fired_1))) 
and (V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1 => (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3))) 
and (V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1 => (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root = 2)) 
and (V54_rlt_eval_microwave_mode_logic_ON_rlt_fired_2 => (2 = V96_microwave_microwave_mode_logic_mode)) 
and ((V54_rlt_eval_microwave_mode_logic_ON_rlt_fired_2 or V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1) => (V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 or V61_rlt_eval_microwave_mode_logic_ON_rlt_complete_2)) 
and ((V54_rlt_eval_microwave_mode_logic_ON_rlt_fired_2 or V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1) => (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3))) 
and ((V54_rlt_eval_microwave_mode_logic_ON_rlt_fired_2 or V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1) => ((V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root >= 1) and (V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root <= 3))) 
and ((V54_rlt_eval_microwave_mode_logic_ON_rlt_fired_2 or V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1) => (if (pre V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock) then false else (pre V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step))) 
...
and ((V73_rlt_enter_microwave_mode_logic_ON_rlt_fired_0 and (((V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root >= 1) and (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root <= 3)) and (not V74_rlt_enter_microwave_mode_logic_ON_rlt_fired_1))) => (not V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1)) 
and ((V73_rlt_enter_microwave_mode_logic_ON_rlt_fired_0 and (((V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root >= 1) and (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root <= 3)) and (not V74_rlt_enter_microwave_mode_logic_ON_rlt_fired_1))) => ((not V18_COOKING) or DOOR_CLOSED)) 
and ((V73_rlt_enter_microwave_mode_logic_ON_rlt_fired_0 and (((V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root >= 1) and (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root <= 3)) and (not V74_rlt_enter_microwave_mode_logic_ON_rlt_fired_1))) => (not V61_rlt_eval_microwave_mode_logic_ON_rlt_complete_2)) 
...
and ((V73_rlt_enter_microwave_mode_logic_ON_rlt_fired_0 and (((V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root >= 1) and (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root <= 3)) and (not V74_rlt_enter_microwave_mode_logic_ON_rlt_fired_1))) => (not V18_COOKING)) 
...
and (V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 => ((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root = 3) and (not V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1))) 
and ((V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 or V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1) => ((V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root >= 1) and (V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root <= 3))) 
...
and ((not (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root = 2)) => ((not V18_COOKING) or DOOR_CLOSED)) 
and (V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock => (not V61_rlt_eval_microwave_mode_logic_ON_rlt_complete_2)) 
and (V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock => (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3))) 
and ((not ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) = 0)) => (not V61_rlt_eval_microwave_mode_logic_ON_rlt_complete_2)) 
and ((not ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) = 0)) => (not V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1)) 
and ((not ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) = 0)) => (V48_chart_microwave_mode_logic_clear_off = 0)) 
and ((V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 or V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1) => (V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 or V61_rlt_eval_microwave_mode_logic_ON_rlt_complete_2)) 
...
and ((V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3) => ((V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root >= 1) and (V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root <= 3))) 
and ((V54_rlt_eval_microwave_mode_logic_ON_rlt_fired_2 or V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1) => ((not V18_COOKING) or DOOR_CLOSED)) 
...
and (V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock => (not V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1)) 
and (V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock => (not (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root = 2))) 
and ((not V61_rlt_eval_microwave_mode_logic_ON_rlt_complete_2) => (not V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1)) 
and ((V73_rlt_enter_microwave_mode_logic_ON_rlt_fired_0 and (((V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root >= 1) and (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root <= 3)) and (if (not (V49_chart_microwave_mode_logic_door_closed = 0)) then true else false))) => (not V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1)) 
and ((V73_rlt_enter_microwave_mode_logic_ON_rlt_fired_0 and (((V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root >= 1) and (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root <= 3)) and (if (not (V49_chart_microwave_mode_logic_door_closed = 0)) then true else false))) => (not (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root = 2))) 
and ((V73_rlt_enter_microwave_mode_logic_ON_rlt_fired_0 and (((V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root >= 1) and (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root <= 3)) and (if (not (V49_chart_microwave_mode_logic_door_closed = 0)) then true else false))) => DOOR_CLOSED) 
...
and ((not (V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 or V61_rlt_eval_microwave_mode_logic_ON_rlt_complete_2)) => (not V18_COOKING)) 
...
and ((((if (not (V48_chart_microwave_mode_logic_clear_off = 0)) then true else false) or (not (if (not (V49_chart_microwave_mode_logic_door_closed = 0)) then true else false))) and (not (V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 or V61_rlt_eval_microwave_mode_logic_ON_rlt_complete_2))) => (not V18_COOKING)) 
...
and ((V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4) => (not V18_COOKING)) 
and ((V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4) => (V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root >= 1)) 
and ((V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4) => (not V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1)) 
and ((V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4) => ((not V18_COOKING) or DOOR_CLOSED)) 
...
and (((V87_chart_microwave_mode_logic_begin_state_states___root = 4) and ((if (not (V47_chart_microwave_mode_logic_start = 0)) then true else false) and (if (not ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) = 0)) then true else false))) => (V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root >= 1)) 
and (((if (not (V47_chart_microwave_mode_logic_start = 0)) then true else false) and (if (not ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) = 0)) then true else false)) => (not V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1)) 
and (((if (not (V47_chart_microwave_mode_logic_start = 0)) then true else false) and (if (not ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) = 0)) then true else false)) => ((not V18_COOKING) or DOOR_CLOSED)) 
and (((V87_chart_microwave_mode_logic_begin_state_states___root = 4) and ((if (not (V47_chart_microwave_mode_logic_start = 0)) then true else false) and (if (not ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) = 0)) then true else false))) => ((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root >= 1) and (V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root <= 3))) 
...
and ((2 = V96_microwave_microwave_mode_logic_mode) => (V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root >= 1)) 
and ((2 = V96_microwave_microwave_mode_logic_mode) => (not V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1)) 
and ((2 = V96_microwave_microwave_mode_logic_mode) => ((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root >= 1) and (V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root <= 3))) 
and ((2 = V96_microwave_microwave_mode_logic_mode) => (V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 or V61_rlt_eval_microwave_mode_logic_ON_rlt_complete_2)) 
...
and (V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1 => (V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 or V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1)) 
and (V54_rlt_eval_microwave_mode_logic_ON_rlt_fired_2 => (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) 
and ((V54_rlt_eval_microwave_mode_logic_ON_rlt_fired_2 or V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1) => (V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 or V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1)) 
...
and ((V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root = 2) => ((V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root >= 1) and (V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root <= 3))) 
...
and ((not (V48_chart_microwave_mode_logic_clear_off = 0)) => KP_CLEAR) 
...
and (((if (not (V47_chart_microwave_mode_logic_start = 0)) then true else false) and (if (not (V49_chart_microwave_mode_logic_door_closed = 0)) then true else false)) => DOOR_CLOSED) 
...
and ((V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3) => (not V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1)) 
and ((V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3) => ((not V18_COOKING) or DOOR_CLOSED)) 
...
and (((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root = 3) and (not V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1)) => (not V18_COOKING)) 
...
and ((V53_rlt_eval_microwave_mode_logic_ON_rlt_state_2_states___root = 3) => ((not V18_COOKING) or DOOR_CLOSED)) 
...
and ((2 = V96_microwave_microwave_mode_logic_mode) => (V63_rlt_eval_microwave_mode_logic_ON_rlt_state_6_outports_steps_remaining > 0)) 
...
and (V86_chart_microwave_mode_logic_rlt_evtInitStep => V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock) 
and (V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1 => (pre V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step)) 
and ((V54_rlt_eval_microwave_mode_logic_ON_rlt_fired_2 or V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1) => (pre V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step)) 
...
and ((V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3) => ((not V18_COOKING) or DOOR_CLOSED)) 
...
and (V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1 => (not V18_COOKING)) 
and ((V54_rlt_eval_microwave_mode_logic_ON_rlt_fired_2 or V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1) => (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2))) 
...
and (V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1 => ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3))) 
...
and ((V54_rlt_eval_microwave_mode_logic_ON_rlt_fired_2 or V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1) => ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3))) 
and (V86_chart_microwave_mode_logic_rlt_evtInitStep => ((not V18_COOKING) or DOOR_CLOSED)) 
...
and ((not ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) = 0)) => V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock) 
...
and ((V73_rlt_enter_microwave_mode_logic_ON_rlt_fired_0 and (((V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root >= 1) and (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root <= 3)) and (if (not (V49_chart_microwave_mode_logic_door_closed = 0)) then true else false))) => V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock) 
and (DOOR_CLOSED => ((not V18_COOKING) or DOOR_CLOSED)) 
...
and (((if (not (V47_chart_microwave_mode_logic_start = 0)) then true else false) and (if (not (V49_chart_microwave_mode_logic_door_closed = 0)) then true else false)) => ((not V18_COOKING) or DOOR_CLOSED)) 
...
and (((if (not (V47_chart_microwave_mode_logic_start = 0)) then true else false) and (if (not (V49_chart_microwave_mode_logic_door_closed = 0)) then true else false)) => (not (V47_chart_microwave_mode_logic_start = 0))) 
...
and ((not (V47_chart_microwave_mode_logic_start = 0)) => KP_START) 
...
and ((V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining <= 0) => ((not V18_COOKING) or DOOR_CLOSED)) 
...
and ((V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining <= 0) => (not V18_COOKING)) 
and (((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) = 0) => (not V81_rlt_eval_microwave_mode_logic_rlt_fired_1)) 
and (((V87_chart_microwave_mode_logic_begin_state_states___root = 4) and ((if (not (V47_chart_microwave_mode_logic_start = 0)) then true else false) and (if (not ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) = 0)) then true else false))) => (V87_chart_microwave_mode_logic_begin_state_states___root = 4)) 
and (((if (not (V47_chart_microwave_mode_logic_start = 0)) then true else false) and (if (not ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) = 0)) then true else false)) => V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock) 
...
and (V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1 => (V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4)) 
and (V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1 => ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) = 0)) 
and (V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1 => (V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining <= 0)) 
and ((V54_rlt_eval_microwave_mode_logic_ON_rlt_fired_2 or V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1) => (V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root >= 1)) 
and ((V54_rlt_eval_microwave_mode_logic_ON_rlt_fired_2 or V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1) => ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) = 0)) 
...
and (((V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root >= 1) and (V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root <= 3)) => (V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root >= 1)) 
...
and ((not (V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 or V61_rlt_eval_microwave_mode_logic_ON_rlt_complete_2)) => (not V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1)) 
and ((not (V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 or V61_rlt_eval_microwave_mode_logic_ON_rlt_complete_2)) => ((not V18_COOKING) or DOOR_CLOSED)) 
...
and ((not V18_COOKING) => (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2))) 
and ((not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2)) => ((not V18_COOKING) or DOOR_CLOSED)) 
and ((KP_6 and (not (pre KP_6))) => KP_6) 
and (V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1 => ((not V18_COOKING) or DOOR_CLOSED)) 
...
and ((V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3) => ((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root >= 1) and (V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root <= 3))) 
...
and ((V73_rlt_enter_microwave_mode_logic_ON_rlt_fired_0 and (((V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root >= 1) and (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root <= 3)) and (not V74_rlt_enter_microwave_mode_logic_ON_rlt_fired_1))) => V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock) 
...
and (V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 => (KP_CLEAR and (not (pre KP_CLEAR)))) 
and (V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 => ((if (not (V48_chart_microwave_mode_logic_clear_off = 0)) then true else false) and (not V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1))) 
and ((V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 or V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1) => (V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root >= 1)) 
...
and (((if (not (V47_chart_microwave_mode_logic_start = 0)) then true else false) and (if (not ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) = 0)) then true else false)) => (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3))) 
...
and (((if (not (V47_chart_microwave_mode_logic_start = 0)) then true else false) and (if (not ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) = 0)) then true else false)) => (not (V47_chart_microwave_mode_logic_start = 0))) 
...
and (V49_chart_microwave_mode_logic_door_closed = (if (DOOR_CLOSED = false) then 0 else 1)) 
and ((if (V20_START_PRESSED = false) then 0 else 1) = V47_chart_microwave_mode_logic_start) 
and ((if (not (V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4)) then 1 else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode) = (if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 1 else V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode)) 
and ((if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 1 else V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode) = (if (not (V87_chart_microwave_mode_logic_begin_state_states___root = 4)) then 1 else V88_chart_microwave_mode_logic_begin_state_outports_mode)) 
and ((if (not (V87_chart_microwave_mode_logic_begin_state_states___root = 4)) then 1 else V88_chart_microwave_mode_logic_begin_state_outports_mode) = 1) 
...
and ((if V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 then (if (not (V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4)) then 1 else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode) else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode) = (if V69_rlt_eval_microwave_mode_logic_ON_rlt_fired_6 then (if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V71_rlt_eval_microwave_mode_logic_ON_rlt_state_11_outports_mode) else V71_rlt_eval_microwave_mode_logic_ON_rlt_state_11_outports_mode)) 
and ((if V69_rlt_eval_microwave_mode_logic_ON_rlt_fired_6 then (if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V71_rlt_eval_microwave_mode_logic_ON_rlt_state_11_outports_mode) else V71_rlt_eval_microwave_mode_logic_ON_rlt_state_11_outports_mode) = V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) 
and (V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode = (if V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 then (if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode)) 
and ((if V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 then (if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) = (if ((not V81_rlt_eval_microwave_mode_logic_rlt_fired_1) and ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3))) then (if V69_rlt_eval_microwave_mode_logic_ON_rlt_fired_6 then (if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V71_rlt_eval_microwave_mode_logic_ON_rlt_state_11_outports_mode) else V71_rlt_eval_microwave_mode_logic_ON_rlt_state_11_outports_mode) else V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode)) 
...
and (2 = (if (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2)) then 2 else V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root)) 
and ((if (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2)) then 2 else V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root) = (if (not (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root = 2)) then 2 else V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root)) 
and ((if (not (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root = 2)) then 2 else V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root) = (if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode)) 
and ((if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) = (if (not (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root = 2)) then 2 else V88_chart_microwave_mode_logic_begin_state_outports_mode)) 
and ((if (not (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root = 2)) then 2 else V88_chart_microwave_mode_logic_begin_state_outports_mode) = (if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root)) 
...
and ((if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) = 3) 
and (3 = (if (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) then 3 else V76_rlt_enter_microwave_mode_logic_ON_rlt_state_2_outports_mode)) 
...
and ((if V81_rlt_eval_microwave_mode_logic_rlt_fired_1 then (if (V87_chart_microwave_mode_logic_begin_state_states___root = 4) then 0 else V87_chart_microwave_mode_logic_begin_state_states___root) else V87_chart_microwave_mode_logic_begin_state_states___root) = V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root) 
and ((if (V64_rlt_eval_microwave_mode_logic_ON_rlt_state_7_states___root = 2) then 1 else V64_rlt_eval_microwave_mode_logic_ON_rlt_state_7_states___root) = (if (V68_rlt_eval_microwave_mode_logic_ON_rlt_state_10_states___root = 2) then 1 else V68_rlt_eval_microwave_mode_logic_ON_rlt_state_10_states___root)) 
...
and ((if V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 then (if ((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root >= 1) and (V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root <= 3)) then 0 else V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root) else V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root) = V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root) 
...
and ((if ((not V81_rlt_eval_microwave_mode_logic_rlt_fired_1) and ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3))) then (if V69_rlt_eval_microwave_mode_logic_ON_rlt_fired_6 then (if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) else V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root) = V68_rlt_eval_microwave_mode_logic_ON_rlt_state_10_states___root) 
and ((if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 4 else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root) = (if (not (V87_chart_microwave_mode_logic_begin_state_states___root = 4)) then 4 else V87_chart_microwave_mode_logic_begin_state_states___root)) 
and ((if (not (V87_chart_microwave_mode_logic_begin_state_states___root = 4)) then 4 else V87_chart_microwave_mode_logic_begin_state_states___root) = 4) 
and (4 = (if (not (V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4)) then 4 else V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root)) 
...
and (0 <=V25_STEPS_TO_COOK) 
and (0 <=(if ((not V81_rlt_eval_microwave_mode_logic_rlt_fired_1) and ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3))) then (if V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 then (V63_rlt_eval_microwave_mode_logic_ON_rlt_state_6_outports_steps_remaining - 1) else V63_rlt_eval_microwave_mode_logic_ON_rlt_state_6_outports_steps_remaining) else V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining)) 
...
and (0 <=V49_chart_microwave_mode_logic_door_closed) 
and (0 <=(if (V20_START_PRESSED = false) then 0 else 1)) 
and (0 <=(if (not (V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4)) then 1 else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode)) 
...
and (0 <=(if V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 then (if (not (V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4)) then 1 else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode) else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode)) 
...
and (0 <=(if (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2)) then 2 else V57_rlt_eval_microwave_mode_logic_ON_rlt_state_3_outports_mode)) 
...
and (0 <=V78_rlt_enter_microwave_mode_logic_ON_rlt_state_4_states___root) 
and (0 <=(if (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) then 3 else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root)) 
...
and (0 <=(if V81_rlt_eval_microwave_mode_logic_rlt_fired_1 then (if (V87_chart_microwave_mode_logic_begin_state_states___root = 4) then 0 else V87_chart_microwave_mode_logic_begin_state_states___root) else V87_chart_microwave_mode_logic_begin_state_states___root)) 
and (0 <=(if (V64_rlt_eval_microwave_mode_logic_ON_rlt_state_7_states___root = 2) then 1 else V64_rlt_eval_microwave_mode_logic_ON_rlt_state_7_states___root)) 
...
and (0 <=(if V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 then (if ((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root >= 1) and (V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root <= 3)) then 0 else V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root) else V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root)) 
and (0 <=V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root) 
and (0 <=V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root) 
and (0 <=V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root) 
...
and (0 <=(if V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 then (if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root) else V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root)) 
...
and (0 <=(if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 4 else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root)) 
...
and ((if V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step then 0 else (if KP_CLEAR then 0 else (if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY) else (pre V38_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_LEFT_DIGIT_DIGIT_TO_DISPLAY)))) <=V25_STEPS_TO_COOK) 
and ((if V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step then 0 else (if KP_CLEAR then 0 else (if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY) else (pre V38_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_LEFT_DIGIT_DIGIT_TO_DISPLAY)))) <=(if ((not V81_rlt_eval_microwave_mode_logic_rlt_fired_1) and ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3))) then (if V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 then (V63_rlt_eval_microwave_mode_logic_ON_rlt_state_6_outports_steps_remaining - 1) else V63_rlt_eval_microwave_mode_logic_ON_rlt_state_6_outports_steps_remaining) else V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining)) 
...
and ((if (V87_chart_microwave_mode_logic_begin_state_states___root = 4) then 0 else V87_chart_microwave_mode_logic_begin_state_states___root) <=(if V81_rlt_eval_microwave_mode_logic_rlt_fired_1 then (if (V87_chart_microwave_mode_logic_begin_state_states___root = 4) then 0 else V87_chart_microwave_mode_logic_begin_state_states___root) else V87_chart_microwave_mode_logic_begin_state_states___root)) 
...
and ((if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) else (pre V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY)) <=(if KP_9 then 9 else 10)) 
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=(if (not (V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4)) then 1 else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode)) 
...
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=(if V74_rlt_enter_microwave_mode_logic_ON_rlt_fired_1 then (if (not (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root = 2)) then 2 else V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root) else V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root)) 
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=(if (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2)) then 2 else V57_rlt_eval_microwave_mode_logic_ON_rlt_state_3_outports_mode)) 
...
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=V78_rlt_enter_microwave_mode_logic_ON_rlt_state_4_states___root) 
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=(if (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) then 3 else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root)) 
...
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=(if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 4 else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root)) 
...
and ((if V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock then (if V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step then 0 else (if KP_CLEAR then 0 else (if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (pre V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY) else (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY)))) else (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY)) <=10) 
and ((if V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock then (if V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step then 0 else (if KP_CLEAR then 0 else (if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (pre V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY) else (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY)))) else (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY)) <=60) 
and (V49_chart_microwave_mode_logic_door_closed <=(if V74_rlt_enter_microwave_mode_logic_ON_rlt_fired_1 then (if (not (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root = 2)) then 2 else V88_chart_microwave_mode_logic_begin_state_outports_mode) else V88_chart_microwave_mode_logic_begin_state_outports_mode)) 
and ((if (not (V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4)) then 1 else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode) <=(if KP_1 then 1 else (if KP_2 then 2 else (if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))))) 
and ((if (not (V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4)) then 1 else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode) <=(if V86_chart_microwave_mode_logic_rlt_evtInitStep then (if (not (V87_chart_microwave_mode_logic_begin_state_states___root = 4)) then 1 else V88_chart_microwave_mode_logic_begin_state_outports_mode) else (if ((not V81_rlt_eval_microwave_mode_logic_rlt_fired_1) and ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3))) then (if V69_rlt_eval_microwave_mode_logic_ON_rlt_fired_6 then (if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V71_rlt_eval_microwave_mode_logic_ON_rlt_state_11_outports_mode) else V71_rlt_eval_microwave_mode_logic_ON_rlt_state_11_outports_mode) else V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode))) 
and ((if (not (V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4)) then 1 else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode) <=(if (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2)) then 2 else V57_rlt_eval_microwave_mode_logic_ON_rlt_state_3_outports_mode)) 
and ((if (not (V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4)) then 1 else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode) <=(if KP_2 then 2 else (if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))))))) 
and ((if (not (V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4)) then 1 else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode) <=(if V86_chart_microwave_mode_logic_rlt_evtInitStep then V85_rlt_enter_microwave_mode_logic_rlt_state_2_states___root else (if ((not V81_rlt_eval_microwave_mode_logic_rlt_fired_1) and ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3))) then (if V69_rlt_eval_microwave_mode_logic_ON_rlt_fired_6 then (if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) else V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root))) 
and ((if (not (V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4)) then 1 else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode) <=(if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) 
and ((if (not (V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4)) then 1 else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode) <=(if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10))))))))) 
...
and (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root <=V78_rlt_enter_microwave_mode_logic_ON_rlt_state_4_states___root) 
...
and ((if V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 then (if (not (V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4)) then 1 else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode) else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode) <=(if V54_rlt_eval_microwave_mode_logic_ON_rlt_fired_2 then (if (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2)) then 2 else V57_rlt_eval_microwave_mode_logic_ON_rlt_state_3_outports_mode) else V57_rlt_eval_microwave_mode_logic_ON_rlt_state_3_outports_mode)) 
and ((if V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 then (if (not (V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4)) then 1 else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode) else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode) <=(if V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1 then (if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 1 else V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode) else V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode)) 
and ((if V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 then (if (not (V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4)) then 1 else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode) else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode) <=V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode) 
and ((if V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 then (if (not (V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4)) then 1 else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode) else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode) <=V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root) 
and ((if V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 then (if (not (V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4)) then 1 else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode) else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode) <=V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root) 
and ((if V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 then (if (not (V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4)) then 1 else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode) else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode) <=V53_rlt_eval_microwave_mode_logic_ON_rlt_state_2_states___root) 
and ((if V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 then (if (not (V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4)) then 1 else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode) else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode) <=(if V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 then (if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root) else V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root)) 
and ((if V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 then (if (not (V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4)) then 1 else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode) else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode) <=V87_chart_microwave_mode_logic_begin_state_states___root) 
...
and ((if V54_rlt_eval_microwave_mode_logic_ON_rlt_fired_2 then (if (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2)) then 2 else V57_rlt_eval_microwave_mode_logic_ON_rlt_state_3_outports_mode) else V57_rlt_eval_microwave_mode_logic_ON_rlt_state_3_outports_mode) <=V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root) 
and ((if V54_rlt_eval_microwave_mode_logic_ON_rlt_fired_2 then (if (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2)) then 2 else V57_rlt_eval_microwave_mode_logic_ON_rlt_state_3_outports_mode) else V57_rlt_eval_microwave_mode_logic_ON_rlt_state_3_outports_mode) <=(if V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 then (if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root) else V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root)) 
...
and (V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode <=V53_rlt_eval_microwave_mode_logic_ON_rlt_state_2_states___root) 
...
and ((if (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2)) then 2 else V57_rlt_eval_microwave_mode_logic_ON_rlt_state_3_outports_mode) <=V78_rlt_enter_microwave_mode_logic_ON_rlt_state_4_states___root) 
and ((if (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2)) then 2 else V57_rlt_eval_microwave_mode_logic_ON_rlt_state_3_outports_mode) <=(if (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) then 3 else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root)) 
and ((if (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2)) then 2 else V57_rlt_eval_microwave_mode_logic_ON_rlt_state_3_outports_mode) <=(if V86_chart_microwave_mode_logic_rlt_evtInitStep then V85_rlt_enter_microwave_mode_logic_rlt_state_2_states___root else (if ((not V81_rlt_eval_microwave_mode_logic_rlt_fired_1) and ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3))) then (if V69_rlt_eval_microwave_mode_logic_ON_rlt_fired_6 then (if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) else V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root))) 
and ((if (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2)) then 2 else V57_rlt_eval_microwave_mode_logic_ON_rlt_state_3_outports_mode) <=(pre V90_chart_microwave_mode_logic_final_state_states___root)) 
and ((if (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2)) then 2 else V57_rlt_eval_microwave_mode_logic_ON_rlt_state_3_outports_mode) <=(if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 4 else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root)) 
and ((if (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2)) then 2 else V57_rlt_eval_microwave_mode_logic_ON_rlt_state_3_outports_mode) <=5) 
and ((if (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2)) then 2 else V57_rlt_eval_microwave_mode_logic_ON_rlt_state_3_outports_mode) <=6) 
and ((if (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2)) then 2 else V57_rlt_eval_microwave_mode_logic_ON_rlt_state_3_outports_mode) <=7) 
and ((if (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2)) then 2 else V57_rlt_eval_microwave_mode_logic_ON_rlt_state_3_outports_mode) <=8) 
and ((if (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2)) then 2 else V57_rlt_eval_microwave_mode_logic_ON_rlt_state_3_outports_mode) <=9) 
...
and ((if (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) then 3 else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root) <=(if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 4 else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root)) 
and ((if (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) then 3 else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root) <=5) 
and ((if (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) then 3 else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root) <=6) 
and ((if (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) then 3 else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root) <=7) 
and ((if (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) then 3 else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root) <=8) 
and ((if (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) then 3 else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root) <=9) 
...
and ((if ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3)) then 0 else V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root) <=V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root) 
...
and ((if ((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root >= 1) and (V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root <= 3)) then 0 else V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root) <=(if V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 then (if ((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root >= 1) and (V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root <= 3)) then 0 else V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root) else V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root)) 
...
and ((if ((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root >= 1) and (V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root <= 3)) then 0 else V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root) <=V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root) 
...
and ((if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 4 else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root) <=5) 
and ((if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 4 else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root) <=6) 
and ((if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 4 else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root) <=7) 
and ((if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 4 else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root) <=8) 
and ((if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 4 else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root) <=9) 
...
and ((if V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 then (V63_rlt_eval_microwave_mode_logic_ON_rlt_state_6_outports_steps_remaining - 1) else V63_rlt_eval_microwave_mode_logic_ON_rlt_state_6_outports_steps_remaining) <=(if ((not V81_rlt_eval_microwave_mode_logic_rlt_fired_1) and ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3))) then (if V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 then (V63_rlt_eval_microwave_mode_logic_ON_rlt_state_6_outports_steps_remaining - 1) else V63_rlt_eval_microwave_mode_logic_ON_rlt_state_6_outports_steps_remaining) else V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining)) 
and ((if ((not V81_rlt_eval_microwave_mode_logic_rlt_fired_1) and ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3))) then (if V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 then (V63_rlt_eval_microwave_mode_logic_ON_rlt_state_6_outports_steps_remaining - 1) else V63_rlt_eval_microwave_mode_logic_ON_rlt_state_6_outports_steps_remaining) else V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining) <=(if V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 then 0 else V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining)) 
...
and ((pre V96_microwave_microwave_mode_logic_mode) <=(if (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) then 3 else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root)) 
and ((if (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) then 3 else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root) <=(if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))) 
...
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=V25_STEPS_TO_COOK) 
and (V25_STEPS_TO_COOK <=(if V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock then ((((V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY * 1) + (V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY * 10)) + (V38_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_LEFT_DIGIT_DIGIT_TO_DISPLAY * 60)) * 1) else (pre V25_STEPS_TO_COOK))) 
...
and (((V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY * 1) + (V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY * 10)) <=((((V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY * 1) + (V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY * 10)) + (V38_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_LEFT_DIGIT_DIGIT_TO_DISPLAY * 60)) * 1)) 
and ((if (V21_CLEAR_PRESSED = false) then 0 else 1) <=(if (not (V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4)) then 1 else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode)) 
and ((if (not (V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4)) then 1 else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode) <=V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root) 
and (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root <=(pre V96_microwave_microwave_mode_logic_mode)) 
and ((pre V96_microwave_microwave_mode_logic_mode) <=(if (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) then 3 else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root)) 
and ((if (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) then 3 else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root) <=(if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))) 
and ((if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))))) <=(if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))))) 
...
and ((if (KP_9 and (not (pre KP_9))) then 9 else 10) <=10) 
and (10 <=60) 
and (V49_chart_microwave_mode_logic_door_closed <=(if (not (V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4)) then 1 else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode)) 
and ((if (not (V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4)) then 1 else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode) <=V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root) 
and (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root <=(pre V96_microwave_microwave_mode_logic_mode)) 
and ((pre V96_microwave_microwave_mode_logic_mode) <=(if (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) then 3 else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root)) 
and ((if (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) then 3 else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root) <=(if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))) 
...
and ((if (KP_9 and (not (pre KP_9))) then 9 else 10) <=10) 
and (10 <=60) 
and ((if (V20_START_PRESSED = false) then 0 else 1) <=(if (not (V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4)) then 1 else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode)) 
and ((if (not (V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4)) then 1 else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode) <=V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root) 
and (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root <=(pre V96_microwave_microwave_mode_logic_mode)) 
and ((pre V96_microwave_microwave_mode_logic_mode) <=(if (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) then 3 else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root)) 
and ((if (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) then 3 else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root) <=(if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))) 
...
and ((if (KP_9 and (not (pre KP_9))) then 9 else 10) <=10) 
and (10 <=60) 
and ((if V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 then (if (not (V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4)) then 1 else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode) else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode) <=(if V86_chart_microwave_mode_logic_rlt_evtInitStep then (if (not (V87_chart_microwave_mode_logic_begin_state_states___root = 4)) then 1 else V88_chart_microwave_mode_logic_begin_state_outports_mode) else (if ((not V81_rlt_eval_microwave_mode_logic_rlt_fired_1) and ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3))) then (if V69_rlt_eval_microwave_mode_logic_ON_rlt_fired_6 then (if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V71_rlt_eval_microwave_mode_logic_ON_rlt_state_11_outports_mode) else V71_rlt_eval_microwave_mode_logic_ON_rlt_state_11_outports_mode) else V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode))) 
and ((if V86_chart_microwave_mode_logic_rlt_evtInitStep then (if (not (V87_chart_microwave_mode_logic_begin_state_states___root = 4)) then 1 else V88_chart_microwave_mode_logic_begin_state_outports_mode) else (if ((not V81_rlt_eval_microwave_mode_logic_rlt_fired_1) and ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3))) then (if V69_rlt_eval_microwave_mode_logic_ON_rlt_fired_6 then (if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V71_rlt_eval_microwave_mode_logic_ON_rlt_state_11_outports_mode) else V71_rlt_eval_microwave_mode_logic_ON_rlt_state_11_outports_mode) else V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode)) <=V78_rlt_enter_microwave_mode_logic_ON_rlt_state_4_states___root) 
and (V78_rlt_enter_microwave_mode_logic_ON_rlt_state_4_states___root <=(if (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) then 3 else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root)) 
and ((if (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) then 3 else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root) <=(if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))) 
and ((if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))))) <=(if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))))) 
and ((if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))) <=(if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))) 
and ((if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))) <=(if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))) 
...
and ((if V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1 then (if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 1 else V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode) else V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode) <=V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode) 
and (V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode <=V78_rlt_enter_microwave_mode_logic_ON_rlt_state_4_states___root) 
and (V78_rlt_enter_microwave_mode_logic_ON_rlt_state_4_states___root <=(if (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) then 3 else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root)) 
and ((if (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) then 3 else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root) <=(if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))) 
and ((if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))))) <=(if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))))) 
and ((if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))) <=(if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))) 
...
and (10 <=60) 
and ((if V74_rlt_enter_microwave_mode_logic_ON_rlt_fired_1 then (if (not (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root = 2)) then 2 else V88_chart_microwave_mode_logic_begin_state_outports_mode) else V88_chart_microwave_mode_logic_begin_state_outports_mode) <=(if V74_rlt_enter_microwave_mode_logic_ON_rlt_fired_1 then (if (not (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root = 2)) then 2 else V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root) else V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root)) 
and ((if V74_rlt_enter_microwave_mode_logic_ON_rlt_fired_1 then (if (not (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root = 2)) then 2 else V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root) else V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root) <=V78_rlt_enter_microwave_mode_logic_ON_rlt_state_4_states___root) 
and (V78_rlt_enter_microwave_mode_logic_ON_rlt_state_4_states___root <=(if (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) then 3 else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root)) 
and ((if (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) then 3 else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root) <=(if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))) 
and ((if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))))) <=(if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))))) 
and ((if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))) <=(if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))) 
...
and ((if (KP_9 and (not (pre KP_9))) then 9 else 10) <=10) 
and (10 <=60) 
and ((if (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2)) then 2 else V57_rlt_eval_microwave_mode_logic_ON_rlt_state_3_outports_mode) <=(if KP_2 then 2 else (if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))))))) 
and ((if KP_2 then 2 else (if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))) <=(if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))) 
and ((if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))))) <=(if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))))) 
and ((if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))) <=(if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))) 
and ((if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))) <=(if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))) 
...
and ((if ((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root >= 1) and (V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root <= 3)) then 0 else V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root) <=(if (V64_rlt_eval_microwave_mode_logic_ON_rlt_state_7_states___root = 2) then 1 else V64_rlt_eval_microwave_mode_logic_ON_rlt_state_7_states___root)) 
and ((if (V64_rlt_eval_microwave_mode_logic_ON_rlt_state_7_states___root = 2) then 1 else V64_rlt_eval_microwave_mode_logic_ON_rlt_state_7_states___root) <=(if V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 then (if (V64_rlt_eval_microwave_mode_logic_ON_rlt_state_7_states___root = 2) then 1 else V64_rlt_eval_microwave_mode_logic_ON_rlt_state_7_states___root) else V64_rlt_eval_microwave_mode_logic_ON_rlt_state_7_states___root)) 
and ((if V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 then (if (V64_rlt_eval_microwave_mode_logic_ON_rlt_state_7_states___root = 2) then 1 else V64_rlt_eval_microwave_mode_logic_ON_rlt_state_7_states___root) else V64_rlt_eval_microwave_mode_logic_ON_rlt_state_7_states___root) <=(if V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 then (if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root) else V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root)) 
and ((if V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 then (if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root) else V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root) <=(if V86_chart_microwave_mode_logic_rlt_evtInitStep then V85_rlt_enter_microwave_mode_logic_rlt_state_2_states___root else (if ((not V81_rlt_eval_microwave_mode_logic_rlt_fired_1) and ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3))) then (if V69_rlt_eval_microwave_mode_logic_ON_rlt_fired_6 then (if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) else V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root))) 
and ((if V86_chart_microwave_mode_logic_rlt_evtInitStep then V85_rlt_enter_microwave_mode_logic_rlt_state_2_states___root else (if ((not V81_rlt_eval_microwave_mode_logic_rlt_fired_1) and ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3))) then (if V69_rlt_eval_microwave_mode_logic_ON_rlt_fired_6 then (if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) else V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root)) <=(if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 4 else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root)) 
and ((if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 4 else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root) <=(if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))))) 
and ((if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))) <=(if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))) 
and ((if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))) <=(if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))) 
and ((if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))) <=(if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))) 
and ((if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))) <=(if KP_8 then 8 else (if KP_9 then 9 else 10))) 
...
and (V53_rlt_eval_microwave_mode_logic_ON_rlt_state_2_states___root <=(if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 4 else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root)) 
and ((if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 4 else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root) <=(if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))))) 
and ((if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))) <=(if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))) 
and ((if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))) <=(if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))) 
and ((if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))) <=(if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))) 
...
and (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root <=V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root) 
and (V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root <=V53_rlt_eval_microwave_mode_logic_ON_rlt_state_2_states___root) 
and (V53_rlt_eval_microwave_mode_logic_ON_rlt_state_2_states___root <=(if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 4 else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root)) 
and ((if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 4 else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root) <=(if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))))) 
and ((if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))) <=(if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))) 
and ((if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))) <=(if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))) 
...
and ((if (KP_9 and (not (pre KP_9))) then 9 else 10) <=10) 
and (10 <=60) 
and ((if V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 then (if ((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root >= 1) and (V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root <= 3)) then 0 else V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root) else V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root) <=V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root) 
and (V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root <=V53_rlt_eval_microwave_mode_logic_ON_rlt_state_2_states___root) 
and (V53_rlt_eval_microwave_mode_logic_ON_rlt_state_2_states___root <=(if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 4 else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root)) 
and ((if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 4 else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root) <=(if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))))) 
and ((if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))) <=(if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))) 
...
and ((if (KP_9 and (not (pre KP_9))) then 9 else 10) <=10) 
and (10 <=60) 
and (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root <=V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root) 
and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <=V53_rlt_eval_microwave_mode_logic_ON_rlt_state_2_states___root) 
and (V53_rlt_eval_microwave_mode_logic_ON_rlt_state_2_states___root <=(if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 4 else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root)) 
and ((if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 4 else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root) <=(if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))))) 
and ((if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))) <=(if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))) 
...
and ((pre V90_chart_microwave_mode_logic_final_state_states___root) <=(if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 4 else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root)) 
and ((if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 4 else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root) <=(if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))))) 
and ((if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))) <=(if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))) 
and ((if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))) <=(if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))) 
and ((if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))) <=(if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))) 
