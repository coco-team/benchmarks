...
-- 329 implications. 
assert (true -> ((V103_garde1 = V108_garde6) 
...
and ((V129_X and (pre V52_env)) => V52_env) 
...
and (V103_garde1 => (V52_env => (V50_exclusive < 2))) 
...
and (V129_X => ((((((((((((((((not e1) and (not e2)) and (not e3)) and (not e4)) and (not e5)) and (not e6)) and (not e7)) and (not e8)) or (((((((e1 and (not e2)) and (not e3)) and (not e4)) and (not e5)) and (not e6)) and (not e7)) and (not e8))) or ((((((((not e1) and e2) and (not e3)) and (not e4)) and (not e5)) and (not e6)) and (not e7)) and (not e8))) or ((((((((not e1) and (not e2)) and e3) and (not e4)) and (not e5)) and (not e6)) and (not e7)) and (not e8))) or ((((((((not e1) and (not e2)) and (not e3)) and e4) and (not e5)) and (not e6)) and (not e7)) and (not e8))) or ((((((((not e1) and (not e2)) and (not e3)) and (not e4)) and e5) and (not e6)) and (not e7)) and (not e8))) or ((((((((not e1) and (not e2)) and (not e3)) and (not e4)) and (not e5)) and e6) and (not e7)) and (not e8))) or ((((((((not e1) and (not e2)) and (not e3)) and (not e4)) and (not e5)) and (not e6)) and e7) and (not e8))) or ((((((((not e1) and (not e2)) and (not e3)) and (not e4)) and (not e5)) and (not e6)) and (not e7)) and e8))) 
...
and (V103_garde1 => (V50_exclusive < 2)) 
...
and ((V129_X and (pre V52_env)) => (pre V52_env)) 
...
and ((if V105_garde3 then ((pre V48_invalid) - 1) else (pre V48_invalid)) = (if V110_garde8 then ((pre V48_invalid) - 1) else (pre V48_invalid))) 
...
and (((pre V48_invalid) - 1) <=(if V105_garde3 then ((pre V48_invalid) - 1) else (pre V48_invalid))) 
...
and ((pre V48_invalid) <=(pre V111_mem_invalid)) 
and ((if V105_garde3 then ((pre V48_invalid) - 1) else (pre V48_invalid)) <=(if e8 then (if V110_garde8 then ((pre V48_invalid) - 1) else (pre V48_invalid)) else (pre V48_invalid))) 
