...
and (V75_garde_me3 => (V91_X or (pre V33_env))) 
and (V75_garde_me3 => (pre V33_env)) 
...
and (((pre V30_exclusive_me) >= 1) => (V91_X or (pre V33_env))) 
and (((pre V30_exclusive_me) >= 1) => (pre V33_env)) 
...
and ((not ((((((etat_me1 and etat_me2) or (etat_me1 and etat_me3)) or (etat_me1 and etat_me4)) or (etat_me2 and etat_me3)) or (etat_me2 and etat_me4)) or (etat_me3 and etat_me4))) => V33_env) 
...
and (((((etat_me1 and etat_me2) or (etat_me1 and etat_me3)) or (etat_me1 and etat_me4)) or (etat_me2 and etat_me3)) => ((((((etat_me1 and etat_me2) or (etat_me1 and etat_me3)) or (etat_me1 and etat_me4)) or (etat_me2 and etat_me3)) or (etat_me2 and etat_me4)) or (etat_me3 and etat_me4))) 
