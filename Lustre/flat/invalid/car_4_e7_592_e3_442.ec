...
and ((V33_env => (V28_speed >= 0)) = (V28_speed >= 0)) 
...
and ((not V30_move) => (V33_env => (V28_speed >= 0))) 
...
and (s => (V33_env => (V28_speed >= 0))) 
and (((pre V30_move) and (not (pre V25_stop))) => (pre V30_move)) 
and ((pre V26_bump) => (V33_env => (V28_speed >= 0))) 
and ((not V30_move) => ((not V30_move) or V31_second)) 
and ((pre V25_stop) => (V33_env => (V28_speed >= 0))) 
and ((m and (not s)) => (not s)) 
and (((not V30_move) or V31_second) => (V33_env => (V28_speed >= 0))) 
and ((not s) => V90_X) 
and ((m and s) => s) 
