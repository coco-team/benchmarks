...
let
  ...
  V99_X = (not ((((((etat_mo1 or etat_mo2) or (etat_mo1 and etat_mo3)) or (
...
-- 221 implications. 
assert (true -> (((not ((((((etat_mo1 or etat_mo2) or (etat_mo1 and etat_mo3)) or (etat_mo1 and etat_mo4)) or (etat_mo2 and etat_mo3)) or (etat_mo2 and etat_mo4)) or (etat_mo3 and etat_mo4))) = V99_X) 
and (V83_garde_mo1 = V86_garde_mo4) 
and (V86_garde_mo4 = ((pre V36_invalid_mo) >= 1)) 
and ((((etat_mo1 or etat_mo2) or (etat_mo1 and etat_mo3)) or (etat_mo1 and etat_mo4)) = (((((etat_mo1 or etat_mo2) or (etat_mo1 and etat_mo3)) or (etat_mo1 and etat_mo4)) or (etat_mo2 and etat_mo3)) or (etat_mo2 and etat_mo4))) 
and ((((((etat_mo1 or etat_mo2) or (etat_mo1 and etat_mo3)) or (etat_mo1 and etat_mo4)) or (etat_mo2 and etat_mo3)) or (etat_mo2 and etat_mo4)) = (etat_mo1 or etat_mo2)) 
and ((etat_mo1 or etat_mo2) = ((etat_mo1 or etat_mo2) or (etat_mo1 and etat_mo3))) 
and (((etat_mo1 or etat_mo2) or (etat_mo1 and etat_mo3)) = ((((etat_mo1 or etat_mo2) or (etat_mo1 and etat_mo3)) or (etat_mo1 and etat_mo4)) or (etat_mo2 and etat_mo3))) 
...
and ((((etat_mo1 or etat_mo2) or (etat_mo1 and etat_mo3)) or (etat_mo1 and etat_mo4)) => ((((((etat_mo1 or etat_mo2) or (etat_mo1 and etat_mo3)) or (etat_mo1 and etat_mo4)) or (etat_mo2 and etat_mo3)) or (etat_mo2 and etat_mo4)) or (etat_mo3 and etat_mo4))) 
...
and ((etat_mo1 and etat_mo4) => etat_mo1) 
and ((not ((((((etat_mo1 or etat_mo2) or (etat_mo1 and etat_mo3)) or (etat_mo1 and etat_mo4)) or (etat_mo2 and etat_mo3)) or (etat_mo2 and etat_mo4)) or (etat_mo3 and etat_mo4))) => V39_env) 
and ((etat_mo2 and etat_mo3) => (((etat_mo1 or etat_mo2) or (etat_mo1 and etat_mo3)) or (etat_mo1 and etat_mo4))) 
and ((etat_mo1 and etat_mo3) => etat_mo1) 
and ((etat_mo3 and etat_mo4) => etat_mo4) 
and ((etat_mo2 and etat_mo4) => etat_mo4) 
and (etat_mo2 => (((etat_mo1 or etat_mo2) or (etat_mo1 and etat_mo3)) or (etat_mo1 and etat_mo4))) 
...
and (etat_mo1 => (((etat_mo1 or etat_mo2) or (etat_mo1 and etat_mo3)) or (etat_mo1 and etat_mo4))) 
and ((pre V39_env) => (V99_X or (pre V39_env))) 
and (etat_mo1 => (V39_env => (((((V33_modified_mo + V34_exclusive_mo) + V35_shared_mo) + V36_invalid_mo) + V37_owned_mo) = (((((pre V33_modified_mo) + (pre V34_exclusive_mo)) + (pre V35_shared_mo)) + (pre V36_invalid_mo)) + (pre V37_owned_mo))))) 
