...
let
  ...
  and (((pre V39_nB1) - (pre V38_nB0)) <= 30)));
...
and ((((((pre V38_nB0) + 1) - (pre V39_nB1)) <= 30) and (((pre V39_nB1) - (pre V38_nB0)) <= 30)) => ((((pre V38_nB0) + 1) - (pre V39_nB1)) <= 30)) 
...
and ((((((pre V38_nB0) + 1) - (pre V39_nB1)) <= 30) and (((pre V39_nB1) - (pre V38_nB0)) <= 30)) => (((pre V39_nB1) - (pre V38_nB0)) <= 30)) 
...
and (0 <=((pre V39_nB1) + 1)) 
and (0 <=((pre V40_nS) + 1)) 
and (0 <=(if B0 then (((pre V158_c) + 1) + 1) else (pre V158_c))) 
