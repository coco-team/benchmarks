...
let
  ...
  V31_env = (V84_X -> (V84_X or (pre V31_env)));
...
-- 97 implications. 
assert (true -> ((((not ((((e_s1 and e_s2) and e_s1) and e_s3) or (e_s2 and e_s3))) and (init_invalid_s >= 0)) = V84_X) 
...
and (V31_env => (V84_X or (pre V31_env))) 
and ((((e_s1 and e_s2) and e_s1) and e_s3) => (e_s1 and e_s2)) 
and ((V31_env => (V29_dirty_s < 1)) => ((V31_env => (V29_dirty_s < 1)) or (V28_valid_s < 1))) 
...
and ((V28_valid_s < 1) => ((V31_env => (V29_dirty_s < 1)) or (V28_valid_s < 1))) 
...
and (((not ((((e_s1 and e_s2) and e_s1) and e_s3) or (e_s2 and e_s3))) and (init_invalid_s >= 0)) => V31_env) 
and ((pre V31_env) => (V84_X or (pre V31_env))) 
