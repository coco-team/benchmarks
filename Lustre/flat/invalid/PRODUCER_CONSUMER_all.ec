...
-- 91 implications. 
assert (true -> ((true = (V39_env => ((V34_i >= 0) and (((pre etat1) and etat2) => ((V37_o1 = ((pre V37_o1) + 1)) or (V37_o1 = (pre V37_o1))))))) 
...
and (((not (((etat1 and etat2) or (etat1 and etat3)) or (etat2 and etat3))) or (not ((etat1 or etat2) or etat3))) = V102_X) 
and (V88_garde1 = ((pre V34_i) >= 1)) 
and (((V107_Sofar and V115_First) and (V123_First > 0)) = V39_env) 
and (V90_garde3 = ((pre V35_b) >= 1)) 
and (((pre V35_b) >= 1) = V89_garde2) 
and (((V34_i >= 0) and (((pre etat1) and etat2) => ((V37_o1 = ((pre V37_o1) + 1)) or (V37_o1 = (pre V37_o1))))) => (V34_i >= 0)) 
...
and ((V107_Sofar and V115_First) => (not (((etat1 and etat2) or (etat1 and etat3)) or (etat2 and etat3)))) 
and (V107_Sofar => (not (((etat1 and etat2) or (etat1 and etat3)) or (etat2 and etat3)))) 
...
and ((not ((etat1 or etat2) or etat3)) => (not (((etat1 and etat2) or (etat1 and etat3)) or (etat2 and etat3)))) 
...
and (((V107_Sofar and V115_First) and (V123_First > 0)) => (((pre etat1) and etat2) => ((V37_o1 = ((pre V37_o1) + 1)) or (V37_o1 = (pre V37_o1))))) 
and (((V107_Sofar and V115_First) and (V123_First > 0)) => V107_Sofar) 
and (((V107_Sofar and V115_First) and (V123_First > 0)) => ((V34_i >= 0) and (((pre etat1) and etat2) => ((V37_o1 = ((pre V37_o1) + 1)) or (V37_o1 = (pre V37_o1)))))) 
and (((V107_Sofar and V115_First) and (V123_First > 0)) => (V123_First > 0)) 
and (((V107_Sofar and V115_First) and (V123_First > 0)) => (V107_Sofar and V115_First)) 
and (((V34_i >= 0) and (((pre etat1) and etat2) => ((V37_o1 = ((pre V37_o1) + 1)) or (V37_o1 = (pre V37_o1))))) => (((pre etat1) and etat2) => ((V37_o1 = ((pre V37_o1) + 1)) or (V37_o1 = (pre V37_o1))))) 
and ((pre V36_a) = (pre V123_First)) 
and ((if V90_garde3 then ((pre V35_b) - 1) else (pre V35_b)) = (if etat2 then (if V89_garde2 then ((pre V35_b) - 1) else (pre V35_b)) else (if V90_garde3 then ((pre V35_b) - 1) else (pre V35_b)))) 
and ((if etat2 then (if V89_garde2 then ((pre V35_b) - 1) else (pre V35_b)) else (if V90_garde3 then ((pre V35_b) - 1) else (pre V35_b))) = (if V89_garde2 then ((pre V35_b) - 1) else (pre V35_b))) 
and (0 <=(pre V37_o1)) 
and (0 <=V37_o1) 
...
and (0 <=1) 
and (0 <=((pre V37_o1) + 1)) 
and ((if V90_garde3 then ((pre V35_b) - 1) else (pre V35_b)) <=(if etat1 then (if V88_garde1 then ((pre V35_b) + 1) else (pre V35_b)) else (if etat2 then (if V89_garde2 then ((pre V35_b) - 1) else (pre V35_b)) else (if V90_garde3 then ((pre V35_b) - 1) else (pre V35_b))))) 
and (1 <=((pre V35_b) + 1)) 
...
and (((pre V35_b) - 1) <=(if V90_garde3 then ((pre V35_b) - 1) else (pre V35_b))) 
and ((if V90_garde3 then ((pre V35_b) - 1) else (pre V35_b)) <=(pre V35_b)) 
and ((pre V35_b) <=(if V88_garde1 then ((pre V35_b) + 1) else (pre V35_b))) 
and ((if V88_garde1 then ((pre V35_b) + 1) else (pre V35_b)) <=((pre V35_b) + 1)) 
and (V34_i <=V123_First) 
and (0 <=(if V90_garde3 then ((pre V35_b) - 1) else (pre V35_b))) 
and ((if V90_garde3 then ((pre V35_b) - 1) else (pre V35_b)) <=(pre V35_b)) 
and ((pre V35_b) <=(if V88_garde1 then ((pre V35_b) + 1) else (pre V35_b))) 
and ((if V88_garde1 then ((pre V35_b) + 1) else (pre V35_b)) <=((pre V35_b) + 1)) 
