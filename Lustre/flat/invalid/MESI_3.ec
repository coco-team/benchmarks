...
and ((if V85_garde_me1 then ((((pre V34_shared_me) + (pre V33_exclusive_me)) + (pre V32_modified_me)) - 1) else (pre V34_shared_me)) <=((pre V34_shared_me) + (pre V33_exclusive_me))) 
...
and ((if V87_garde_me3 then 0 else (pre V34_shared_me)) <=((pre V34_shared_me) + (pre V33_exclusive_me))) 
...
and (((pre V34_shared_me) + (pre V33_exclusive_me)) <=(pre V33_exclusive_me)) 
and ((pre V33_exclusive_me) <=(if etat_me3 then (if V87_garde_me3 then 1 else (pre V33_exclusive_me)) else (if etat_me4 then (if V88_garde_me4 then 1 else (pre V33_exclusive_me)) else (pre V33_exclusive_me)))) 
and ((if etat_me3 then (if V87_garde_me3 then 1 else (pre V33_exclusive_me)) else (if etat_me4 then (if V88_garde_me4 then 1 else (pre V33_exclusive_me)) else (pre V33_exclusive_me))) <=(if etat_me4 then (if V88_garde_me4 then 1 else (pre V33_exclusive_me)) else (pre V33_exclusive_me))) 
and ((if etat_me4 then (if V88_garde_me4 then 1 else (pre V33_exclusive_me)) else (pre V33_exclusive_me)) <=(if V88_garde_me4 then 1 else (pre V33_exclusive_me))) 
and ((if V88_garde_me4 then 1 else (pre V33_exclusive_me)) <=1) 
