...
-- 103 implications. 
assert (true -> ((V79_garde_s3 = V77_garde_s1) 
...
and ((e_s2 and e_s3) => (V34_env => (((V30_invalid_s + V31_valid_s) + V32_dirty_s) = V106_First))) 
and ((e_s2 and e_s3) => e_s2) 
and (V78_garde_s2 => V79_garde_s3) 
and (((e_s1 and e_s2) or (e_s1 and e_s3)) => e_s1) 
and ((e_s1 and e_s3) => (V34_env => (((V30_invalid_s + V31_valid_s) + V32_dirty_s) = V106_First))) 
...
and ((e_s1 and e_s2) => (V34_env => (((V30_invalid_s + V31_valid_s) + V32_dirty_s) = V106_First))) 
and ((e_s1 and e_s2) => e_s2) 
and (V34_env => V92_X) 
and ((e_s1 and e_s2) => ((e_s1 and e_s2) or (e_s1 and e_s3))) 
and ((e_s2 and e_s3) => e_s3) 
and (V92_X => (init_invalid_s >= 0)) 
and ((((V30_invalid_s + V31_valid_s) + V32_dirty_s) = V106_First) => (V34_env => (((V30_invalid_s + V31_valid_s) + V32_dirty_s) = V106_First))) 
and ((V92_X and (pre V34_env)) => (pre V34_env)) 
and (V92_X => (not (((e_s1 and e_s2) or (e_s1 and e_s3)) or (e_s2 and e_s3)))) 
and ((((e_s1 and e_s2) or (e_s1 and e_s3)) or (e_s2 and e_s3)) => (V34_env => (((V30_invalid_s + V31_valid_s) + V32_dirty_s) = V106_First))) 
and (0 = (if V79_garde_s3 then 0 else (pre V31_valid_s))) 
and ((if V79_garde_s3 then 0 else (pre V31_valid_s)) = (if V78_garde_s2 then 0 else (pre V31_valid_s))) 
and (((((pre V30_invalid_s) + (pre V32_dirty_s)) + (pre V31_valid_s)) - 1) = ((((pre V30_invalid_s) - 1) + (pre V32_dirty_s)) + (pre V31_valid_s))) 
and ((pre V106_First) = (pre V33_mem_init_s)) 
and (((pre V30_invalid_s) + (pre V32_dirty_s)) = ((((pre V30_invalid_s) + 1) + (pre V32_dirty_s)) - 1)) 
and ((((((pre V30_invalid_s) - 1) + (pre V32_dirty_s)) + (pre V31_valid_s)) - 1) <=(if V78_garde_s2 then (((((pre V30_invalid_s) - 1) + (pre V32_dirty_s)) + (pre V31_valid_s)) - 1) else (pre V30_invalid_s))) 
...
and ((((((pre V30_invalid_s) - 1) + (pre V32_dirty_s)) + (pre V31_valid_s)) - 1) <=((((pre V30_invalid_s) + (pre V32_dirty_s)) + (pre V31_valid_s)) - 1)) 
and (((((pre V30_invalid_s) + (pre V32_dirty_s)) + (pre V31_valid_s)) - 1) <=(if V79_garde_s3 then ((((pre V30_invalid_s) + (pre V32_dirty_s)) + (pre V31_valid_s)) - 1) else (pre V30_invalid_s))) 
and ((if V79_garde_s3 then ((((pre V30_invalid_s) + (pre V32_dirty_s)) + (pre V31_valid_s)) - 1) else (pre V30_invalid_s)) <=(((pre V30_invalid_s) + (pre V32_dirty_s)) + (pre V31_valid_s))) 
...
and ((if V78_garde_s2 then 1 else (pre V32_dirty_s)) <=(if V79_garde_s3 then 1 else (pre V32_dirty_s))) 
...
and (((((pre V30_invalid_s) + (pre V32_dirty_s)) + (pre V31_valid_s)) - 1) <=(if V79_garde_s3 then ((((pre V30_invalid_s) + (pre V32_dirty_s)) + (pre V31_valid_s)) - 1) else (pre V30_invalid_s))) 
and ((if V79_garde_s3 then ((((pre V30_invalid_s) + (pre V32_dirty_s)) + (pre V31_valid_s)) - 1) else (pre V30_invalid_s)) <=(((pre V30_invalid_s) + (pre V32_dirty_s)) + (pre V31_valid_s))) 
and ((if e_s3 then (if V79_garde_s3 then ((((pre V30_invalid_s) + (pre V32_dirty_s)) + (pre V31_valid_s)) - 1) else (pre V30_invalid_s)) else (pre V30_invalid_s)) <=(((pre V30_invalid_s) + (pre V32_dirty_s)) + (pre V31_valid_s))) 
and ((if e_s2 then (if V78_garde_s2 then (((((pre V30_invalid_s) - 1) + (pre V32_dirty_s)) + (pre V31_valid_s)) - 1) else (pre V30_invalid_s)) else (if e_s3 then (if V79_garde_s3 then ((((pre V30_invalid_s) + (pre V32_dirty_s)) + (pre V31_valid_s)) - 1) else (pre V30_invalid_s)) else (pre V30_invalid_s))) <=(((pre V30_invalid_s) + (pre V32_dirty_s)) + (pre V31_valid_s))) 
and (V30_invalid_s <=(V30_invalid_s + V31_valid_s)) 
and ((V30_invalid_s + V31_valid_s) <=((V30_invalid_s + V31_valid_s) + V32_dirty_s)) 
and ((if e_s1 then (if V77_garde_s1 then ((((pre V30_invalid_s) + 1) + (pre V32_dirty_s)) - 1) else (pre V30_invalid_s)) else (if e_s2 then (if V78_garde_s2 then (((((pre V30_invalid_s) - 1) + (pre V32_dirty_s)) + (pre V31_valid_s)) - 1) else (pre V30_invalid_s)) else (if e_s3 then (if V79_garde_s3 then ((((pre V30_invalid_s) + (pre V32_dirty_s)) + (pre V31_valid_s)) - 1) else (pre V30_invalid_s)) else (pre V30_invalid_s)))) <=(((pre V30_invalid_s) + (pre V32_dirty_s)) + (pre V31_valid_s))) 
...
and ((if e_s2 then (if V78_garde_s2 then 1 else (pre V32_dirty_s)) else (if e_s3 then (if V79_garde_s3 then 1 else (pre V32_dirty_s)) else (pre V32_dirty_s))) <=(if V79_garde_s3 then 1 else (pre V32_dirty_s))) 
and ((if V79_garde_s3 then 1 else (pre V32_dirty_s)) <=1) 
and (1 <=((pre V31_valid_s) + 1)) 
...
and ((if V79_garde_s3 then 1 else (pre V32_dirty_s)) <=1) 
and (1 <=((pre V31_valid_s) + 1)) 
and ((if V78_garde_s2 then (((((pre V30_invalid_s) - 1) + (pre V32_dirty_s)) + (pre V31_valid_s)) - 1) else (pre V30_invalid_s)) <=(((pre V30_invalid_s) + (pre V32_dirty_s)) + (pre V31_valid_s))) 
and ((pre V30_invalid_s) <=(if V77_garde_s1 then ((((pre V30_invalid_s) + 1) + (pre V32_dirty_s)) - 1) else (pre V30_invalid_s))) 
...
and ((pre V106_First) <=((pre V30_invalid_s) + (pre V32_dirty_s))) 
and (((pre V30_invalid_s) + (pre V32_dirty_s)) <=(((pre V30_invalid_s) + (pre V32_dirty_s)) + (pre V31_valid_s))) 
and (((pre V30_invalid_s) + 1) <=(((pre V30_invalid_s) + 1) + (pre V32_dirty_s))) 
and  true ));
tel.
