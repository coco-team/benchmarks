...
and ((if (V30_move and V32_meter) then (((pre V28_speed) - 1) + 1) else (pre V28_speed)) = (if V31_second then (((pre V29_time) - 1) + 1) else (pre V29_time))) 
and ((if V31_second then (((pre V29_time) - 1) + 1) else (pre V29_time)) = (pre V29_time)) 
and ((pre V29_time) = V29_time) 
and (V29_time = (((pre V28_speed) - 1) + 1)) 
