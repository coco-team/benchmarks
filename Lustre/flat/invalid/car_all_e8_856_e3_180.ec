...
and ((V27_dist >= 0) = (((V27_dist >= 0) and (V27_dist < 11)) and (V28_speed < 4))) 
...
and (((not V30_move) and V31_second) => (V28_speed >= 0)) 
and (((not V30_move) and V31_second) => (not V30_move)) 
and (((pre V30_move) and (not (pre V25_stop))) => (pre V30_move)) 
and (((not V30_move) and V31_second) => (V33_env => ((((V27_dist >= 0) and (V27_dist < 11)) and (V28_speed < 4)) and (V28_speed >= 0)))) 
...
and ((m and (not s)) => m) 
and ((not s) => V92_X) 
and ((m and s) => (V33_env => ((((V27_dist >= 0) and (V27_dist < 11)) and (V28_speed < 4)) and (V28_speed >= 0)))) 
and ((m and s) => s) 
and ((m and s) => m) 
and (V33_env => V92_X) 
...
and ((if (V30_move and V32_meter) then ((pre V28_speed) - 1) else (pre V28_speed)) <=(if ((not V30_move) and V31_second) then 0 else (if (V30_move and V32_meter) then ((pre V28_speed) - 1) else (pre V28_speed)))) 
and ((if ((not V30_move) and V31_second) then 0 else (if (V30_move and V32_meter) then ((pre V28_speed) - 1) else (pre V28_speed))) <=V28_speed) 
and (V28_speed <=0) 
and (0 <=(pre V29_time)) 
