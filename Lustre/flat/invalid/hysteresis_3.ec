...
let
  OK = (true -> (not ((pre V19_late) and V20_early)));
...
-- 48 implications. 
assert (true -> (((not ((pre V19_late) and V20_early)) = true) 
...
and ((V71_diff <= (- 10)) => (if (pre V19_late) then (V71_diff < 0) else (V71_diff <= (- 10)))) 
