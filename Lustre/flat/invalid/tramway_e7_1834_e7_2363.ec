...
let
  ...
  V251_door_opens_before_leaving_station = (not (V253_between_A_and_X or (false 
  -> (V252_X or (not (pre V252_X))))));
...
and (V253_between_A_and_X => (V253_between_A_and_X or (V252_X or (not (pre V252_X))))) 
...
and ((not (V253_between_A_and_X or (V252_X or (not (pre V252_X))))) => ((V274_X or (not (pre V274_X))) => (pre V62_door_ok))) 
and ((not (V253_between_A_and_X or (V252_X or (not (pre V252_X))))) => in_station) 
and ((not (V253_between_A_and_X or (V252_X or (not (pre V252_X))))) => V59_prop_ok) 
...
and (((((V266_door_doesnt_open_if_not_asked and V265_door_doesnt_close_if_not_asked) and V267_tramway_doesnt_start_if_not_door_ok) and V268_door_initially_closed) and V269_initially_not_in_station) => V267_tramway_doesnt_start_if_not_door_ok) 
...
and (((V273_X or (not (pre V273_X))) => V61_close_door) => (door_is_open or (not (pre door_is_open)))) 
...
and (V264_env_ok => V267_tramway_doesnt_start_if_not_door_ok) 
...
and (((((V266_door_doesnt_open_if_not_asked and V265_door_doesnt_close_if_not_asked) and V267_tramway_doesnt_start_if_not_door_ok) and V268_door_initially_closed) and V269_initially_not_in_station) => V250_door_doesnt_open_out_of_station) 
and (((((V266_door_doesnt_open_if_not_asked and V265_door_doesnt_close_if_not_asked) and V267_tramway_doesnt_start_if_not_door_ok) and V268_door_initially_closed) and V269_initially_not_in_station) => V265_door_doesnt_close_if_not_asked) 
...
and (((((V266_door_doesnt_open_if_not_asked and V265_door_doesnt_close_if_not_asked) and V267_tramway_doesnt_start_if_not_door_ok) and V268_door_initially_closed) and V269_initially_not_in_station) => V266_door_doesnt_open_if_not_asked) 
and ((((V266_door_doesnt_open_if_not_asked and V265_door_doesnt_close_if_not_asked) and V267_tramway_doesnt_start_if_not_door_ok) and V268_door_initially_closed) => V266_door_doesnt_open_if_not_asked) 
...
and ((V275_X or (not (pre V275_X))) => (V253_between_A_and_X or (V252_X or (not (pre V252_X))))) 
...
and (V59_prop_ok => V267_tramway_doesnt_start_if_not_door_ok) 
and (V251_door_opens_before_leaving_station => V267_tramway_doesnt_start_if_not_door_ok) 
...
and (V58_env_always_ok => (V253_between_A_and_X or (V252_X or (not (pre V252_X))))) 
and (V58_env_always_ok => (not V60_open_door)) 
and ((pre V58_env_always_ok) => (warning_start or (not (pre warning_start)))) 
...
and ((not (V253_between_A_and_X or (V252_X or (not (pre V252_X))))) => (pre V275_X)) 
and ((not door_is_open) => V268_door_initially_closed) 
and ((not door_is_open) => (V273_X or (not (pre V273_X)))) 
and ((((((V266_door_doesnt_open_if_not_asked and V265_door_doesnt_close_if_not_asked) and V267_tramway_doesnt_start_if_not_door_ok) and V268_door_initially_closed) and V269_initially_not_in_station) and V270_warning_start_and_in_station_go_down_simultaneously) => (V253_between_A_and_X or (V252_X or (not (pre V252_X))))) 
and ((((((V266_door_doesnt_open_if_not_asked and V265_door_doesnt_close_if_not_asked) and V267_tramway_doesnt_start_if_not_door_ok) and V268_door_initially_closed) and V269_initially_not_in_station) and V270_warning_start_and_in_station_go_down_simultaneously) => V266_door_doesnt_open_if_not_asked) 
