...
let
  ...
  V95_X = ((not (((e_s1 or e_s2) or (e_s1 and e_s3)) or (e_s2 and e_s3))) and (
  init_invalid_s >= 0));
...
-- 133 implications. 
assert (true -> (((V35_R2 and V34_R1) = (V37_env => (V32_dirty_s < 2))) 
and ((V37_env => (V32_dirty_s < 2)) = (V37_env => (((V30_invalid_s + V31_valid_s) + V32_dirty_s) = V108_First))) 
and ((V37_env => (((V30_invalid_s + V31_valid_s) + V32_dirty_s) = V108_First)) = true) 
and (true = (((V30_invalid_s + V31_valid_s) + V32_dirty_s) = V108_First)) 
and ((((V30_invalid_s + V31_valid_s) + V32_dirty_s) = V108_First) = ((V35_R2 and V34_R1) and V36_R3)) 
and (((V35_R2 and V34_R1) and V36_R3) = V35_R2) 
and (V35_R2 = V34_R1) 
and (V34_R1 = V36_R3) 
and (V36_R3 = (V32_dirty_s < 2)) 
and (((pre V30_invalid_s) >= 1) = V81_garde_s1) 
and (V81_garde_s1 = V83_garde_s3) 
and ((e_s1 or e_s2) = ((e_s1 or e_s2) or (e_s1 and e_s3))) 
and (((e_s1 or e_s2) or (e_s1 and e_s3)) = (((e_s1 or e_s2) or (e_s1 and e_s3)) or (e_s2 and e_s3))) 
and (V95_X = ((not (((e_s1 or e_s2) or (e_s1 and e_s3)) or (e_s2 and e_s3))) and (init_invalid_s >= 0))) 
...
and (V37_env => (V95_X or (pre V37_env))) 
and ((e_s2 and e_s3) => e_s2) 
and ((pre V37_env) => (V95_X or (pre V37_env))) 
...
and (e_s2 => (V37_env => (((V30_invalid_s + V31_valid_s) + V32_dirty_s) = (((pre V30_invalid_s) + (pre V31_valid_s)) + (pre V32_dirty_s))))) 
and (e_s2 => (e_s1 or e_s2)) 
and ((e_s1 or e_s2) => (V37_env => (((V30_invalid_s + V31_valid_s) + V32_dirty_s) = (((pre V30_invalid_s) + (pre V31_valid_s)) + (pre V32_dirty_s))))) 
and (V95_X => (not (((e_s1 or e_s2) or (e_s1 and e_s3)) or (e_s2 and e_s3)))) 
and (V95_X => V37_env) 
...
and (e_s1 => (V37_env => (((V30_invalid_s + V31_valid_s) + V32_dirty_s) = (((pre V30_invalid_s) + (pre V31_valid_s)) + (pre V32_dirty_s))))) 
and (e_s1 => (e_s1 or e_s2)) 
...
and ((((pre V30_invalid_s) + (pre V31_valid_s)) + (pre V32_dirty_s)) = (pre V33_mem_init_s)) 
