...
-- 269 implications. 
assert (true -> ((true = (V36_env => (((((if (V32_modified_me < 0) then (- V32_modified_me) else V32_modified_me) + (if (V33_exclusive_me < 0) then (- V33_exclusive_me) else V33_exclusive_me)) + (if (V34_shared_me < 0) then (- V34_shared_me) else V34_shared_me)) + (if (V35_invalid_me < 0) then (- V35_invalid_me) else V35_invalid_me)) <= 3))) 
and ((V36_env => (((((if (V32_modified_me < 0) then (- V32_modified_me) else V32_modified_me) + (if (V33_exclusive_me < 0) then (- V33_exclusive_me) else V33_exclusive_me)) + (if (V34_shared_me < 0) then (- V34_shared_me) else V34_shared_me)) + (if (V35_invalid_me < 0) then (- V35_invalid_me) else V35_invalid_me)) <= 3)) = (((((if (V32_modified_me < 0) then (- V32_modified_me) else V32_modified_me) + (if (V33_exclusive_me < 0) then (- V33_exclusive_me) else V33_exclusive_me)) + (if (V34_shared_me < 0) then (- V34_shared_me) else V34_shared_me)) + (if (V35_invalid_me < 0) then (- V35_invalid_me) else V35_invalid_me)) <= 3)) 
and (V88_garde_me4 = ((pre V35_invalid_me) >= 1)) 
...
and (((pre V34_shared_me) >= 1) = V87_garde_me3) 
and (false = (V33_exclusive_me < 0)) 
...
and ((etat_me1 and etat_me3) => ((((etat_me1 and etat_me2) or (etat_me1 and etat_me3)) or (etat_me1 and etat_me4)) or (etat_me2 and etat_me3))) 
...
and ((etat_me1 and etat_me2) => (((etat_me1 and etat_me2) or (etat_me1 and etat_me3)) or (etat_me1 and etat_me4))) 
...
and ((pre V34_shared_me) = (if V86_garde_me2 then (pre V34_shared_me) else (pre V34_shared_me))) 
...
and (((pre V32_modified_me) - 1) <=(- V34_shared_me)) 
...
and (((pre V32_modified_me) - 1) <=(if V85_garde_me1 then ((pre V35_invalid_me) - 1) else (pre V35_invalid_me))) 
and (((pre V32_modified_me) - 1) <=(if V88_garde_me4 then (((((pre V35_invalid_me) + (pre V32_modified_me)) + (pre V33_exclusive_me)) + (pre V34_shared_me)) - 1) else (pre V35_invalid_me))) 
and (((pre V32_modified_me) - 1) <=(if etat_me4 then (if V88_garde_me4 then (((((pre V35_invalid_me) + (pre V32_modified_me)) + (pre V33_exclusive_me)) + (pre V34_shared_me)) - 1) else (pre V35_invalid_me)) else (pre V35_invalid_me))) 
and (((pre V32_modified_me) - 1) <=(if etat_me3 then (if V87_garde_me3 then (((((pre V35_invalid_me) + (pre V32_modified_me)) + (pre V33_exclusive_me)) + (pre V34_shared_me)) - 1) else (pre V35_invalid_me)) else (if etat_me4 then (if V88_garde_me4 then (((((pre V35_invalid_me) + (pre V32_modified_me)) + (pre V33_exclusive_me)) + (pre V34_shared_me)) - 1) else (pre V35_invalid_me)) else (pre V35_invalid_me)))) 
and (((pre V32_modified_me) - 1) <=(if etat_me1 then (if V85_garde_me1 then ((pre V35_invalid_me) - 1) else (pre V35_invalid_me)) else (if etat_me2 then (if V86_garde_me2 then (pre V35_invalid_me) else (pre V35_invalid_me)) else (if etat_me3 then (if V87_garde_me3 then (((((pre V35_invalid_me) + (pre V32_modified_me)) + (pre V33_exclusive_me)) + (pre V34_shared_me)) - 1) else (pre V35_invalid_me)) else (if etat_me4 then (if V88_garde_me4 then (((((pre V35_invalid_me) + (pre V32_modified_me)) + (pre V33_exclusive_me)) + (pre V34_shared_me)) - 1) else (pre V35_invalid_me)) else (pre V35_invalid_me)))))) 
and (((pre V32_modified_me) - 1) <=V35_invalid_me) 
and (((pre V32_modified_me) - 1) <=(if etat_me2 then (if V86_garde_me2 then (pre V35_invalid_me) else (pre V35_invalid_me)) else (if etat_me3 then (if V87_garde_me3 then (((((pre V35_invalid_me) + (pre V32_modified_me)) + (pre V33_exclusive_me)) + (pre V34_shared_me)) - 1) else (pre V35_invalid_me)) else (if etat_me4 then (if V88_garde_me4 then (((((pre V35_invalid_me) + (pre V32_modified_me)) + (pre V33_exclusive_me)) + (pre V34_shared_me)) - 1) else (pre V35_invalid_me)) else (pre V35_invalid_me))))) 
and (((pre V32_modified_me) - 1) <=((pre V35_invalid_me) + (pre V32_modified_me))) 
and (((pre V32_modified_me) - 1) <=(pre V35_invalid_me)) 
and (((pre V32_modified_me) - 1) <=(((pre V35_invalid_me) + (pre V32_modified_me)) + (pre V33_exclusive_me))) 
and (((pre V32_modified_me) - 1) <=((((pre V35_invalid_me) + (pre V32_modified_me)) + (pre V33_exclusive_me)) + (pre V34_shared_me))) 
...
and (((pre V34_shared_me) - 1) <=(if V85_garde_me1 then ((pre V35_invalid_me) - 1) else (pre V35_invalid_me))) 
and (((pre V34_shared_me) - 1) <=(if V88_garde_me4 then (((((pre V35_invalid_me) + (pre V32_modified_me)) + (pre V33_exclusive_me)) + (pre V34_shared_me)) - 1) else (pre V35_invalid_me))) 
and (((pre V34_shared_me) - 1) <=(if etat_me4 then (if V88_garde_me4 then (((((pre V35_invalid_me) + (pre V32_modified_me)) + (pre V33_exclusive_me)) + (pre V34_shared_me)) - 1) else (pre V35_invalid_me)) else (pre V35_invalid_me))) 
and (((pre V34_shared_me) - 1) <=(if etat_me3 then (if V87_garde_me3 then (((((pre V35_invalid_me) + (pre V32_modified_me)) + (pre V33_exclusive_me)) + (pre V34_shared_me)) - 1) else (pre V35_invalid_me)) else (if etat_me4 then (if V88_garde_me4 then (((((pre V35_invalid_me) + (pre V32_modified_me)) + (pre V33_exclusive_me)) + (pre V34_shared_me)) - 1) else (pre V35_invalid_me)) else (pre V35_invalid_me)))) 
and (((pre V34_shared_me) - 1) <=(if etat_me1 then (if V85_garde_me1 then ((pre V35_invalid_me) - 1) else (pre V35_invalid_me)) else (if etat_me2 then (if V86_garde_me2 then (pre V35_invalid_me) else (pre V35_invalid_me)) else (if etat_me3 then (if V87_garde_me3 then (((((pre V35_invalid_me) + (pre V32_modified_me)) + (pre V33_exclusive_me)) + (pre V34_shared_me)) - 1) else (pre V35_invalid_me)) else (if etat_me4 then (if V88_garde_me4 then (((((pre V35_invalid_me) + (pre V32_modified_me)) + (pre V33_exclusive_me)) + (pre V34_shared_me)) - 1) else (pre V35_invalid_me)) else (pre V35_invalid_me)))))) 
and (((pre V34_shared_me) - 1) <=V35_invalid_me) 
and (((pre V34_shared_me) - 1) <=(if etat_me2 then (if V86_garde_me2 then (pre V35_invalid_me) else (pre V35_invalid_me)) else (if etat_me3 then (if V87_garde_me3 then (((((pre V35_invalid_me) + (pre V32_modified_me)) + (pre V33_exclusive_me)) + (pre V34_shared_me)) - 1) else (pre V35_invalid_me)) else (if etat_me4 then (if V88_garde_me4 then (((((pre V35_invalid_me) + (pre V32_modified_me)) + (pre V33_exclusive_me)) + (pre V34_shared_me)) - 1) else (pre V35_invalid_me)) else (pre V35_invalid_me))))) 
and (((pre V34_shared_me) - 1) <=(pre V35_invalid_me)) 
and (((pre V33_exclusive_me) - 1) <=(if V87_garde_me3 then 0 else (pre V34_shared_me))) 
and (((pre V33_exclusive_me) - 1) <=(if V88_garde_me4 then 0 else (pre V34_shared_me))) 
and (((pre V33_exclusive_me) - 1) <=(if etat_me3 then (if V87_garde_me3 then 0 else (pre V34_shared_me)) else (if etat_me4 then (if V88_garde_me4 then 0 else (pre V34_shared_me)) else (pre V34_shared_me)))) 
and (((pre V33_exclusive_me) - 1) <=(if etat_me2 then (if V86_garde_me2 then (pre V34_shared_me) else (pre V34_shared_me)) else (if etat_me3 then (if V87_garde_me3 then 0 else (pre V34_shared_me)) else (if etat_me4 then (if V88_garde_me4 then 0 else (pre V34_shared_me)) else (pre V34_shared_me))))) 
and (((pre V33_exclusive_me) - 1) <=(if etat_me4 then (if V88_garde_me4 then 0 else (pre V34_shared_me)) else (pre V34_shared_me))) 
and (((pre V33_exclusive_me) - 1) <=(pre V34_shared_me)) 
and (((pre V33_exclusive_me) - 1) <=(if etat_me1 then (if V85_garde_me1 then (((((pre V34_shared_me) - 1) + (pre V33_exclusive_me)) + (pre V32_modified_me)) + 1) else (pre V34_shared_me)) else (if etat_me2 then (if V86_garde_me2 then (pre V34_shared_me) else (pre V34_shared_me)) else (if etat_me3 then (if V87_garde_me3 then 0 else (pre V34_shared_me)) else (if etat_me4 then (if V88_garde_me4 then 0 else (pre V34_shared_me)) else (pre V34_shared_me)))))) 
and (((pre V33_exclusive_me) - 1) <=V34_shared_me) 
and (((pre V33_exclusive_me) - 1) <=(if V85_garde_me1 then (((((pre V34_shared_me) - 1) + (pre V33_exclusive_me)) + (pre V32_modified_me)) + 1) else (pre V34_shared_me))) 
and (((pre V33_exclusive_me) - 1) <=(((((pre V34_shared_me) - 1) + (pre V33_exclusive_me)) + (pre V32_modified_me)) + 1)) 
and (((((pre V34_shared_me) - 1) + (pre V33_exclusive_me)) + (pre V32_modified_me)) <=(((pre V35_invalid_me) + (pre V32_modified_me)) + (pre V33_exclusive_me))) 
and (((((pre V34_shared_me) - 1) + (pre V33_exclusive_me)) + (pre V32_modified_me)) <=((((pre V35_invalid_me) + (pre V32_modified_me)) + (pre V33_exclusive_me)) + (pre V34_shared_me))) 
and ((((pre V34_shared_me) - 1) + (pre V33_exclusive_me)) <=(if V87_garde_me3 then 0 else (pre V34_shared_me))) 
...
and ((((pre V34_shared_me) - 1) + (pre V33_exclusive_me)) <=(if etat_me1 then (if V85_garde_me1 then (((((pre V34_shared_me) - 1) + (pre V33_exclusive_me)) + (pre V32_modified_me)) + 1) else (pre V34_shared_me)) else (if etat_me2 then (if V86_garde_me2 then (pre V34_shared_me) else (pre V34_shared_me)) else (if etat_me3 then (if V87_garde_me3 then 0 else (pre V34_shared_me)) else (if etat_me4 then (if V88_garde_me4 then 0 else (pre V34_shared_me)) else (pre V34_shared_me)))))) 
and ((((pre V34_shared_me) - 1) + (pre V33_exclusive_me)) <=V34_shared_me) 
and ((((pre V34_shared_me) - 1) + (pre V33_exclusive_me)) <=(if V85_garde_me1 then (((((pre V34_shared_me) - 1) + (pre V33_exclusive_me)) + (pre V32_modified_me)) + 1) else (pre V34_shared_me))) 
and ((((pre V34_shared_me) - 1) + (pre V33_exclusive_me)) <=(((((pre V34_shared_me) - 1) + (pre V33_exclusive_me)) + (pre V32_modified_me)) + 1)) 
and ((if V86_garde_me2 then ((pre V32_modified_me) - 1) else (pre V32_modified_me)) <=(pre V32_modified_me)) 
and ((if V86_garde_me2 then ((pre V32_modified_me) - 1) else (pre V32_modified_me)) <=(if V85_garde_me1 then ((pre V35_invalid_me) - 1) else (pre V35_invalid_me))) 
and ((if V86_garde_me2 then ((pre V32_modified_me) - 1) else (pre V32_modified_me)) <=(pre V35_invalid_me)) 
...
and ((if V87_garde_me3 then 0 else (pre V34_shared_me)) <=(if V88_garde_me4 then 0 else (pre V34_shared_me))) 
and ((if V87_garde_me3 then 0 else (pre V34_shared_me)) <=(if etat_me3 then (if V87_garde_me3 then 0 else (pre V34_shared_me)) else (if etat_me4 then (if V88_garde_me4 then 0 else (pre V34_shared_me)) else (pre V34_shared_me)))) 
and ((if V87_garde_me3 then 0 else (pre V34_shared_me)) <=(if etat_me2 then (if V86_garde_me2 then (pre V34_shared_me) else (pre V34_shared_me)) else (if etat_me3 then (if V87_garde_me3 then 0 else (pre V34_shared_me)) else (if etat_me4 then (if V88_garde_me4 then 0 else (pre V34_shared_me)) else (pre V34_shared_me))))) 
and ((if V87_garde_me3 then 0 else (pre V34_shared_me)) <=(if etat_me4 then (if V88_garde_me4 then 0 else (pre V34_shared_me)) else (pre V34_shared_me))) 
and ((if V87_garde_me3 then 0 else (pre V34_shared_me)) <=(pre V34_shared_me)) 
...
and (V34_shared_me <=(if V87_garde_me3 then 1 else (pre V33_exclusive_me))) 
and ((pre V33_exclusive_me) <=(if etat_me3 then (if V87_garde_me3 then 1 else (pre V33_exclusive_me)) else (if etat_me4 then (if V88_garde_me4 then 1 else (pre V33_exclusive_me)) else (pre V33_exclusive_me)))) 
and ((pre V33_exclusive_me) <=(if etat_me4 then (if V88_garde_me4 then 1 else (pre V33_exclusive_me)) else (pre V33_exclusive_me))) 
and ((pre V33_exclusive_me) <=(if V88_garde_me4 then 1 else (pre V33_exclusive_me))) 
and ((if V87_garde_me3 then 1 else (pre V33_exclusive_me)) <=((((if (V32_modified_me < 0) then (- V32_modified_me) else V32_modified_me) + (if (V33_exclusive_me < 0) then (- V33_exclusive_me) else V33_exclusive_me)) + (if (V34_shared_me < 0) then (- V34_shared_me) else V34_shared_me)) + (if (V35_invalid_me < 0) then (- V35_invalid_me) else V35_invalid_me))) 
...
and (((pre V35_invalid_me) - 1) <=((((pre V35_invalid_me) + (pre V32_modified_me)) + (pre V33_exclusive_me)) + (pre V34_shared_me))) 
...
and ((if V88_garde_me4 then (((((pre V35_invalid_me) + (pre V32_modified_me)) + (pre V33_exclusive_me)) + (pre V34_shared_me)) - 1) else (pre V35_invalid_me)) <=((((if (V32_modified_me < 0) then (- V32_modified_me) else V32_modified_me) + (if (V33_exclusive_me < 0) then (- V33_exclusive_me) else V33_exclusive_me)) + (if (V34_shared_me < 0) then (- V34_shared_me) else V34_shared_me)) + (if (V35_invalid_me < 0) then (- V35_invalid_me) else V35_invalid_me))) 
...
and ((- V35_invalid_me) <=((if (V32_modified_me < 0) then (- V32_modified_me) else V32_modified_me) + (if (V33_exclusive_me < 0) then (- V33_exclusive_me) else V33_exclusive_me))) 
and (((if (V32_modified_me < 0) then (- V32_modified_me) else V32_modified_me) + (if (V33_exclusive_me < 0) then (- V33_exclusive_me) else V33_exclusive_me)) <=(((if (V32_modified_me < 0) then (- V32_modified_me) else V32_modified_me) + (if (V33_exclusive_me < 0) then (- V33_exclusive_me) else V33_exclusive_me)) + (if (V34_shared_me < 0) then (- V34_shared_me) else V34_shared_me))) 
and ((((if (V32_modified_me < 0) then (- V32_modified_me) else V32_modified_me) + (if (V33_exclusive_me < 0) then (- V33_exclusive_me) else V33_exclusive_me)) + (if (V34_shared_me < 0) then (- V34_shared_me) else V34_shared_me)) <=1) 
and (1 <=3) 
...
and ((if V85_garde_me1 then 0 else (pre V33_exclusive_me)) <=(pre V33_exclusive_me)) 
and ((pre V33_exclusive_me) <=(if V87_garde_me3 then 1 else (pre V33_exclusive_me))) 
and ((if V87_garde_me3 then 1 else (pre V33_exclusive_me)) <=1) 
and (1 <=3) 
and (((pre V34_shared_me) - 1) <=(((pre V34_shared_me) - 1) + (pre V33_exclusive_me))) 
and ((((pre V34_shared_me) - 1) + (pre V33_exclusive_me)) <=(pre V32_modified_me)) 
and ((pre V32_modified_me) <=(if etat_me3 then (if V87_garde_me3 then 0 else (pre V32_modified_me)) else (if etat_me4 then (if V88_garde_me4 then 0 else (pre V32_modified_me)) else (pre V32_modified_me)))) 
and ((if etat_me3 then (if V87_garde_me3 then 0 else (pre V32_modified_me)) else (if etat_me4 then (if V88_garde_me4 then 0 else (pre V32_modified_me)) else (pre V32_modified_me))) <=(if etat_me4 then (if V88_garde_me4 then 0 else (pre V32_modified_me)) else (pre V32_modified_me))) 
and ((if etat_me4 then (if V88_garde_me4 then 0 else (pre V32_modified_me)) else (pre V32_modified_me)) <=(if V88_garde_me4 then 0 else (pre V32_modified_me))) 
and ((if V88_garde_me4 then 0 else (pre V32_modified_me)) <=(if V86_garde_me2 then ((pre V33_exclusive_me) - 1) else (pre V33_exclusive_me))) 
...
and ((if V87_garde_me3 then 1 else (pre V33_exclusive_me)) <=1) 
and (1 <=3) 
and ((- V34_shared_me) <=(if (V34_shared_me < 0) then (- V34_shared_me) else V34_shared_me)) 
...
and ((((if (V32_modified_me < 0) then (- V32_modified_me) else V32_modified_me) + (if (V33_exclusive_me < 0) then (- V33_exclusive_me) else V33_exclusive_me)) + (if (V34_shared_me < 0) then (- V34_shared_me) else V34_shared_me)) <=1) 
and (1 <=3) 
and ((if V87_garde_me3 then 0 else (pre V34_shared_me)) <=(if V86_garde_me2 then ((pre V33_exclusive_me) - 1) else (pre V33_exclusive_me))) 
and ((if V86_garde_me2 then ((pre V33_exclusive_me) - 1) else (pre V33_exclusive_me)) <=(if V85_garde_me1 then 0 else (pre V33_exclusive_me))) 
and ((if V85_garde_me1 then 0 else (pre V33_exclusive_me)) <=(pre V33_exclusive_me)) 
and ((pre V33_exclusive_me) <=(if V87_garde_me3 then 1 else (pre V33_exclusive_me))) 
and ((if V87_garde_me3 then 1 else (pre V33_exclusive_me)) <=1) 
and (1 <=3) 
and ((if V88_garde_me4 then 0 else (pre V34_shared_me)) <=(if V87_garde_me3 then 1 else (pre V33_exclusive_me))) 
and ((if V87_garde_me3 then 1 else (pre V33_exclusive_me)) <=1) 
and (1 <=3) 
...
and ((if etat_me4 then (if V88_garde_me4 then 0 else (pre V34_shared_me)) else (pre V34_shared_me)) <=(if V87_garde_me3 then 1 else (pre V33_exclusive_me))) 
and ((if V87_garde_me3 then 1 else (pre V33_exclusive_me)) <=1) 
and (1 <=3) 
and ((if etat_me2 then (if V86_garde_me2 then (pre V34_shared_me) else (pre V34_shared_me)) else (if etat_me3 then (if V87_garde_me3 then 0 else (pre V34_shared_me)) else (if etat_me4 then (if V88_garde_me4 then 0 else (pre V34_shared_me)) else (pre V34_shared_me)))) <=(if V87_garde_me3 then 1 else (pre V33_exclusive_me))) 
and ((if V87_garde_me3 then 1 else (pre V33_exclusive_me)) <=1) 
and (1 <=3) 
and ((pre V34_shared_me) <=(if V87_garde_me3 then 1 else (pre V33_exclusive_me))) 
and ((if V87_garde_me3 then 1 else (pre V33_exclusive_me)) <=1) 
and (1 <=3) 
...
and ((((if (V32_modified_me < 0) then (- V32_modified_me) else V32_modified_me) + (if (V33_exclusive_me < 0) then (- V33_exclusive_me) else V33_exclusive_me)) + (if (V34_shared_me < 0) then (- V34_shared_me) else V34_shared_me)) <=1) 
and (1 <=3) 
and ((if etat_me1 then (if V85_garde_me1 then (((((pre V34_shared_me) - 1) + (pre V33_exclusive_me)) + (pre V32_modified_me)) + 1) else (pre V34_shared_me)) else (if etat_me2 then (if V86_garde_me2 then (pre V34_shared_me) else (pre V34_shared_me)) else (if etat_me3 then (if V87_garde_me3 then 0 else (pre V34_shared_me)) else (if etat_me4 then (if V88_garde_me4 then 0 else (pre V34_shared_me)) else (pre V34_shared_me))))) <=(if V87_garde_me3 then 1 else (pre V33_exclusive_me))) 
and ((if V87_garde_me3 then 1 else (pre V33_exclusive_me)) <=1) 
and (1 <=3) 
and (V34_shared_me <=(if (V34_shared_me < 0) then (- V34_shared_me) else V34_shared_me)) 
and ((if (V34_shared_me < 0) then (- V34_shared_me) else V34_shared_me) <=(((if (V32_modified_me < 0) then (- V32_modified_me) else V32_modified_me) + (if (V33_exclusive_me < 0) then (- V33_exclusive_me) else V33_exclusive_me)) + (if (V34_shared_me < 0) then (- V34_shared_me) else V34_shared_me))) 
and ((((if (V32_modified_me < 0) then (- V32_modified_me) else V32_modified_me) + (if (V33_exclusive_me < 0) then (- V33_exclusive_me) else V33_exclusive_me)) + (if (V34_shared_me < 0) then (- V34_shared_me) else V34_shared_me)) <=1) 
and (1 <=3) 
and ((if V85_garde_me1 then (((((pre V34_shared_me) - 1) + (pre V33_exclusive_me)) + (pre V32_modified_me)) + 1) else (pre V34_shared_me)) <=(if V87_garde_me3 then 1 else (pre V33_exclusive_me))) 
and ((if V87_garde_me3 then 1 else (pre V33_exclusive_me)) <=1) 
and (1 <=3) 
and ((((((pre V34_shared_me) - 1) + (pre V33_exclusive_me)) + (pre V32_modified_me)) + 1) <=(if V87_garde_me3 then 1 else (pre V33_exclusive_me))) 
and ((if V87_garde_me3 then 1 else (pre V33_exclusive_me)) <=1) 
and (1 <=3) 
...
and ((if etat_me3 then (if V87_garde_me3 then 1 else (pre V33_exclusive_me)) else (if etat_me4 then (if V88_garde_me4 then 1 else (pre V33_exclusive_me)) else (pre V33_exclusive_me))) <=1) 
and (1 <=3) 
and ((if etat_me2 then (if V86_garde_me2 then ((pre V33_exclusive_me) - 1) else (pre V33_exclusive_me)) else (if etat_me3 then (if V87_garde_me3 then 1 else (pre V33_exclusive_me)) else (if etat_me4 then (if V88_garde_me4 then 1 else (pre V33_exclusive_me)) else (pre V33_exclusive_me)))) <=(if etat_me3 then (if V87_garde_me3 then 1 else (pre V33_exclusive_me)) else (if etat_me4 then (if V88_garde_me4 then 1 else (pre V33_exclusive_me)) else (pre V33_exclusive_me)))) 
and ((if etat_me3 then (if V87_garde_me3 then 1 else (pre V33_exclusive_me)) else (if etat_me4 then (if V88_garde_me4 then 1 else (pre V33_exclusive_me)) else (pre V33_exclusive_me))) <=1) 
and (1 <=3) 
...
and ((if V85_garde_me1 then ((pre V35_invalid_me) - 1) else (pre V35_invalid_me)) <=((((if (V32_modified_me < 0) then (- V32_modified_me) else V32_modified_me) + (if (V33_exclusive_me < 0) then (- V33_exclusive_me) else V33_exclusive_me)) + (if (V34_shared_me < 0) then (- V34_shared_me) else V34_shared_me)) + (if (V35_invalid_me < 0) then (- V35_invalid_me) else V35_invalid_me))) 
and (((((if (V32_modified_me < 0) then (- V32_modified_me) else V32_modified_me) + (if (V33_exclusive_me < 0) then (- V33_exclusive_me) else V33_exclusive_me)) + (if (V34_shared_me < 0) then (- V34_shared_me) else V34_shared_me)) + (if (V35_invalid_me < 0) then (- V35_invalid_me) else V35_invalid_me)) <=3) 
...
and (((((pre V35_invalid_me) + (pre V32_modified_me)) + (pre V33_exclusive_me)) + (pre V34_shared_me)) <=3) 
and  true ));
tel.
