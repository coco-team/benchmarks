...
and ((pre V28_speed) = (pre V29_time)) 
and ((pre V29_time) = (if ((not V30_move) or V31_second) then 0 else (if (V30_move and V32_meter) then (((pre V28_speed) - 1) + 1) else (pre V28_speed)))) 
...
and ((((pre V29_time) - 1) + 1) = (if V31_second then (((pre V29_time) - 1) + 1) else (pre V29_time))) 
and ((if V31_second then (((pre V29_time) - 1) + 1) else (pre V29_time)) = (((pre V28_speed) - 1) + 1)) 
...
and (1 <=4) 
and (1 <=10) 
and (((pre V29_time) - 1) <=(pre V28_speed)) 
