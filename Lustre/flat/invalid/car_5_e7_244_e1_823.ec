...
-- 108 implications. 
assert (true -> ((((V27_dist > 9) => (not (V30_move and V32_meter))) = (V33_env => ((V27_dist > 9) => (not (V30_move and V32_meter))))) 
...
and ((pre V24_toofast) => ((V27_dist > 9) => (not (V30_move and V32_meter)))) 
and ((pre V24_toofast) => (not (pre V25_stop))) 
and ((pre V24_toofast) => (V91_X or (pre V33_env))) 
