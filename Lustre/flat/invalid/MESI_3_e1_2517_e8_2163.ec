...
and (V102_X = (not (((((((etat_me1 and etat_me2) and etat_me1) and etat_me3) or (etat_me1 and etat_me4)) or (etat_me2 and etat_me3)) or (etat_me2 and etat_me4)) or (etat_me3 and etat_me4)))) 
...
and ((((etat_me1 and etat_me2) and etat_me1) and etat_me3) => etat_me3) 
...
and (V34_shared_me <=((pre V34_shared_me) + 1)) 
and (V34_shared_me <=((((pre V34_shared_me) + 1) + (pre V33_exclusive_me)) + (pre V32_modified_me))) 
and (V34_shared_me <=(((pre V34_shared_me) + 1) + (pre V33_exclusive_me))) 
and ((- V32_modified_me) <=((pre V34_shared_me) + 1)) 
and ((- V32_modified_me) <=(((pre V34_shared_me) + 1) + (pre V33_exclusive_me))) 
...
and ((if V87_garde_me3 then 1 else (pre V33_exclusive_me)) <=((pre V34_shared_me) + 1)) 
and ((if V87_garde_me3 then 1 else (pre V33_exclusive_me)) <=((((pre V34_shared_me) + 1) + (pre V33_exclusive_me)) + (pre V32_modified_me))) 
and ((if V87_garde_me3 then 1 else (pre V33_exclusive_me)) <=(((pre V34_shared_me) + 1) + (pre V33_exclusive_me))) 
...
and ((((pre V34_shared_me) + 1) + (pre V33_exclusive_me)) <=3) 
