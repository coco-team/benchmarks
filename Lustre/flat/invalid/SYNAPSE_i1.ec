...
let
  OK = ((V31_env => (V29_dirty_s < 1)) or (V27_invalid_s < 2));
...
-- 105 implications. 
assert (true -> ((V70_garde_s1 = ((pre V27_invalid_s) >= 1)) 
and (((pre V27_invalid_s) >= 1) = V72_garde_s3) 
...
and ((e_s2 and e_s3) => ((V31_env => (V29_dirty_s < 1)) or (V27_invalid_s < 2))) 
and ((e_s2 and e_s3) => e_s2) 
and (((e_s1 and e_s2) or (e_s1 and e_s3)) => (V31_env => (V29_dirty_s < 1))) 
and (((e_s1 and e_s2) or (e_s1 and e_s3)) => (((e_s1 and e_s2) or (e_s1 and e_s3)) or (e_s2 and e_s3))) 
and ((e_s1 and e_s2) => (V31_env => (V29_dirty_s < 1))) 
and ((e_s1 and e_s2) => (((e_s1 and e_s2) or (e_s1 and e_s3)) or (e_s2 and e_s3))) 
and ((e_s1 and e_s2) => ((V31_env => (V29_dirty_s < 1)) or (V27_invalid_s < 2))) 
and ((e_s1 and e_s2) => e_s2) 
and (V85_X => (init_invalid_s >= 0)) 
and (e_s1 => ((V31_env => (V29_dirty_s < 1)) or (V27_invalid_s < 2))) 
and (((e_s1 and e_s2) or (e_s1 and e_s3)) => e_s1) 
and ((((e_s1 and e_s2) or (e_s1 and e_s3)) or (e_s2 and e_s3)) => (V31_env => (V29_dirty_s < 1))) 
and (V31_env => V85_X) 
and ((V31_env => (V29_dirty_s < 1)) => ((V31_env => (V29_dirty_s < 1)) or (V27_invalid_s < 2))) 
and ((V29_dirty_s < 1) => (V31_env => (V29_dirty_s < 1))) 
and ((V29_dirty_s < 1) => ((V31_env => (V29_dirty_s < 1)) or (V27_invalid_s < 2))) 
...
and ((V27_invalid_s < 2) => ((V31_env => (V29_dirty_s < 1)) or (V27_invalid_s < 2))) 
and ((if V71_garde_s2 then 0 else (pre V28_valid_s)) = 0) 
and ((((pre V27_invalid_s) + (pre V29_dirty_s)) + (pre V28_valid_s)) = (pre V30_mem_init_s)) 
and ((if V71_garde_s2 then 0 else (pre V28_valid_s)) <=(if V72_garde_s3 then 0 else (pre V28_valid_s))) 
and ((if V71_garde_s2 then 0 else (pre V28_valid_s)) <=(if V70_garde_s1 then 0 else (pre V29_dirty_s))) 
and ((if V71_garde_s2 then 0 else (pre V28_valid_s)) <=(pre V29_dirty_s)) 
and ((if V71_garde_s2 then 0 else (pre V28_valid_s)) <=(if V71_garde_s2 then 1 else (pre V29_dirty_s))) 
and ((if V71_garde_s2 then 0 else (pre V28_valid_s)) <=V29_dirty_s) 
and ((if V71_garde_s2 then 0 else (pre V28_valid_s)) <=(if e_s1 then (if V70_garde_s1 then 0 else (pre V29_dirty_s)) else (if e_s2 then (if V71_garde_s2 then 1 else (pre V29_dirty_s)) else (if e_s3 then (if V72_garde_s3 then 1 else (pre V29_dirty_s)) else (pre V29_dirty_s))))) 
and ((if V71_garde_s2 then 0 else (pre V28_valid_s)) <=(if e_s2 then (if V71_garde_s2 then 1 else (pre V29_dirty_s)) else (if e_s3 then (if V72_garde_s3 then 1 else (pre V29_dirty_s)) else (pre V29_dirty_s)))) 
and ((if V71_garde_s2 then 0 else (pre V28_valid_s)) <=(if e_s3 then (if V72_garde_s3 then 1 else (pre V29_dirty_s)) else (pre V29_dirty_s))) 
and ((if V71_garde_s2 then 0 else (pre V28_valid_s)) <=(if V72_garde_s3 then 1 else (pre V29_dirty_s))) 
and ((if V71_garde_s2 then 0 else (pre V28_valid_s)) <=1) 
and ((if V71_garde_s2 then 0 else (pre V28_valid_s)) <=2) 
...
and ((if V71_garde_s2 then 0 else (pre V28_valid_s)) <=(if e_s2 then (if V71_garde_s2 then 0 else (pre V28_valid_s)) else (if e_s3 then (if V72_garde_s3 then 0 else (pre V28_valid_s)) else (pre V28_valid_s)))) 
...
and ((if V71_garde_s2 then ((((pre V27_invalid_s) + (pre V29_dirty_s)) + (pre V28_valid_s)) - 1) else (pre V27_invalid_s)) <=(((pre V27_invalid_s) + (pre V29_dirty_s)) + (pre V28_valid_s))) 
...
and ((if V71_garde_s2 then ((((pre V27_invalid_s) + (pre V29_dirty_s)) + (pre V28_valid_s)) - 1) else (pre V27_invalid_s)) <=(((pre V27_invalid_s) + (pre V29_dirty_s)) + (pre V28_valid_s))) 
and (((pre V27_invalid_s) + (pre V29_dirty_s)) <=(((pre V27_invalid_s) + (pre V29_dirty_s)) + (pre V28_valid_s))) 
and  true ));
tel.
