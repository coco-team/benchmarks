...
and ((pre V51_shared) <=((pre V51_shared) + 1)) 
...
and ((if V106_garde5 then ((pre V50_exclusive) + 1) else (pre V50_exclusive)) <=((pre V50_exclusive) + 1)) 
and ((if V104_garde3 then ((((pre V51_shared) + 1) - (pre V50_exclusive)) + 1) else (pre V51_shared)) <=((pre V51_shared) + 2)) 
...
and (((((pre V51_shared) + 1) - (pre V50_exclusive)) + 1) <=((pre V51_shared) + 2)) 
