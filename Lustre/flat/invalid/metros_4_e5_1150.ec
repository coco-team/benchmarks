...
and ((- 10) <=0) 
and ((- 10) <=(pre V159_c)) 
and ((- 10) <=(if ((pre V44_avance1) and V44_avance1) then (if B1 then ((pre V159_c) + 1) else (pre V159_c)) else 0)) 
and ((- 10) <=(pre V158_c)) 
and ((- 10) <=(if ((pre V43_avance0) and V43_avance0) then (if B0 then ((pre V158_c) + 1) else (pre V158_c)) else 0)) 
and ((- 10) <=(pre V40_nS)) 
and ((- 10) <=(pre V39_nB1)) 
and ((- 10) <=(if B0 then ((pre V158_c) + 1) else (pre V158_c))) 
and ((- 10) <=V38_nB0) 
and ((- 10) <=(if B1 then ((pre V159_c) + 1) else (pre V159_c))) 
and ((- 10) <=V39_nB1) 
