...
and ((((e_s1 and e_s2) and e_s1) and e_s3) => (V34_env => ((((V32_dirty_s < 2) and (((V30_invalid_s + V31_valid_s) + V32_dirty_s) = (((pre V30_invalid_s) + (pre V31_valid_s)) + (pre V32_dirty_s)))) and (((V30_invalid_s + V31_valid_s) + V32_dirty_s) = V105_First)) and ((V32_dirty_s < 1) or (V31_valid_s < 1))))) 
...
and (V34_env => (not ((((e_s1 and e_s2) and e_s1) and e_s3) or (e_s2 and e_s3)))) 
