...
and (((pre V160_c) >= 9) => (if (pre V45_retard0) then (not S) else true)) 
...
and ((V42_diff1 < 0) => (if ((pre V161_c) >= 9) then (not B1) else true)) 
...
and ((if ((pre V43_avance0) and V43_avance0) then (if B0 then (((pre V160_c) + 1) + 1) else (pre V160_c)) else 0) <=V38_nB0) 
...
and ((if B0 then (((pre V160_c) + 1) + 1) else (pre V160_c)) <=(if B0 then (((pre V38_nB0) + 1) + 1) else (pre V38_nB0))) 
