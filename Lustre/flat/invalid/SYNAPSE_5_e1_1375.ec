...
-- 85 implications. 
assert (true -> ((V92_X = ((not (((e_s1 and e_s2) or (e_s1 and e_s3)) or (e_s2 and e_s3))) and (init_invalid_s >= 0))) 
...
and ((((e_s1 and e_s2) or (e_s1 and e_s3)) or (e_s2 and e_s3)) => (V34_env => (V31_valid_s <= V106_First))) 
