...
-- 131 implications. 
assert (true -> (((V37_env => (V32_dirty_s < 2)) = (V37_env => (((V30_invalid_s + V31_valid_s) + V32_dirty_s) = V108_First))) 
and ((V37_env => (((V30_invalid_s + V31_valid_s) + V32_dirty_s) = V108_First)) = ((V35_R2 and V34_R1) and V36_R3)) 
and (((V35_R2 and V34_R1) and V36_R3) = true) 
