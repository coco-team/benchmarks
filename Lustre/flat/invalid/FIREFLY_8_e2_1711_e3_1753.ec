...
-- 362 implications. 
assert (true -> ((true = (V52_env => (V48_invalid >= 0))) 
...
and (V52_env => (V48_invalid >= 0)) 
and ((V130_X and (pre V52_env)) => (V48_invalid >= 0)) 
...
and ((((((not e1) and e2) and (not e3)) and (not e4)) and (not e5)) => e2) 
