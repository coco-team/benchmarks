...
and (((pre V43_avance0) and V43_avance0) = (V41_diff0 >= 10)) 
...
and ((not (pre V45_retard0)) => (if (pre V46_retard1) then (not S) else true)) 
and ((not (pre V45_retard0)) => V158_H0) 
...
and ((if B0 then (((pre V38_nB0) - 1) + 1) else (pre V38_nB0)) = 0) 
and (0 = (pre V160_c)) 
...
and ((((pre V38_nB0) - 1) + 1) <=(if ((pre V44_avance1) and V44_avance1) then (if B1 then (((pre V161_c) + 1) + 1) else (pre V161_c)) else 0)) 
...
and ((((pre V38_nB0) - 1) + 1) <=(if B1 then ((pre V39_nB1) + 1) else (pre V39_nB1))) 
and ((((pre V38_nB0) - 1) + 1) <=((pre V160_c) + 1)) 
and ((((pre V38_nB0) - 1) + 1) <=((pre V39_nB1) + 1)) 
and ((((pre V38_nB0) - 1) + 1) <=((pre V40_nS) + 1)) 
and ((((pre V38_nB0) - 1) + 1) <=(if B0 then (((pre V160_c) + 1) + 1) else (pre V160_c))) 
and ((((pre V38_nB0) - 1) + 1) <=(((pre V160_c) + 1) + 1)) 
...
and ((((pre V160_c) + 1) + 1) <=(((pre V161_c) + 1) + 1)) 
and (9 <=10) 
and (10 <=20) 
and  true ));
tel.
