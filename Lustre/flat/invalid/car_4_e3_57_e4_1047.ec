...
-- 72 implications. 
assert (true -> (((not (pre V24_toofast)) = (V33_env => (V28_speed >= 0))) 
and ((V33_env => (V28_speed >= 0)) = true) 
and (true = (V28_speed >= 0)) 
...
and ((pre V28_speed) <=V29_time) 
and ((pre V28_speed) <=V27_dist) 
and ((pre V28_speed) <=(if (V30_move and V32_meter) then ((pre V27_dist) + 1) else (pre V27_dist))) 
and ((pre V28_speed) <=1) 
and ((pre V28_speed) <=((pre V27_dist) + 1)) 
and ((pre V28_speed) <=3) 
and ((pre V28_speed) <=4) 
and ((pre V28_speed) <=10) 
