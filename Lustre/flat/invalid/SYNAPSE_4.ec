...
let
  ...
  V84_X = ((not (((e_s1 and e_s2) or (e_s1 and e_s3)) or (e_s2 and e_s3))) and 
  (init_invalid_s >= 0));
    --%PROPERTY OK=true;
...
and (V84_X = ((not (((e_s1 and e_s2) or (e_s1 and e_s3)) or (e_s2 and e_s3))) and (init_invalid_s >= 0))) 
...
and (V84_X => (not (((e_s1 and e_s2) or (e_s1 and e_s3)) or (e_s2 and e_s3)))) 
...
and (V84_X => (init_invalid_s >= 0)) 
and (V31_env => (init_invalid_s >= 0)) 
