...
and ((((pre V41_time) + 1) + 1) = (if ((pre V41_time) = 5) then 1 else (((pre V41_time) + 1) + 1))) 
and (1 <=5) 
and ((pre V41_time) <=((pre V41_time) + 1)) 
and (((pre V41_time) + 1) <=(((pre V41_time) + 1) + 1)) 
and (1 <=((pre V41_time) + 1)) 
and (((pre V41_time) + 1) <=(((pre V41_time) + 1) + 1)) 
and (V41_time <=(((pre V41_time) + 1) + 1)) 
and  true ));
tel.
