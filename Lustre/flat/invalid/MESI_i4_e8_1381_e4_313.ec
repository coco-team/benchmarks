...
let
  ...
  V31_shared_me) + (pre V30_exclusive_me)) + (pre V29_modified_me)) + 1) - 1) 
...
and ((etat_me1 and etat_me4) => (V33_env => (V32_invalid_me >= 0))) 
...
and ((etat_me2 and etat_me4) => (V33_env => (V32_invalid_me >= 0))) 
...
and ((etat_me2 and etat_me4) => (((((((etat_me1 and etat_me2) and etat_me1) and etat_me3) or (etat_me1 and etat_me4)) or (etat_me2 and etat_me3)) or (etat_me2 and etat_me4)) or (etat_me3 and etat_me4))) 
...
and ((((pre V31_shared_me) + (pre V30_exclusive_me)) + (pre V29_modified_me)) = (((((pre V31_shared_me) + (pre V30_exclusive_me)) + (pre V29_modified_me)) + 1) - 1)) 
...
and (((pre V30_exclusive_me) - 1) <=(if etat_me1 then (if V73_garde_me1 then (((((pre V31_shared_me) + (pre V30_exclusive_me)) + (pre V29_modified_me)) + 1) - 1) else (pre V31_shared_me)) else (if etat_me2 then (if V74_garde_me2 then (pre V31_shared_me) else (pre V31_shared_me)) else (if etat_me3 then (if V75_garde_me3 then 0 else (pre V31_shared_me)) else (if etat_me4 then (if V76_garde_me4 then 0 else (pre V31_shared_me)) else (pre V31_shared_me)))))) 
and (((pre V30_exclusive_me) - 1) <=(if V73_garde_me1 then (((((pre V31_shared_me) + (pre V30_exclusive_me)) + (pre V29_modified_me)) + 1) - 1) else (pre V31_shared_me))) 
and (((pre V30_exclusive_me) - 1) <=(((pre V31_shared_me) + (pre V30_exclusive_me)) + (pre V29_modified_me))) 
and (((pre V30_exclusive_me) - 1) <=((pre V31_shared_me) + (pre V30_exclusive_me))) 
...
and ((if V75_garde_me3 then 0 else (pre V31_shared_me)) <=((pre V31_shared_me) + (pre V30_exclusive_me))) 
...
and ((if V75_garde_me3 then 1 else (pre V30_exclusive_me)) <=((((pre V31_shared_me) + (pre V30_exclusive_me)) + (pre V29_modified_me)) + 1)) 
...
and ((if V75_garde_me3 then 1 else (pre V30_exclusive_me)) <=1) 
and ((pre V31_shared_me) <=((pre V31_shared_me) + (pre V30_exclusive_me))) 
and (((pre V31_shared_me) + (pre V30_exclusive_me)) <=(if V75_garde_me3 then 1 else (pre V30_exclusive_me))) 
and ((if V75_garde_me3 then 1 else (pre V30_exclusive_me)) <=1) 
and ((if etat_me1 then (if V73_garde_me1 then (((((pre V31_shared_me) + (pre V30_exclusive_me)) + (pre V29_modified_me)) + 1) - 1) else (pre V31_shared_me)) else (if etat_me2 then (if V74_garde_me2 then (pre V31_shared_me) else (pre V31_shared_me)) else (if etat_me3 then (if V75_garde_me3 then 0 else (pre V31_shared_me)) else (if etat_me4 then (if V76_garde_me4 then 0 else (pre V31_shared_me)) else (pre V31_shared_me))))) <=(if V75_garde_me3 then 1 else (pre V30_exclusive_me))) 
and ((if V75_garde_me3 then 1 else (pre V30_exclusive_me)) <=1) 
and ((if V73_garde_me1 then (((((pre V31_shared_me) + (pre V30_exclusive_me)) + (pre V29_modified_me)) + 1) - 1) else (pre V31_shared_me)) <=((pre V31_shared_me) + (pre V30_exclusive_me))) 
and (((pre V31_shared_me) + (pre V30_exclusive_me)) <=(if V75_garde_me3 then 1 else (pre V30_exclusive_me))) 
and ((if V75_garde_me3 then 1 else (pre V30_exclusive_me)) <=1) 
