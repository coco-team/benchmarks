...
and ((((pre V30_invalid_s) + (pre V32_dirty_s)) + (pre V31_valid_s)) = (((((pre V30_invalid_s) + 1) + (pre V32_dirty_s)) + (pre V31_valid_s)) - 1)) 
...
and ((((pre V30_invalid_s) + (pre V32_dirty_s)) + (pre V31_valid_s)) <=((((pre V30_invalid_s) + 1) + (pre V32_dirty_s)) + (pre V31_valid_s))) 
