...
and ((pre V37_owned_mo) <=(if V85_garde_mo3 then 1 else (pre V34_exclusive_mo))) 
...
and ((if V85_garde_mo3 then ((((((pre V36_invalid_mo) + (pre V33_modified_mo)) + (pre V34_exclusive_mo)) + (pre V35_shared_mo)) + (pre V37_owned_mo)) - 1) else (pre V36_invalid_mo)) <=((((pre V33_modified_mo) + (pre V34_exclusive_mo)) + (pre V35_shared_mo)) + (pre V36_invalid_mo))) 
...
and ((((pre V35_shared_mo) - 1) + (pre V37_owned_mo)) <=((pre V35_shared_mo) - (pre V34_exclusive_mo))) 
