...
and (V39_env => (V99_X or (pre V39_env))) 
...
and (((((etat_mo1 and etat_mo2) and etat_mo1) and etat_mo3) or (etat_mo1 and etat_mo4)) => (V39_env => (((((V33_modified_mo + V34_exclusive_mo) + V35_shared_mo) + V36_invalid_mo) + V37_owned_mo) = (((((pre V33_modified_mo) + (pre V34_exclusive_mo)) + (pre V35_shared_mo)) + (pre V36_invalid_mo)) + (pre V37_owned_mo))))) 
...
and ((((etat_mo1 and etat_mo2) and etat_mo1) and etat_mo3) => ((((((etat_mo1 and etat_mo2) and etat_mo1) and etat_mo3) or (etat_mo1 and etat_mo4)) or (etat_mo2 and etat_mo3)) or (etat_mo2 and etat_mo4))) 
and ((((etat_mo1 and etat_mo2) and etat_mo1) and etat_mo3) => etat_mo2) 
...
and ((pre V39_env) => (V99_X or (pre V39_env))) 
and ((not (((((((etat_mo1 and etat_mo2) and etat_mo1) and etat_mo3) or (etat_mo1 and etat_mo4)) or (etat_mo2 and etat_mo3)) or (etat_mo2 and etat_mo4)) or (etat_mo3 and etat_mo4))) => V39_env) 
