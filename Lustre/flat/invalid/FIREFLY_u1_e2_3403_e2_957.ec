...
and (((((pre V48_invalid) >= 1) and ((pre V49_dirty) = 0)) and ((pre V51_shared) = 0)) => (V52_env => (not ((((V48_invalid >= 0) and (V50_exclusive >= 0)) and (V49_dirty >= 2)) and (V51_shared >= 0))))) 
and (((((pre V48_invalid) >= 1) and ((pre V49_dirty) = 0)) and ((pre V51_shared) = 0)) => ((pre V51_shared) = 0)) 
and ((((pre V48_invalid) >= 1) and ((pre V49_dirty) = 0)) => (V52_env => (not ((((V48_invalid >= 0) and (V50_exclusive >= 0)) and (V49_dirty >= 2)) and (V51_shared >= 0))))) 
...
and (V108_garde6 => ((pre V49_dirty) = 0)) 
and (V108_garde6 => (V52_env => (not ((((V48_invalid >= 0) and (V50_exclusive >= 0)) and (V49_dirty >= 2)) and (V51_shared >= 0))))) 
and (V108_garde6 => ((pre V51_shared) = 0)) 
...
and (((((((((((not e1) and (not e2)) and (not e3)) and (not e4)) and (not e5)) and (not e6)) and (not e7)) and (not e8)) or (((((((e1 and (not e2)) and (not e3)) and (not e4)) and (not e5)) and (not e6)) and (not e7)) and (not e8))) or ((((((((not e1) and e2) and (not e3)) and (not e4)) and (not e5)) and (not e6)) and (not e7)) and (not e8))) => (not e4)) 
...
and (((((((((not e1) and (not e2)) and (not e3)) and (not e4)) and (not e5)) and (not e6)) and (not e7)) and (not e8)) => (((((((((((not e1) and (not e2)) and (not e3)) and (not e4)) and (not e5)) and (not e6)) and (not e7)) and (not e8)) or (((((((e1 and (not e2)) and (not e3)) and (not e4)) and (not e5)) and (not e6)) and (not e7)) and (not e8))) or ((((((((not e1) and e2) and (not e3)) and (not e4)) and (not e5)) and (not e6)) and (not e7)) and (not e8))) or ((((((((not e1) and (not e2)) and e3) and (not e4)) and (not e5)) and (not e6)) and (not e7)) and (not e8)))) 
...
and ((if V110_garde8 then 0 else (pre V50_exclusive)) = (if V105_garde3 then 0 else (pre V50_exclusive))) 
...
and (0 <=(if V110_garde8 then 0 else (pre V50_exclusive))) 
...
and ((if V110_garde8 then 0 else (pre V50_exclusive)) <=(if e8 then (if V110_garde8 then 0 else (pre V50_exclusive)) else (pre V50_exclusive))) 
...
and (V51_shared <=(if e2 then (if V104_garde2 then ((pre V51_shared) + 2) else (pre V51_shared)) else (if e3 then (if V105_garde3 then (((((pre V51_shared) - 1) + (pre V50_exclusive)) - 1) + 1) else (pre V51_shared)) else (if e5 then (if V107_garde5 then 0 else (pre V51_shared)) else (if e7 then (if V109_garde7 then ((pre V51_shared) + 2) else (pre V51_shared)) else (if e8 then (if V110_garde8 then (((pre V51_shared) + (pre V50_exclusive)) + 1) else (pre V51_shared)) else (pre V51_shared))))))) 
