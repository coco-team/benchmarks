...
and (V38_nB0 = (pre V38_nB0)) 
and ((pre V38_nB0) = (((pre V158_c) - 1) + 1)) 
and ((((pre V158_c) - 1) + 1) = (if B0 then (((pre V158_c) - 1) + 1) else (pre V158_c))) 
and ((if B0 then (((pre V158_c) - 1) + 1) else (pre V158_c)) = (if B0 then (((pre V38_nB0) - 1) + 1) else (pre V38_nB0))) 
and (V41_diff0 <=(pre V158_c)) 
...
and ((pre V158_c) <=(if S then ((pre V40_nS) + 1) else (pre V40_nS))) 
and ((pre V158_c) <=1) 
and ((pre V158_c) <=((pre V40_nS) + 1)) 
and ((pre V158_c) <=9) 
and ((pre V158_c) <=10) 
and ((pre V158_c) <=30) 
and (1 <=((pre V40_nS) + 1)) 
...
and ((if B1 then ((pre V39_nB1) + 1) else (pre V39_nB1)) <=((pre V39_nB1) + 1)) 
and (((pre V38_nB0) - (pre V39_nB1)) <=(pre V158_c)) 
and ((pre V158_c) <=(pre V39_nB1)) 
and ((pre V39_nB1) <=(if B1 then ((pre V39_nB1) + 1) else (pre V39_nB1))) 
and ((if B1 then ((pre V39_nB1) + 1) else (pre V39_nB1)) <=((pre V39_nB1) + 1)) 
