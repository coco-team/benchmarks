...
let
  OK = (true -> ((if (not V17_SETUP) then (if (V102_MWI_FcnMaxI_In1 > 0) then 
  V102_MWI_FcnMaxI_In1 else 0) else 639) > 0));
  ...
  * 10));
  ...
  V103_p4 = (true -> ((if (not V18_COOKING) then (if (V101_MWI_FcnMaxI_In11 > 0
  ) then V101_MWI_FcnMaxI_In11 else 0) else 639) > 0));
  V104_p5 = (true -> ((if (not V19_SUSPENDED) then (if (V100_MWI_FcnMaxI_In12 > 
  0) then V100_MWI_FcnMaxI_In12 else 0) else 639) > 0));
  V105_p6 = (true -> ((not V17_SETUP) or ((if (not (not V17_SETUP)) then (if (
  V99_MWI_FcnMaxI_In13 > 0) then V99_MWI_FcnMaxI_In13 else 0) else 639) > 0)));
  V106_p7 = (true -> ((not V18_COOKING) or ((if (not (not V18_COOKING)) then 
  (if (V97_MWI_FcnMaxI_In16 > 0) then V97_MWI_FcnMaxI_In16 else 0) else 639) > 
  0)));
  V107_p8 = (true -> ((not V19_SUSPENDED) or ((if (not (not V19_SUSPENDED)) 
  then (if (V98_MWI_FcnMaxI_In15 > 0) then V98_MWI_FcnMaxI_In15 else 0) else 
  639) > 0)));
  V108_p9 = (true -> ((not V18_COOKING) or DOOR_CLOSED));
  V109_p10 = (true -> ((not V18_COOKING) or ((if (not (not V18_COOKING)) then 
  (if (V97_MWI_FcnMaxI_In16 > 0) then V97_MWI_FcnMaxI_In16 else 0) else 639) > 
  0)));
  V110_p11 = ((not KP_CLEAR) or (not V18_COOKING));
  V111_p12 = (
...
-- 1119 implications. 
assert (true -> ((((V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root >= 1) and (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root <= 3)) = (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root <= 3)) 
and ((V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root <= 3) = true) 
...
and (((V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root >= 1) and (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root <= 3)) = (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root >= 1)) 
...
and ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) = (V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root >= 1)) 
and (((not ((V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root >= 1) and (V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root <= 3))) and ((V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root >= 1) and (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root <= 3))) = (not ((V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root >= 1) and (V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root <= 3)))) 
and ((not ((V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root >= 1) and (V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root <= 3))) = V73_rlt_enter_microwave_mode_logic_ON_rlt_fired_0) 
and (V73_rlt_enter_microwave_mode_logic_ON_rlt_fired_0 = V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock) 
and ((V87_chart_microwave_mode_logic_begin_state_states___root = 4) = V79_rlt_eval_microwave_mode_logic_rlt_fired_0) 
and ((1 = V96_microwave_microwave_mode_logic_mode) = V17_SETUP) 
and ((((V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root >= 1) and (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root <= 3)) and (if (not (V49_chart_microwave_mode_logic_door_closed = 0)) then true else false)) = DOOR_CLOSED) 
and (DOOR_CLOSED = (not (V49_chart_microwave_mode_logic_door_closed = 0))) 
...
and (V77_rlt_enter_microwave_mode_logic_ON_rlt_fired_2 = (V73_rlt_enter_microwave_mode_logic_ON_rlt_fired_0 and (((V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root >= 1) and (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root <= 3)) and (not V74_rlt_enter_microwave_mode_logic_ON_rlt_fired_1)))) 
and ((not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) = (V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root <= 3)) 
...
and ((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root <= 3) = (not (V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4))) 
and ((V79_rlt_eval_microwave_mode_logic_rlt_fired_0 and ((V87_chart_microwave_mode_logic_begin_state_states___root = 4) and ((if (not (V47_chart_microwave_mode_logic_start = 0)) then true else false) and (if (not ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) = 0)) then true else false)))) = V81_rlt_eval_microwave_mode_logic_rlt_fired_1) 
...
and (((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root = 3) and (not V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1)) = (V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root = 3)) 
...
and ((not V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock) = ((not V81_rlt_eval_microwave_mode_logic_rlt_fired_1) and ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3)))) 
...
and ((V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step and (not V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock)) = ((V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root >= 1) and (V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root <= 3))) 
...
and (V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 = (((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root = 3) and ((if (not (V48_chart_microwave_mode_logic_clear_off = 0)) then true else false) and (not V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1))) and ((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root = 3) and (not V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1)))) 
...
and ((((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2) and (V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining <= 0)) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2)) = ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2) and (V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining <= 0))) 
...
and ((V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2) = V54_rlt_eval_microwave_mode_logic_ON_rlt_fired_2) 
...
and ((V102_MWI_FcnMaxI_In1 > 0) => ((if (not V17_SETUP) then (if (V102_MWI_FcnMaxI_In1 > 0) then V102_MWI_FcnMaxI_In1 else 0) else 639) > 0)) 
and ((V87_chart_microwave_mode_logic_begin_state_states___root = 4) => (1 = (pre V96_microwave_microwave_mode_logic_mode))) 
and ((KP_CLEAR and (not (pre KP_CLEAR))) => V21_CLEAR_PRESSED) 
...
and ((V79_rlt_eval_microwave_mode_logic_rlt_fired_0 and ((V87_chart_microwave_mode_logic_begin_state_states___root = 4) and ((if (not (V47_chart_microwave_mode_logic_start = 0)) then true else false) and (if (not ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) = 0)) then true else false)))) => ((if (not (V47_chart_microwave_mode_logic_start = 0)) then true else false) and (if (not ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) = 0)) then true else false))) 
...
and (((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3)) => (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4))) 
and (((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root >= 1) and (V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root <= 3)) => (V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root <= 3)) 
and ((not V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock) => ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) = 0)) 
and ((not V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock) => (if (not V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock) then true else (if (pre V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock) then false else (pre V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step)))) 
and ((not V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock) => (not (V87_chart_microwave_mode_logic_begin_state_states___root = 4))) 
and ((not V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock) => (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1)) 
and ((not V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock) => (((V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root >= 1) and (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root <= 3)) and (not V74_rlt_enter_microwave_mode_logic_ON_rlt_fired_1))) 
and ((not V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock) => ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3))) 
and ((not (V87_chart_microwave_mode_logic_begin_state_states___root = 4)) => (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4))) 
...
and (((if (not (V48_chart_microwave_mode_logic_clear_off = 0)) then true else false) and (not V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1)) => V21_CLEAR_PRESSED) 
...
and (((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root = 3) and (not V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1)) => (V53_rlt_eval_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) 
...
and ((((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2) and (V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining <= 0)) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2)) => ((if (not V17_SETUP) then (if (V102_MWI_FcnMaxI_In1 > 0) then V102_MWI_FcnMaxI_In1 else 0) else 639) > 0)) 
and ((((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2) and (V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining <= 0)) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2)) => V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1) 
and (V86_chart_microwave_mode_logic_rlt_evtInitStep => ((if (not V17_SETUP) then (if (V102_MWI_FcnMaxI_In1 > 0) then V102_MWI_FcnMaxI_In1 else 0) else 639) > 0)) 
...
and ((V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4) => (V102_MWI_FcnMaxI_In1 > 0)) 
...
and ((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root <= 3) => (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4))) 
...
and (((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root = 3) and ((if (not (V48_chart_microwave_mode_logic_clear_off = 0)) then true else false) and (not V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1))) => ((if (not V17_SETUP) then (if (V102_MWI_FcnMaxI_In1 > 0) then V102_MWI_FcnMaxI_In1 else 0) else 639) > 0)) 
and (((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root = 3) and ((if (not (V48_chart_microwave_mode_logic_clear_off = 0)) then true else false) and (not V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1))) => (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1)) 
and (((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root = 3) and ((if (not (V48_chart_microwave_mode_logic_clear_off = 0)) then true else false) and (not V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1))) => (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2))) 
and (((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root = 3) and ((if (not (V48_chart_microwave_mode_logic_clear_off = 0)) then true else false) and (not V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1))) => ((if (not (V48_chart_microwave_mode_logic_clear_off = 0)) then true else false) or (not (if (not (V49_chart_microwave_mode_logic_door_closed = 0)) then true else false)))) 
and (((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root = 3) and ((if (not (V48_chart_microwave_mode_logic_clear_off = 0)) then true else false) and (not V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1))) => (V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root >= 1)) 
and (((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root = 3) and ((if (not (V48_chart_microwave_mode_logic_clear_off = 0)) then true else false) and (not V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1))) => (1 = V96_microwave_microwave_mode_logic_mode)) 
and (((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root = 3) and ((if (not (V48_chart_microwave_mode_logic_clear_off = 0)) then true else false) and (not V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1))) => V61_rlt_eval_microwave_mode_logic_ON_rlt_complete_2) 
and (V86_chart_microwave_mode_logic_rlt_evtInitStep => (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2))) 
and ((V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2) => (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1)) 
and ((V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2) => (((V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root >= 1) and (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root <= 3)) and (not V74_rlt_enter_microwave_mode_logic_ON_rlt_fired_1))) 
and (V86_chart_microwave_mode_logic_rlt_evtInitStep => (not V81_rlt_eval_microwave_mode_logic_rlt_fired_1)) 
and ((V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2) => (V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root >= 1)) 
...
and ((V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2) => V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1) 
...
and ((pre V86_chart_microwave_mode_logic_rlt_evtInitStep) => (not V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1)) 
and ((pre V86_chart_microwave_mode_logic_rlt_evtInitStep) => (V102_MWI_FcnMaxI_In1 > 0)) 
and ((pre V86_chart_microwave_mode_logic_rlt_evtInitStep) => ((if (not V17_SETUP) then (if (V102_MWI_FcnMaxI_In1 > 0) then V102_MWI_FcnMaxI_In1 else 0) else 639) > 0)) 
and ((pre V86_chart_microwave_mode_logic_rlt_evtInitStep) => (not (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root = 2))) 
and ((pre V86_chart_microwave_mode_logic_rlt_evtInitStep) => (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1)) 
...
and ((V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2) => (not V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1)) 
and ((V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2) => (((V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root >= 1) and (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root <= 3)) and (if (not (V49_chart_microwave_mode_logic_door_closed = 0)) then true else false))) 
and ((((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2) and (V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining <= 0)) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2)) => (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1)) 
and ((((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2) and (V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining <= 0)) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2)) => (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2))) 
and (V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1 => (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1)) 
and ((V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2) => (V53_rlt_eval_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) 
...
and (V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1 => (((V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root >= 1) and (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root <= 3)) and (not V74_rlt_enter_microwave_mode_logic_ON_rlt_fired_1))) 
and (V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1 => ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3))) 
and (V86_chart_microwave_mode_logic_rlt_evtInitStep => (1 = V96_microwave_microwave_mode_logic_mode)) 
and ((V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2) => (not (pre KP_CLEAR))) 
and ((V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2) => (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) 
and ((V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2) => V61_rlt_eval_microwave_mode_logic_ON_rlt_complete_2) 
and ((((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2) and (V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining <= 0)) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2)) => (V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root >= 1)) 
and ((((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2) and (V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining <= 0)) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2)) => (1 = V96_microwave_microwave_mode_logic_mode)) 
and (V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1 => V61_rlt_eval_microwave_mode_logic_ON_rlt_complete_2) 
and ((V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2) => (not (pre KP_START))) 
...
and (V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1 => (not V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock)) 
...
and ((V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3) => (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1)) 
...
and ((V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3) => (not V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock)) 
...
and ((V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2) => (V68_rlt_eval_microwave_mode_logic_ON_rlt_state_10_states___root = 2)) 
and ((((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2) and (V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining <= 0)) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2)) => (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root = 2)) 
...
and (((not ((V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root >= 1) and (V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root <= 3))) and ((V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root >= 1) and (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root <= 3))) => ((if (not V17_SETUP) then (if (V102_MWI_FcnMaxI_In1 > 0) then V102_MWI_FcnMaxI_In1 else 0) else 639) > 0)) 
...
and ((1 = V96_microwave_microwave_mode_logic_mode) => ((if (not V17_SETUP) then (if (V102_MWI_FcnMaxI_In1 > 0) then V102_MWI_FcnMaxI_In1 else 0) else 639) > 0)) 
and ((1 = V96_microwave_microwave_mode_logic_mode) => (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2))) 
and ((1 = V96_microwave_microwave_mode_logic_mode) => (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2))) 
and ((1 = V96_microwave_microwave_mode_logic_mode) => (not V81_rlt_eval_microwave_mode_logic_rlt_fired_1)) 
...
and ((not ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) = 0)) => ((if (not V17_SETUP) then (if (V102_MWI_FcnMaxI_In1 > 0) then V102_MWI_FcnMaxI_In1 else 0) else 639) > 0)) 
...
and (V77_rlt_enter_microwave_mode_logic_ON_rlt_fired_2 => (((if (not (V48_chart_microwave_mode_logic_clear_off = 0)) then true else false) or (not (if (not (V49_chart_microwave_mode_logic_door_closed = 0)) then true else false))) and (not (V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 or V61_rlt_eval_microwave_mode_logic_ON_rlt_complete_2)))) 
and (V77_rlt_enter_microwave_mode_logic_ON_rlt_fired_2 => (not V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1)) 
and (V77_rlt_enter_microwave_mode_logic_ON_rlt_fired_2 => (not V61_rlt_eval_microwave_mode_logic_ON_rlt_complete_2)) 
and (V77_rlt_enter_microwave_mode_logic_ON_rlt_fired_2 => ((if (not V17_SETUP) then (if (V102_MWI_FcnMaxI_In1 > 0) then V102_MWI_FcnMaxI_In1 else 0) else 639) > 0)) 
and (V77_rlt_enter_microwave_mode_logic_ON_rlt_fired_2 => (V49_chart_microwave_mode_logic_door_closed = 0)) 
and ((V79_rlt_eval_microwave_mode_logic_rlt_fired_0 and ((V87_chart_microwave_mode_logic_begin_state_states___root = 4) and ((if (not (V47_chart_microwave_mode_logic_start = 0)) then true else false) and (if (not ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) = 0)) then true else false)))) => ((V63_rlt_eval_microwave_mode_logic_ON_rlt_state_6_outports_steps_remaining > 0) and (not V61_rlt_eval_microwave_mode_logic_ON_rlt_complete_2))) 
...
and ((V79_rlt_eval_microwave_mode_logic_rlt_fired_0 and ((V87_chart_microwave_mode_logic_begin_state_states___root = 4) and ((if (not (V47_chart_microwave_mode_logic_start = 0)) then true else false) and (if (not ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) = 0)) then true else false)))) => (not V17_SETUP)) 
and (((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root = 3) and ((if (not (V48_chart_microwave_mode_logic_clear_off = 0)) then true else false) and (not V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1))) => ((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root = 3) and (not V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1))) 
and (((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root = 3) and ((if (not (V48_chart_microwave_mode_logic_clear_off = 0)) then true else false) and (not V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1))) => (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) 
and (V61_rlt_eval_microwave_mode_logic_ON_rlt_complete_2 => (not V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock)) 
and ((pre V86_chart_microwave_mode_logic_rlt_evtInitStep) => (pre V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock)) 
...
and ((V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4) => (1 = V96_microwave_microwave_mode_logic_mode)) 
and (V74_rlt_enter_microwave_mode_logic_ON_rlt_fired_1 => (not V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1)) 
and (V74_rlt_enter_microwave_mode_logic_ON_rlt_fired_1 => ((if (not V17_SETUP) then (if (V102_MWI_FcnMaxI_In1 > 0) then V102_MWI_FcnMaxI_In1 else 0) else 639) > 0)) 
...
and ((V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining <= 0) => (1 = V96_microwave_microwave_mode_logic_mode)) 
and ((V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining <= 0) => ((if (not V17_SETUP) then (if (V102_MWI_FcnMaxI_In1 > 0) then V102_MWI_FcnMaxI_In1 else 0) else 639) > 0)) 
...
and ((not V17_SETUP) => (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1)) 
and ((not V17_SETUP) => (not V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1)) 
and ((not V17_SETUP) => ((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root >= 1) and (V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root <= 3))) 
and ((V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3) => ((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root = 3) and (not V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1))) 
...
and ((V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root = 2) => (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1)) 
...
and ((V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root = 2) => (not V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock)) 
...
and (V21_CLEAR_PRESSED => KP_CLEAR) 
...
and ((1 = V96_microwave_microwave_mode_logic_mode) => (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3))) 
and ((V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root >= 1) => (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1)) 
...
and (((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root = 3) and (not V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1)) => (not V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1)) 
...
and ((V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3) => (not V17_SETUP)) 
...
and ((V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2) => (pre V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step)) 
and (V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1 => (pre V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step)) 
...
and ((V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2) => (not (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root = 2))) 
and ((((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2) and (V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining <= 0)) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2)) => (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3))) 
and ((V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2) => (KP_START and (not (pre KP_START)))) 
and (((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root = 3) and ((if (not (V48_chart_microwave_mode_logic_clear_off = 0)) then true else false) and (not V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1))) => (not V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1)) 
and (((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root = 3) and ((if (not (V48_chart_microwave_mode_logic_clear_off = 0)) then true else false) and (not V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1))) => (not (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root = 2))) 
and (V61_rlt_eval_microwave_mode_logic_ON_rlt_complete_2 => (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1)) 
...
and ((V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2) => (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3))) 
...
and ((V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2) => (((if (not (V47_chart_microwave_mode_logic_start = 0)) then true else false) and (if (not (V49_chart_microwave_mode_logic_door_closed = 0)) then true else false)) and (not V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1))) 
and ((V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2) => (not V17_SETUP)) 
...
and ((V79_rlt_eval_microwave_mode_logic_rlt_fired_0 and ((V87_chart_microwave_mode_logic_begin_state_states___root = 4) and ((if (not (V47_chart_microwave_mode_logic_start = 0)) then true else false) and (if (not ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) = 0)) then true else false)))) => (V87_chart_microwave_mode_logic_begin_state_states___root = 4)) 
...
and (((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root >= 1) and (V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root <= 3)) => (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1)) 
and ((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root <= 3) => (not V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1)) 
and (((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3)) => (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1)) 
...
and (((if (not (V47_chart_microwave_mode_logic_start = 0)) then true else false) and (if (not ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) = 0)) then true else false)) => ((if (not V17_SETUP) then (if (V102_MWI_FcnMaxI_In1 > 0) then V102_MWI_FcnMaxI_In1 else 0) else 639) > 0)) 
...
and ((V79_rlt_eval_microwave_mode_logic_rlt_fired_0 and ((V87_chart_microwave_mode_logic_begin_state_states___root = 4) and ((if (not (V47_chart_microwave_mode_logic_start = 0)) then true else false) and (if (not ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) = 0)) then true else false)))) => (V102_MWI_FcnMaxI_In1 > 0)) 
and ((V79_rlt_eval_microwave_mode_logic_rlt_fired_0 and ((V87_chart_microwave_mode_logic_begin_state_states___root = 4) and ((if (not (V47_chart_microwave_mode_logic_start = 0)) then true else false) and (if (not ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) = 0)) then true else false)))) => (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1)) 
...
and ((V79_rlt_eval_microwave_mode_logic_rlt_fired_0 and ((V87_chart_microwave_mode_logic_begin_state_states___root = 4) and ((if (not (V47_chart_microwave_mode_logic_start = 0)) then true else false) and (if (not ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) = 0)) then true else false)))) => (not (pre KP_START))) 
...
and ((V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3) => (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1)) 
...
and ((V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3) => (((V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root >= 1) and (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root <= 3)) and (not V74_rlt_enter_microwave_mode_logic_ON_rlt_fired_1))) 
and ((V53_rlt_eval_microwave_mode_logic_ON_rlt_state_2_states___root = 3) => (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1)) 
...
and (((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root = 3) and (not V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1)) => (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1)) 
and (((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root = 3) and (not V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1)) => (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2))) 
...
and ((V79_rlt_eval_microwave_mode_logic_rlt_fired_0 and ((V87_chart_microwave_mode_logic_begin_state_states___root = 4) and ((if (not (V47_chart_microwave_mode_logic_start = 0)) then true else false) and (if (not ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) = 0)) then true else false)))) => (KP_START and (not (pre KP_START)))) 
and (((if (not (V47_chart_microwave_mode_logic_start = 0)) then true else false) and (if (not ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) = 0)) then true else false)) => V20_START_PRESSED) 
...
and ((pre KP_CLEAR) => (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2))) 
...
and ((not V17_SETUP) => (V63_rlt_eval_microwave_mode_logic_ON_rlt_state_6_outports_steps_remaining > 0)) 
...
and ((V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2) => (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2))) 
...
and ((V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2) => (V63_rlt_eval_microwave_mode_logic_ON_rlt_state_6_outports_steps_remaining > 0)) 
and ((((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2) and (V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining <= 0)) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2)) => (V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4)) 
...
and ((not V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock) => (V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root >= 1)) 
...
and ((V68_rlt_eval_microwave_mode_logic_ON_rlt_state_10_states___root = 2) => (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1)) 
...
and ((V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 or V61_rlt_eval_microwave_mode_logic_ON_rlt_complete_2) => (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1)) 
...
and ((V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2) => ((V63_rlt_eval_microwave_mode_logic_ON_rlt_state_6_outports_steps_remaining > 0) and (not V61_rlt_eval_microwave_mode_logic_ON_rlt_complete_2))) 
and ((V68_rlt_eval_microwave_mode_logic_ON_rlt_state_10_states___root = 2) => (V63_rlt_eval_microwave_mode_logic_ON_rlt_state_6_outports_steps_remaining > 0)) 
and (V77_rlt_enter_microwave_mode_logic_ON_rlt_fired_2 => ((not ((V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root >= 1) and (V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root <= 3))) and ((V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root >= 1) and (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root <= 3)))) 
...
and ((V63_rlt_eval_microwave_mode_logic_ON_rlt_state_6_outports_steps_remaining > 0) => (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1)) 
...
and ((V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining <= 0) => (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2))) 
...
and ((V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4) => ((if (not V17_SETUP) then (if (V102_MWI_FcnMaxI_In1 > 0) then V102_MWI_FcnMaxI_In1 else 0) else 639) > 0)) 
...
and ((V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4) => ((if (not V17_SETUP) then (if (V102_MWI_FcnMaxI_In1 > 0) then V102_MWI_FcnMaxI_In1 else 0) else 639) > 0)) 
and ((V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4) => (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1)) 
...
and (((if (not (V48_chart_microwave_mode_logic_clear_off = 0)) then true else false) and (not V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1)) => (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2))) 
and ((KP_CLEAR and (not (pre KP_CLEAR))) => (not (pre KP_CLEAR))) 
and (V21_CLEAR_PRESSED => ((if (not (V48_chart_microwave_mode_logic_clear_off = 0)) then true else false) or (not (if (not (V49_chart_microwave_mode_logic_door_closed = 0)) then true else false)))) 
...
and ((V68_rlt_eval_microwave_mode_logic_ON_rlt_state_10_states___root = 2) => (not V17_SETUP)) 
and ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2) => (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1)) 
...
and ((((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2) and (V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining <= 0)) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2)) => ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) = 0)) 
and ((((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2) and (V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining <= 0)) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root = 2)) => (V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining <= 0)) 
...
and (((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root = 3) and ((if (not (V48_chart_microwave_mode_logic_clear_off = 0)) then true else false) and (not V55_rlt_eval_microwave_mode_logic_ON_rlt_complete_1))) => (KP_CLEAR and (not (pre KP_CLEAR)))) 
...
and (V21_CLEAR_PRESSED => (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3))) 
and (V21_CLEAR_PRESSED => (not V81_rlt_eval_microwave_mode_logic_rlt_fired_1)) 
and (V21_CLEAR_PRESSED => ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) = 0)) 
...
and (V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining = (if V79_rlt_eval_microwave_mode_logic_rlt_fired_0 then V25_STEPS_TO_COOK else V89_chart_microwave_mode_logic_begin_state_outports_steps_remaining)) 
...
and (V47_chart_microwave_mode_logic_start = (if (V20_START_PRESSED = false) then 0 else 1)) 
and ((if (V21_CLEAR_PRESSED = false) then 0 else 1) = V48_chart_microwave_mode_logic_clear_off) 
and ((if (DOOR_CLOSED = false) then 0 else 1) = V49_chart_microwave_mode_logic_door_closed) 
and (1 = (if (not (V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4)) then 1 else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode)) 
and ((if (not (V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4)) then 1 else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode) = (if (not (V87_chart_microwave_mode_logic_begin_state_states___root = 4)) then 1 else V88_chart_microwave_mode_logic_begin_state_outports_mode)) 
and ((if (not (V87_chart_microwave_mode_logic_begin_state_states___root = 4)) then 1 else V88_chart_microwave_mode_logic_begin_state_outports_mode) = (if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 1 else V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode)) 
and (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root = (if (not ((V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root >= 1) and (V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root <= 3))) then 1 else V82_rlt_eval_microwave_mode_logic_rlt_state_2_states___root)) 
and ((if V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 then (if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) = (if V69_rlt_eval_microwave_mode_logic_ON_rlt_fired_6 then (if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V71_rlt_eval_microwave_mode_logic_ON_rlt_state_11_outports_mode) else V71_rlt_eval_microwave_mode_logic_ON_rlt_state_11_outports_mode)) 
and ((if V69_rlt_eval_microwave_mode_logic_ON_rlt_fired_6 then (if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V71_rlt_eval_microwave_mode_logic_ON_rlt_state_11_outports_mode) else V71_rlt_eval_microwave_mode_logic_ON_rlt_state_11_outports_mode) = (if V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 then (if (not (V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4)) then 1 else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode) else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode)) 
and ((if V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 then (if (not (V62_rlt_eval_microwave_mode_logic_ON_rlt_state_6_states___root = 4)) then 1 else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode) else V59_rlt_eval_microwave_mode_logic_ON_rlt_state_4_outports_mode) = V71_rlt_eval_microwave_mode_logic_ON_rlt_state_11_outports_mode) 
and (V71_rlt_eval_microwave_mode_logic_ON_rlt_state_11_outports_mode = (if ((not V81_rlt_eval_microwave_mode_logic_rlt_fired_1) and ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3))) then (if V69_rlt_eval_microwave_mode_logic_ON_rlt_fired_6 then (if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V71_rlt_eval_microwave_mode_logic_ON_rlt_state_11_outports_mode) else V71_rlt_eval_microwave_mode_logic_ON_rlt_state_11_outports_mode) else V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode)) 
...
and ((if V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1 then (if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 1 else V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode) else V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode) = V57_rlt_eval_microwave_mode_logic_ON_rlt_state_3_outports_mode) 
and (V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode = (if V81_rlt_eval_microwave_mode_logic_rlt_fired_1 then (if V77_rlt_enter_microwave_mode_logic_ON_rlt_fired_2 then (if (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) then 3 else V76_rlt_enter_microwave_mode_logic_ON_rlt_state_2_outports_mode) else V76_rlt_enter_microwave_mode_logic_ON_rlt_state_2_outports_mode) else V88_chart_microwave_mode_logic_begin_state_outports_mode)) 
and ((if V74_rlt_enter_microwave_mode_logic_ON_rlt_fired_1 then (if (not (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root = 2)) then 2 else V88_chart_microwave_mode_logic_begin_state_outports_mode) else V88_chart_microwave_mode_logic_begin_state_outports_mode) = V76_rlt_enter_microwave_mode_logic_ON_rlt_state_2_outports_mode) 
and (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = (if V74_rlt_enter_microwave_mode_logic_ON_rlt_fired_1 then (if (not (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root = 2)) then 2 else V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root) else V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root)) 
and ((if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) = (if (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2)) then 2 else V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root)) 
...
and ((if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root) = 2) 
and (2 = (if (not (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root = 2)) then 2 else V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root)) 
and ((if (not (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root = 2)) then 2 else V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root) = (if (not (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root = 2)) then 2 else V88_chart_microwave_mode_logic_begin_state_outports_mode)) 
and ((if (not (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root = 2)) then 2 else V88_chart_microwave_mode_logic_begin_state_outports_mode) = (if (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2)) then 2 else V57_rlt_eval_microwave_mode_logic_ON_rlt_state_3_outports_mode)) 
...
and ((if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) = (if (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) then 3 else V76_rlt_enter_microwave_mode_logic_ON_rlt_state_2_outports_mode)) 
...
and (3 = (if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V71_rlt_eval_microwave_mode_logic_ON_rlt_state_11_outports_mode)) 
...
and ((if V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1 then (if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 4 else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root) else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root) = V53_rlt_eval_microwave_mode_logic_ON_rlt_state_2_states___root) 
...
and (4 = (if (not (V87_chart_microwave_mode_logic_begin_state_states___root = 4)) then 4 else V87_chart_microwave_mode_logic_begin_state_states___root)) 
and ((if (not (V87_chart_microwave_mode_logic_begin_state_states___root = 4)) then 4 else V87_chart_microwave_mode_logic_begin_state_states___root) = (if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 4 else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root)) 
...
and (V102_MWI_FcnMaxI_In1 = ((pre V46_rlt__Arrow) - 1)) 
...
and (0 <=V38_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_LEFT_DIGIT_DIGIT_TO_DISPLAY) 
...
and (0 <=(if V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock then ((((V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY * 1) + (V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY * 10)) + (V38_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_LEFT_DIGIT_DIGIT_TO_DISPLAY * 60)) * 1) else (pre V25_STEPS_TO_COOK))) 
and (0 <=V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining) 
...
and (0 <=V47_chart_microwave_mode_logic_start) 
and (0 <=(if (V21_CLEAR_PRESSED = false) then 0 else 1)) 
and (0 <=(if (DOOR_CLOSED = false) then 0 else 1)) 
and (0 <=1) 
and (0 <=V88_chart_microwave_mode_logic_begin_state_outports_mode) 
and (0 <=V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root) 
...
and (0 <=(if V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 then (if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode)) 
...
and (0 <=(if V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1 then (if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 1 else V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode) else V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode)) 
and (0 <=V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode) 
and (0 <=(if V74_rlt_enter_microwave_mode_logic_ON_rlt_fired_1 then (if (not (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root = 2)) then 2 else V88_chart_microwave_mode_logic_begin_state_outports_mode) else V88_chart_microwave_mode_logic_begin_state_outports_mode)) 
and (0 <=V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root) 
and (0 <=(if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode)) 
...
and (0 <=(if V77_rlt_enter_microwave_mode_logic_ON_rlt_fired_2 then (if (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) then 3 else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root) else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root)) 
and (0 <=(if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root)) 
...
and (0 <=V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root) 
...
and (0 <=(if V54_rlt_eval_microwave_mode_logic_ON_rlt_fired_2 then (if (V53_rlt_eval_microwave_mode_logic_ON_rlt_state_2_states___root = 3) then 1 else V53_rlt_eval_microwave_mode_logic_ON_rlt_state_2_states___root) else V53_rlt_eval_microwave_mode_logic_ON_rlt_state_2_states___root)) 
...
and (0 <=(if V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1 then (if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 4 else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root) else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root)) 
and (0 <=V68_rlt_eval_microwave_mode_logic_ON_rlt_state_10_states___root) 
...
and (0 <=(if (V102_MWI_FcnMaxI_In1 > 0) then V102_MWI_FcnMaxI_In1 else 0)) 
and (0 <=(if (not V17_SETUP) then (if (V102_MWI_FcnMaxI_In1 > 0) then V102_MWI_FcnMaxI_In1 else 0) else 639)) 
and (0 <=(pre V46_rlt__Arrow)) 
...
and ((if V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step then 0 else (if KP_CLEAR then 0 else (if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY) else (pre V38_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_LEFT_DIGIT_DIGIT_TO_DISPLAY)))) <=V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining) 
and ((if V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step then 0 else (if KP_CLEAR then 0 else (if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY) else (pre V38_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_LEFT_DIGIT_DIGIT_TO_DISPLAY)))) <=(pre V25_STEPS_TO_COOK)) 
and ((if V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step then 0 else (if KP_CLEAR then 0 else (if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY) else (pre V38_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_LEFT_DIGIT_DIGIT_TO_DISPLAY)))) <=(if (V102_MWI_FcnMaxI_In1 > 0) then V102_MWI_FcnMaxI_In1 else 0)) 
and ((if V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step then 0 else (if KP_CLEAR then 0 else (if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY) else (pre V38_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_LEFT_DIGIT_DIGIT_TO_DISPLAY)))) <=(if (not V17_SETUP) then (if (V102_MWI_FcnMaxI_In1 > 0) then V102_MWI_FcnMaxI_In1 else 0) else 639)) 
and ((if V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step then 0 else (if KP_CLEAR then 0 else (if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY) else (pre V38_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_LEFT_DIGIT_DIGIT_TO_DISPLAY)))) <=(pre V46_rlt__Arrow)) 
and (V38_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_LEFT_DIGIT_DIGIT_TO_DISPLAY <=9) 
and (V38_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_LEFT_DIGIT_DIGIT_TO_DISPLAY <=(if KP_9 then 9 else 10)) 
and (V38_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_LEFT_DIGIT_DIGIT_TO_DISPLAY <=(if (KP_9 and (not (pre KP_9))) then 9 else 10)) 
and (V38_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_LEFT_DIGIT_DIGIT_TO_DISPLAY <=10) 
and (V38_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_LEFT_DIGIT_DIGIT_TO_DISPLAY <=60) 
...
and ((if V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step then (if KP_CLEAR then 0 else (if (if ((if KP_0 then 0 else (if KP_1 then 1 else (if KP_2 then 2 else (if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))))) <= 9) then true else false) then (if KP_0 then 0 else (if KP_1 then 1 else (if KP_2 then 2 else (if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))))) else 0)) else (if KP_CLEAR then 0 else (if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) else (pre V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY)))) <=(if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) 
and ((if V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step then (if KP_CLEAR then 0 else (if (if ((if KP_0 then 0 else (if KP_1 then 1 else (if KP_2 then 2 else (if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))))) <= 9) then true else false) then (if KP_0 then 0 else (if KP_1 then 1 else (if KP_2 then 2 else (if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))))) else 0)) else (if KP_CLEAR then 0 else (if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) else (pre V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY)))) <=(if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10))))))))) 
and ((if V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step then (if KP_CLEAR then 0 else (if (if ((if KP_0 then 0 else (if KP_1 then 1 else (if KP_2 then 2 else (if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))))) <= 9) then true else false) then (if KP_0 then 0 else (if KP_1 then 1 else (if KP_2 then 2 else (if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))))) else 0)) else (if KP_CLEAR then 0 else (if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) else (pre V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY)))) <=(if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))) 
and ((if V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step then (if KP_CLEAR then 0 else (if (if ((if KP_0 then 0 else (if KP_1 then 1 else (if KP_2 then 2 else (if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))))) <= 9) then true else false) then (if KP_0 then 0 else (if KP_1 then 1 else (if KP_2 then 2 else (if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))))) else 0)) else (if KP_CLEAR then 0 else (if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) else (pre V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY)))) <=(if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10))))))) 
and ((if V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step then (if KP_CLEAR then 0 else (if (if ((if KP_0 then 0 else (if KP_1 then 1 else (if KP_2 then 2 else (if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))))) <= 9) then true else false) then (if KP_0 then 0 else (if KP_1 then 1 else (if KP_2 then 2 else (if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))))) else 0)) else (if KP_CLEAR then 0 else (if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) else (pre V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY)))) <=(if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))) 
and ((if V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step then (if KP_CLEAR then 0 else (if (if ((if KP_0 then 0 else (if KP_1 then 1 else (if KP_2 then 2 else (if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))))) <= 9) then true else false) then (if KP_0 then 0 else (if KP_1 then 1 else (if KP_2 then 2 else (if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))))) else 0)) else (if KP_CLEAR then 0 else (if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) else (pre V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY)))) <=(if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10))))) 
and ((if V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step then (if KP_CLEAR then 0 else (if (if ((if KP_0 then 0 else (if KP_1 then 1 else (if KP_2 then 2 else (if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))))) <= 9) then true else false) then (if KP_0 then 0 else (if KP_1 then 1 else (if KP_2 then 2 else (if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))))) else 0)) else (if KP_CLEAR then 0 else (if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) else (pre V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY)))) <=(if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))) 
and ((if V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step then (if KP_CLEAR then 0 else (if (if ((if KP_0 then 0 else (if KP_1 then 1 else (if KP_2 then 2 else (if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))))) <= 9) then true else false) then (if KP_0 then 0 else (if KP_1 then 1 else (if KP_2 then 2 else (if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))))) else 0)) else (if KP_CLEAR then 0 else (if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) else (pre V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY)))) <=(if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10))) 
and (V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY <=9) 
and (V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY <=(if KP_9 then 9 else 10)) 
and (V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY <=(if (KP_9 and (not (pre KP_9))) then 9 else 10)) 
and (V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY <=10) 
and (V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY <=60) 
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=1) 
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root) 
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=(pre V96_microwave_microwave_mode_logic_mode)) 
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=(if KP_1 then 1 else (if KP_2 then 2 else (if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))))) 
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=(if V86_chart_microwave_mode_logic_rlt_evtInitStep then (if (not (V87_chart_microwave_mode_logic_begin_state_states___root = 4)) then 1 else V88_chart_microwave_mode_logic_begin_state_outports_mode) else (if ((not V81_rlt_eval_microwave_mode_logic_rlt_fired_1) and ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3))) then (if V69_rlt_eval_microwave_mode_logic_ON_rlt_fired_6 then (if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V71_rlt_eval_microwave_mode_logic_ON_rlt_state_11_outports_mode) else V71_rlt_eval_microwave_mode_logic_ON_rlt_state_11_outports_mode) else V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode))) 
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root) 
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=(if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode)) 
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=(if KP_2 then 2 else (if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))))))) 
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=(if V77_rlt_enter_microwave_mode_logic_ON_rlt_fired_2 then (if (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) then 3 else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root) else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root)) 
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=(if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root)) 
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=(if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))) 
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=(if V86_chart_microwave_mode_logic_rlt_evtInitStep then V85_rlt_enter_microwave_mode_logic_rlt_state_2_states___root else (if ((not V81_rlt_eval_microwave_mode_logic_rlt_fired_1) and ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3))) then (if V69_rlt_eval_microwave_mode_logic_ON_rlt_fired_6 then (if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) else V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root))) 
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=(pre V90_chart_microwave_mode_logic_final_state_states___root)) 
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=4) 
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=5) 
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=6) 
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=(if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))))) 
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=(if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))) 
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=7) 
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=(if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))) 
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=(if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))) 
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=8) 
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=(if KP_8 then 8 else (if KP_9 then 9 else 10))) 
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=9) 
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=(if KP_9 then 9 else 10)) 
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=(if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) 
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=(if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10))))))))) 
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=(if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))) 
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=(if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10))))))) 
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=(if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))) 
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=(if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10))))) 
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=(if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))) 
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=(if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10))) 
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=(if (KP_9 and (not (pre KP_9))) then 9 else 10)) 
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=10) 
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=60) 
and ((if ((V25_STEPS_TO_COOK > 0) = false) then 0 else 1) <=(if (not V17_SETUP) then (if (V102_MWI_FcnMaxI_In1 > 0) then V102_MWI_FcnMaxI_In1 else 0) else 639)) 
and ((if V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step then 0 else (if KP_CLEAR then 0 else (if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (pre V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY) else (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY)))) <=(if V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock then (if V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step then 0 else (if KP_CLEAR then 0 else (if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (pre V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY) else (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY)))) else (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY))) 
and ((if V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step then 0 else (if KP_CLEAR then 0 else (if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (pre V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY) else (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY)))) <=(V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY * 10)) 
and ((if V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step then 0 else (if KP_CLEAR then 0 else (if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (pre V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY) else (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY)))) <=(if V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 then (V63_rlt_eval_microwave_mode_logic_ON_rlt_state_6_outports_steps_remaining - 1) else V63_rlt_eval_microwave_mode_logic_ON_rlt_state_6_outports_steps_remaining)) 
...
and ((if V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step then 0 else (if KP_CLEAR then 0 else (if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (pre V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY) else (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY)))) <=(if (V102_MWI_FcnMaxI_In1 > 0) then V102_MWI_FcnMaxI_In1 else 0)) 
and ((if V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step then 0 else (if KP_CLEAR then 0 else (if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (pre V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY) else (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY)))) <=(if (not V17_SETUP) then (if (V102_MWI_FcnMaxI_In1 > 0) then V102_MWI_FcnMaxI_In1 else 0) else 639)) 
and ((if V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step then 0 else (if KP_CLEAR then 0 else (if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (pre V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY) else (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY)))) <=(pre V46_rlt__Arrow)) 
and ((if V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock then (if V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step then 0 else (if KP_CLEAR then 0 else (if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (pre V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY) else (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY)))) else (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY)) <=9) 
and ((if V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock then (if V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step then 0 else (if KP_CLEAR then 0 else (if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (pre V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY) else (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY)))) else (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY)) <=(if KP_9 then 9 else 10)) 
and ((if V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock then (if V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step then 0 else (if KP_CLEAR then 0 else (if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (pre V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY) else (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY)))) else (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY)) <=(if (KP_9 and (not (pre KP_9))) then 9 else 10)) 
and ((if V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock then (if V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step then 0 else (if KP_CLEAR then 0 else (if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (pre V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY) else (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY)))) else (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY)) <=10) 
and ((if V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock then (if V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step then 0 else (if KP_CLEAR then 0 else (if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (pre V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY) else (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY)))) else (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY)) <=60) 
and ((if (DOOR_CLOSED = false) then 0 else 1) <=(if V74_rlt_enter_microwave_mode_logic_ON_rlt_fired_1 then (if (not (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root = 2)) then 2 else V88_chart_microwave_mode_logic_begin_state_outports_mode) else V88_chart_microwave_mode_logic_begin_state_outports_mode)) 
and (1 <=(if KP_1 then 1 else (if KP_2 then 2 else (if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))))) 
and (1 <=(if V86_chart_microwave_mode_logic_rlt_evtInitStep then (if (not (V87_chart_microwave_mode_logic_begin_state_states___root = 4)) then 1 else V88_chart_microwave_mode_logic_begin_state_outports_mode) else (if ((not V81_rlt_eval_microwave_mode_logic_rlt_fired_1) and ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3))) then (if V69_rlt_eval_microwave_mode_logic_ON_rlt_fired_6 then (if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V71_rlt_eval_microwave_mode_logic_ON_rlt_state_11_outports_mode) else V71_rlt_eval_microwave_mode_logic_ON_rlt_state_11_outports_mode) else V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode))) 
and (1 <=(if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode)) 
and (1 <=(if KP_2 then 2 else (if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))))))) 
and (1 <=(if V86_chart_microwave_mode_logic_rlt_evtInitStep then V85_rlt_enter_microwave_mode_logic_rlt_state_2_states___root else (if ((not V81_rlt_eval_microwave_mode_logic_rlt_fired_1) and ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3))) then (if V69_rlt_eval_microwave_mode_logic_ON_rlt_fired_6 then (if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) else V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root))) 
and (1 <=(if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) 
and (1 <=(if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10))))))))) 
and (V88_chart_microwave_mode_logic_begin_state_outports_mode <=V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode) 
and (V88_chart_microwave_mode_logic_begin_state_outports_mode <=(if V74_rlt_enter_microwave_mode_logic_ON_rlt_fired_1 then (if (not (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root = 2)) then 2 else V88_chart_microwave_mode_logic_begin_state_outports_mode) else V88_chart_microwave_mode_logic_begin_state_outports_mode)) 
and (V88_chart_microwave_mode_logic_begin_state_outports_mode <=V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root) 
and (V88_chart_microwave_mode_logic_begin_state_outports_mode <=(if V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1 then (if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 4 else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root) else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root)) 
and (V88_chart_microwave_mode_logic_begin_state_outports_mode <=V87_chart_microwave_mode_logic_begin_state_states___root) 
and (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root <=V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root) 
and (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root <=(if V77_rlt_enter_microwave_mode_logic_ON_rlt_fired_2 then (if (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) then 3 else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root) else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root)) 
...
and ((if V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 then (if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) <=(if V54_rlt_eval_microwave_mode_logic_ON_rlt_fired_2 then (if (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2)) then 2 else V57_rlt_eval_microwave_mode_logic_ON_rlt_state_3_outports_mode) else V57_rlt_eval_microwave_mode_logic_ON_rlt_state_3_outports_mode)) 
and ((if V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 then (if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) <=(if V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1 then (if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 1 else V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode) else V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode)) 
and ((if V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 then (if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) <=V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode) 
and ((if V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 then (if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) <=V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root) 
...
and ((if V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 then (if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) <=(if V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1 then (if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 4 else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root) else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root)) 
and ((if V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 then (if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) <=V68_rlt_eval_microwave_mode_logic_ON_rlt_state_10_states___root) 
and ((if V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 then (if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) <=V87_chart_microwave_mode_logic_begin_state_states___root) 
...
and ((if V54_rlt_eval_microwave_mode_logic_ON_rlt_fired_2 then (if (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2)) then 2 else V57_rlt_eval_microwave_mode_logic_ON_rlt_state_3_outports_mode) else V57_rlt_eval_microwave_mode_logic_ON_rlt_state_3_outports_mode) <=V68_rlt_eval_microwave_mode_logic_ON_rlt_state_10_states___root) 
...
and (V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode <=V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root) 
and (V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode <=(if V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1 then (if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 4 else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root) else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root)) 
and (V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode <=V87_chart_microwave_mode_logic_begin_state_states___root) 
and (V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode <=(pre V90_chart_microwave_mode_logic_final_state_states___root)) 
and (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root <=(pre V90_chart_microwave_mode_logic_final_state_states___root)) 
and ((if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) <=(if V77_rlt_enter_microwave_mode_logic_ON_rlt_fired_2 then (if (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) then 3 else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root) else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root)) 
and ((if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) <=(if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root)) 
and ((if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) <=(if V86_chart_microwave_mode_logic_rlt_evtInitStep then V85_rlt_enter_microwave_mode_logic_rlt_state_2_states___root else (if ((not V81_rlt_eval_microwave_mode_logic_rlt_fired_1) and ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3))) then (if V69_rlt_eval_microwave_mode_logic_ON_rlt_fired_6 then (if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) else V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root))) 
and ((if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) <=(pre V90_chart_microwave_mode_logic_final_state_states___root)) 
and ((if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) <=4) 
and ((if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) <=5) 
and ((if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) <=6) 
and ((if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) <=7) 
and ((if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) <=8) 
and ((if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) <=9) 
...
and ((if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) <=4) 
and ((if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) <=5) 
and ((if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) <=6) 
and ((if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) <=7) 
and ((if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) <=8) 
and ((if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) <=9) 
...
and ((if ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3)) then 0 else V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root) <=(if (V102_MWI_FcnMaxI_In1 > 0) then V102_MWI_FcnMaxI_In1 else 0)) 
and ((if ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3)) then 0 else V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root) <=(pre V46_rlt__Arrow)) 
...
and ((if ((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root >= 1) and (V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root <= 3)) then 0 else V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root) <=V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root) 
...
and ((if ((V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root >= 1) and (V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root <= 3)) then 0 else V58_rlt_eval_microwave_mode_logic_ON_rlt_state_4_states___root) <=(if (not V17_SETUP) then (if (V102_MWI_FcnMaxI_In1 > 0) then V102_MWI_FcnMaxI_In1 else 0) else 639)) 
...
and ((if V54_rlt_eval_microwave_mode_logic_ON_rlt_fired_2 then (if (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2)) then 2 else V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root) else V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root) <=V68_rlt_eval_microwave_mode_logic_ON_rlt_state_10_states___root) 
...
and (4 <=(if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10))))))) 
and (5 <=(if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))) 
and (5 <=(if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))) 
and (6 <=(if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))) 
and (6 <=(if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10))))) 
...
and ((if (V102_MWI_FcnMaxI_In1 > 0) then V102_MWI_FcnMaxI_In1 else 0) <=(pre V46_rlt__Arrow)) 
...
and ((if V86_chart_microwave_mode_logic_rlt_evtInitStep then V89_chart_microwave_mode_logic_begin_state_outports_steps_remaining else (if ((not V81_rlt_eval_microwave_mode_logic_rlt_fired_1) and ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3))) then (if V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 then (V63_rlt_eval_microwave_mode_logic_ON_rlt_state_6_outports_steps_remaining - 1) else V63_rlt_eval_microwave_mode_logic_ON_rlt_state_6_outports_steps_remaining) else V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining)) <=(if V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 then 0 else V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining)) 
and ((if V60_rlt_eval_microwave_mode_logic_ON_rlt_fired_4 then 0 else V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining) <=V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining) 
and (V80_rlt_eval_microwave_mode_logic_rlt_state_1_outports_steps_remaining <=((((V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY * 1) + (V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY * 10)) + (V38_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_LEFT_DIGIT_DIGIT_TO_DISPLAY * 60)) * 1)) 
and (((((V40_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_RIGHT_DIGIT_DIGIT_TO_DISPLAY * 1) + (V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY * 10)) + (V38_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_LEFT_DIGIT_DIGIT_TO_DISPLAY * 60)) * 1) <=639) 
...
and (10 <=60) 
and (60 <=639) 
and ((if V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step then 0 else (if KP_CLEAR then 0 else (if (if ((if (KP_0 and (not (pre KP_0))) then 0 else (if (KP_1 and (not (pre KP_1))) then 1 else (if (KP_2 and (not (pre KP_2))) then 2 else (if (KP_3 and (not (pre KP_3))) then 3 else (if (KP_4 and (not (pre KP_4))) then 4 else (if (KP_5 and (not (pre KP_5))) then 5 else (if (KP_6 and (not (pre KP_6))) then 6 else (if (KP_7 and (not (pre KP_7))) then 7 else (if (KP_8 and (not (pre KP_8))) then 8 else (if (KP_9 and (not (pre KP_9))) then 9 else 10)))))))))) <= 9) then true else false) then (pre V39_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_MIDDLE_DIGIT_DIGIT_TO_DISPLAY) else (pre V38_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_LEFT_DIGIT_DIGIT_TO_DISPLAY)))) <=V38_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_LEFT_DIGIT_DIGIT_TO_DISPLAY) 
and (V38_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_LEFT_DIGIT_DIGIT_TO_DISPLAY <=(V38_microwave_microwave_KEYPAD_PROCESSING_DISPLAY_LEFT_DIGIT_DIGIT_TO_DISPLAY * 60)) 
...
and (V88_chart_microwave_mode_logic_begin_state_outports_mode <=V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root) 
and (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root <=(pre V96_microwave_microwave_mode_logic_mode)) 
and ((pre V96_microwave_microwave_mode_logic_mode) <=(if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root)) 
and ((if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) <=(if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))) 
...
and ((pre V92_chart_microwave_mode_logic_steps_remaining) <=639) 
...
and (10 <=60) 
and (60 <=639) 
and ((pre V25_STEPS_TO_COOK) <=639) 
and (V47_chart_microwave_mode_logic_start <=1) 
and (1 <=V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root) 
and (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root <=(pre V96_microwave_microwave_mode_logic_mode)) 
and ((pre V96_microwave_microwave_mode_logic_mode) <=(if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root)) 
and ((if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) <=(if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))) 
and ((if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))))) <=(if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))))) 
...
and (10 <=60) 
and (60 <=639) 
and ((if (V21_CLEAR_PRESSED = false) then 0 else 1) <=1) 
and (1 <=V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root) 
and (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root <=(pre V96_microwave_microwave_mode_logic_mode)) 
and ((pre V96_microwave_microwave_mode_logic_mode) <=(if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root)) 
and ((if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) <=(if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))) 
...
and (10 <=60) 
and (60 <=639) 
and ((if (DOOR_CLOSED = false) then 0 else 1) <=1) 
and (1 <=V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root) 
and (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root <=(pre V96_microwave_microwave_mode_logic_mode)) 
and ((pre V96_microwave_microwave_mode_logic_mode) <=(if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root)) 
and ((if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) <=(if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))) 
...
and (10 <=60) 
and (60 <=639) 
and ((if V65_rlt_eval_microwave_mode_logic_ON_rlt_fired_5 then (if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) <=(if V86_chart_microwave_mode_logic_rlt_evtInitStep then (if (not (V87_chart_microwave_mode_logic_begin_state_states___root = 4)) then 1 else V88_chart_microwave_mode_logic_begin_state_outports_mode) else (if ((not V81_rlt_eval_microwave_mode_logic_rlt_fired_1) and ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3))) then (if V69_rlt_eval_microwave_mode_logic_ON_rlt_fired_6 then (if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V71_rlt_eval_microwave_mode_logic_ON_rlt_state_11_outports_mode) else V71_rlt_eval_microwave_mode_logic_ON_rlt_state_11_outports_mode) else V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode))) 
and ((if V86_chart_microwave_mode_logic_rlt_evtInitStep then (if (not (V87_chart_microwave_mode_logic_begin_state_states___root = 4)) then 1 else V88_chart_microwave_mode_logic_begin_state_outports_mode) else (if ((not V81_rlt_eval_microwave_mode_logic_rlt_fired_1) and ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3))) then (if V69_rlt_eval_microwave_mode_logic_ON_rlt_fired_6 then (if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V71_rlt_eval_microwave_mode_logic_ON_rlt_state_11_outports_mode) else V71_rlt_eval_microwave_mode_logic_ON_rlt_state_11_outports_mode) else V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode)) <=(if V77_rlt_enter_microwave_mode_logic_ON_rlt_fired_2 then (if (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) then 3 else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root) else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root)) 
...
and (10 <=60) 
and (60 <=639) 
and ((if V54_rlt_eval_microwave_mode_logic_ON_rlt_fired_2 then (if (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2)) then 2 else V57_rlt_eval_microwave_mode_logic_ON_rlt_state_3_outports_mode) else V57_rlt_eval_microwave_mode_logic_ON_rlt_state_3_outports_mode) <=(if V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1 then (if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 1 else V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode) else V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode)) 
and ((if V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1 then (if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 1 else V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode) else V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode) <=V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode) 
and (V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode <=(if V77_rlt_enter_microwave_mode_logic_ON_rlt_fired_2 then (if (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) then 3 else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root) else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root)) 
and ((if V77_rlt_enter_microwave_mode_logic_ON_rlt_fired_2 then (if (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) then 3 else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root) else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root) <=(if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root)) 
and ((if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) <=(if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))) 
and ((if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))))) <=(if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))))) 
and ((if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))) <=(if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))) 
...
and (60 <=639) 
and ((if V74_rlt_enter_microwave_mode_logic_ON_rlt_fired_1 then (if (not (V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root = 2)) then 2 else V88_chart_microwave_mode_logic_begin_state_outports_mode) else V88_chart_microwave_mode_logic_begin_state_outports_mode) <=V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root) 
and (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root <=(if V77_rlt_enter_microwave_mode_logic_ON_rlt_fired_2 then (if (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) then 3 else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root) else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root)) 
and ((if V77_rlt_enter_microwave_mode_logic_ON_rlt_fired_2 then (if (not (V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root = 3)) then 3 else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root) else V75_rlt_enter_microwave_mode_logic_ON_rlt_state_2_states___root) <=(if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root)) 
and ((if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) <=(if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))) 
and ((if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))))) <=(if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))))) 
and ((if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))) <=(if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))) 
...
and (10 <=60) 
and (60 <=639) 
and ((if (not (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root = 2)) then 2 else V66_rlt_eval_microwave_mode_logic_ON_rlt_state_8_outports_mode) <=(if KP_2 then 2 else (if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))))))) 
and ((if KP_2 then 2 else (if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))) <=(if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))))) 
and ((if KP_3 then 3 else (if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))))) <=(if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))))) 
and ((if KP_4 then 4 else (if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))) <=(if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10)))))) 
and ((if KP_5 then 5 else (if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))) <=(if KP_6 then 6 else (if KP_7 then 7 else (if KP_8 then 8 else (if KP_9 then 9 else 10))))) 
...
and ((if (V53_rlt_eval_microwave_mode_logic_ON_rlt_state_2_states___root = 3) then 1 else V53_rlt_eval_microwave_mode_logic_ON_rlt_state_2_states___root) <=(if V54_rlt_eval_microwave_mode_logic_ON_rlt_fired_2 then (if (V53_rlt_eval_microwave_mode_logic_ON_rlt_state_2_states___root = 3) then 1 else V53_rlt_eval_microwave_mode_logic_ON_rlt_state_2_states___root) else V53_rlt_eval_microwave_mode_logic_ON_rlt_state_2_states___root)) 
and ((if V54_rlt_eval_microwave_mode_logic_ON_rlt_fired_2 then (if (V53_rlt_eval_microwave_mode_logic_ON_rlt_state_2_states___root = 3) then 1 else V53_rlt_eval_microwave_mode_logic_ON_rlt_state_2_states___root) else V53_rlt_eval_microwave_mode_logic_ON_rlt_state_2_states___root) <=(if V54_rlt_eval_microwave_mode_logic_ON_rlt_fired_2 then (if (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2)) then 2 else V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root) else V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root)) 
and ((if V54_rlt_eval_microwave_mode_logic_ON_rlt_fired_2 then (if (not (V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root = 2)) then 2 else V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root) else V56_rlt_eval_microwave_mode_logic_ON_rlt_state_3_states___root) <=(if V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1 then (if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 4 else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root) else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root)) 
and ((if V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1 then (if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 4 else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root) else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root) <=4) 
and (4 <=5) 
and (5 <=6) 
and (6 <=7) 
...
and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <=(if V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1 then (if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 4 else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root) else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root)) 
and ((if V51_rlt_eval_microwave_mode_logic_ON_rlt_fired_1 then (if (not (V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root = 4)) then 4 else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root) else V52_rlt_eval_microwave_mode_logic_ON_rlt_state_1_states___root) <=4) 
and (4 <=5) 
and (5 <=6) 
and (6 <=7) 
...
and (10 <=60) 
and (60 <=639) 
and ((if (V68_rlt_eval_microwave_mode_logic_ON_rlt_state_10_states___root = 2) then 1 else V68_rlt_eval_microwave_mode_logic_ON_rlt_state_10_states___root) <=V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root) 
and (V67_rlt_eval_microwave_mode_logic_ON_rlt_state_9_states___root <=V68_rlt_eval_microwave_mode_logic_ON_rlt_state_10_states___root) 
and (V68_rlt_eval_microwave_mode_logic_ON_rlt_state_10_states___root <=(if V86_chart_microwave_mode_logic_rlt_evtInitStep then V85_rlt_enter_microwave_mode_logic_rlt_state_2_states___root else (if ((not V81_rlt_eval_microwave_mode_logic_rlt_fired_1) and ((V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3))) then (if V69_rlt_eval_microwave_mode_logic_ON_rlt_fired_6 then (if (not (V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root = 3)) then 3 else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) else V70_rlt_eval_microwave_mode_logic_ON_rlt_state_11_states___root) else V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root))) 
...
and (10 <=60) 
and (60 <=639) 
and (V102_MWI_FcnMaxI_In1 <=(if (V102_MWI_FcnMaxI_In1 > 0) then V102_MWI_FcnMaxI_In1 else 0)) 
and ((if (V102_MWI_FcnMaxI_In1 > 0) then V102_MWI_FcnMaxI_In1 else 0) <=(if (not V17_SETUP) then (if (V102_MWI_FcnMaxI_In1 > 0) then V102_MWI_FcnMaxI_In1 else 0) else 639)) 
and ((if (not V17_SETUP) then (if (V102_MWI_FcnMaxI_In1 > 0) then V102_MWI_FcnMaxI_In1 else 0) else 639) <=639) 
and ((pre V46_rlt__Arrow) <=639) 
and  true ));
tel.
