...
let
  OK = ((not (not V218_zz186)) or V219_zz187);
  ...
  V30_OK0 = ((not V223_zz191) or V224_zz192);
  V31_OK1 = ((not V225_zz193) or V226_zz194);
...
and (((V147_zz115 >= 2) and (V147_zz115 <= 8)) = ((not (not V218_zz186)) or V219_zz187)) 
and (((not (not V218_zz186)) or V219_zz187) = true) 
and (true = (V87_zz55 <= 6)) 
...
and ((not ((if ((V218_zz186 = true) = false) then 0 else 1) = 0)) = (not (not V218_zz186))) 
...
and ((V70_zz38 = 6) => (((((not cancel) and (not brakePedal)) and V213_zz181) and V214_zz182) and validInputs)) 
...
and (V249_zz217 => (((((not cancel) and (not brakePedal)) and V213_zz181) and V214_zz182) and validInputs)) 
and ((V77_zz45 = 5) => ((V140_zz108 >= 3) and (V140_zz108 <= 6))) 
and (V62_zz30 => (V140_zz108 = 4)) 
and (V249_zz217 => ((V140_zz108 >= 3) and (V140_zz108 <= 6))) 
...
and ((V72_zz40 = 6) => (not cancel)) 
and (V74_zz42 => (not cancel)) 
and (V74_zz42 => (V127_zz95 <= 6)) 
and ((V70_zz38 = 6) => (V127_zz95 <= 6)) 
and (V248_zz216 => (not cancel)) 
...
and ((if ((not V177_zz145) and ((V179_zz147 >= 2) and (V179_zz147 <= 8))) then V144_zz112 else V173_zz141) => ((not V216_zz184) and decelSet)) 
...
and ((not V218_zz186) => ((not ((V133_zz101 >= 3) and (V133_zz101 <= 6))) and ((V95_zz63 >= 3) and (V95_zz63 <= 6)))) 
...
and (V233_zz201 => (((not cancel) and (not brakePedal)) and V213_zz181)) 
