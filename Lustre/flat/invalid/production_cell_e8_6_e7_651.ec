...
-- 133 implications. 
assert (true -> ((V86_signal = (not V16_MayMove1)) 
and ((not V17_MayMove2) = V90_signal) 
and ((if V58_on then true else (if V20_stop then false else (pre V21_moving))) = (V18_start1 and V19_start2)) 
and ((V18_start1 and V19_start2) = V21_moving) 
and (V21_moving = V58_on) 
...
and ((pre V90_signal) => (V75_signal or (not (pre V75_signal)))) 
and ((pre V90_signal) => (not (pre V75_signal))) 
and (((not V18_start1) and (not V19_start2)) => (if V21_moving then MaySafelyMove else true)) 
and (((not V18_start1) and (not V19_start2)) => V20_stop) 
and (((not V18_start1) and (not V19_start2)) => (V90_signal or (not (pre V90_signal)))) 
and (((not V18_start1) and (not V19_start2)) => (not V18_start1)) 
and (((not V18_start1) and (not V19_start2)) => (V86_signal or (not (pre V86_signal)))) 
and ((not (pre V66_signal)) => (V66_signal or (not (pre V66_signal)))) 
and ((not V18_start1) => (if V21_moving then MaySafelyMove else true)) 
...
and ((not V19_start2) => (if V21_moving then MaySafelyMove else true)) 
and ((not V19_start2) => V20_stop) 
and ((not V19_start2) => (V90_signal or (not (pre V90_signal)))) 
...
and (((V18_start1 and V19_start2) and V20_stop) => (if V58_on then true else (if V20_stop then false else (pre V21_moving)))) 
...
and (V86_signal => V20_stop) 
and (V86_signal => (V86_signal or (not (pre V86_signal)))) 
and ((if V20_stop then false else (pre V21_moving)) => (pre V21_moving)) 
and ((not V20_stop) => (not ((V18_start1 and V19_start2) and V20_stop))) 
and ((not V20_stop) => (if V21_moving then MaySafelyMove else true)) 
...
and ((if V58_on then true else (if V20_stop then false else (pre V21_moving))) => V19_start2) 
...
and ((not V20_stop) => TryToMove1) 
and ((V16_MayMove1 and (not (pre TryToMove2))) => (not (pre TryToMove2))) 
and ((not V20_stop) => V19_start2) 
and ((not V20_stop) => (TryToMove2 or (not (pre TryToMove2)))) 
...
and ((not (pre V86_signal)) => ((V86_signal or (not (pre V86_signal))) or (V90_signal or (not (pre V90_signal))))) 
...
and ((not (TryToMove1 or (not (pre TryToMove1)))) => V86_signal) 
and ((not (TryToMove1 or (not (pre TryToMove1)))) => V20_stop) 
...
and ((not V20_stop) => (if V58_on then true else (if V20_stop then false else (pre V21_moving)))) 
...
and ((not V20_stop) => (TryToMove1 or (not (pre TryToMove1)))) 
and (V16_MayMove1 => (TryToMove1 or (not (pre TryToMove1)))) 
and ((if V58_on then true else (if V20_stop then false else (pre V21_moving))) => V18_start1) 
