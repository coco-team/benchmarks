...
and (false = (pre V20_early)) 
and ((pre V20_early) = (pre V19_late)) 
and ((pre V19_late) = (V63_diff >= 10)) 
and ((V63_diff >= 10) = (V63_diff > 0)) 
and ((V63_diff > 0) = ((not V19_late) and (pre V20_early))) 
and (((not V19_late) and (pre V20_early)) = (if (pre V20_early) then (V63_diff > 0) else (V63_diff >= 10))) 
...
and (0 = V63_diff) 
and (V63_diff = V65_PC) 
and (V65_PC = (if false then 0 else (if (beacon and second) then (V65_PC + V64_incr) else V65_PC))) 
...
and ((pre V63_diff) <=1) 
and ((- 10) <=(pre V63_diff)) 
and ((pre V63_diff) <=(if (second and (not beacon)) then 2 else 0)) 
