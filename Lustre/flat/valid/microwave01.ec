...
var
  ...
  V85_rlt_enter_microwave_mode_logic_rltCheckEntryStateConsistency_0: bool;
  V86_rlt_enter_microwave_mode_logic_rlt_state_2_states___root: int;
  V87_chart_microwave_mode_logic_rlt_evtInitStep: bool;
  V88_chart_microwave_mode_logic_begin_state_states___root: int;
  V89_chart_microwave_mode_logic_begin_state_outports_mode: int;
  V90_chart_microwave_mode_logic_begin_state_outports_steps_remaining: int;
  V91_chart_microwave_mode_logic_final_state_states___root: int;
  V93_chart_microwave_mode_logic_steps_remaining: int;
  V94_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_MINUTES__QUOTIENT: int;
  V95_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT: int;
  V96_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__REMAINDER: int;
  V97_microwave_microwave_mode_logic_mode: int;
  V98_MWI_FcnMaxI_In16: int;
  V99_MWI_FcnMaxI_In15: int;
  V100_MWI_FcnMaxI_In13: int;
  V101_MWI_FcnMaxI_In12: int;
  V102_MWI_FcnMaxI_In11: int;
  V103_MWI_FcnMaxI_In1: int;
  V104_p3: bool;
  V105_p4: bool;
  V106_p5: bool;
  V107_p6: bool;
  ...
  V137_p36: bool;
  V138_p37: bool;
  V139_rltTruncByConv2: bool;
  V140_rltTruncByConv1: bool;
  V141_rltTruncByConv: bool;

let
  OK = ((V78_rlt_enter_microwave_mode_logic_ON_rlt_state_4_states___root = 2) 
  or (V78_rlt_enter_microwave_mode_logic_ON_rlt_state_4_states___root = 3));
  V17_SETUP = (if (1 = V97_microwave_microwave_mode_logic_mode) then true else 
  false);
  V18_COOKING = (if (2 = V97_microwave_microwave_mode_logic_mode) then true 
  else false);
  V19_SUSPENDED = (if (3 = V97_microwave_microwave_mode_logic_mode) then true 
  else false);
  ...
  * 60)) * 1) else (pre V25_STEPS_TO_COOK))));
  ...
  -> (if (1 = (pre V97_microwave_microwave_mode_logic_mode)) then true else 
  false));
  V37_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_init_step = (
  true -> (if (not 
  V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock) then 
  ...
  V100_MWI_FcnMaxI_In13 > 0) then V100_MWI_FcnMaxI_In13 else 0) else 639));
  V42_rlt__Arrow4 = (639 -> (if (not V19_SUSPENDED) then (if (
  V101_MWI_FcnMaxI_In12 > 0) then V101_MWI_FcnMaxI_In12 else 0) else 639));
  V43_rlt__Arrow3 = (639 -> (if (not (not V18_COOKING)) then (if (
  V98_MWI_FcnMaxI_In16 > 0) then V98_MWI_FcnMaxI_In16 else 0) else 639));
  V44_rlt__Arrow2 = (639 -> (if (not (not V19_SUSPENDED)) then (if (
  V99_MWI_FcnMaxI_In15 > 0) then V99_MWI_FcnMaxI_In15 else 0) else 639));
  V45_rlt__Arrow1 = (639 -> (if (not V18_COOKING) then (if (
  V102_MWI_FcnMaxI_In11 > 0) then V102_MWI_FcnMaxI_In11 else 0) else 639));
  V46_rlt__Arrow = (639 -> (if (not V17_SETUP) then (if (V103_MWI_FcnMaxI_In1 > 
  0) then V103_MWI_FcnMaxI_In1 else 0) else 639));
  ...
  V74_rlt_enter_microwave_mode_logic_ON_rlt_fired_1 then (if (not (
  V72_rlt_enter_microwave_mode_logic_ON_rlt_state_1_states___root = 2)) then 2 
  else V89_chart_microwave_mode_logic_begin_state_outports_mode) else 
  V89_chart_microwave_mode_logic_begin_state_outports_mode);
  ...
  V88_chart_microwave_mode_logic_begin_state_states___root = 4);
  ...
  V90_chart_microwave_mode_logic_begin_state_outports_steps_remaining);
  V81_rlt_eval_microwave_mode_logic_rlt_fired_1 = (
  V79_rlt_eval_microwave_mode_logic_rlt_fired_0 and ((
  V88_chart_microwave_mode_logic_begin_state_states___root = 4) and ((if (
  ...
  V88_chart_microwave_mode_logic_begin_state_states___root = 4) then 0 else 
  V88_chart_microwave_mode_logic_begin_state_states___root) else 
  V88_chart_microwave_mode_logic_begin_state_states___root);
  ...
  V89_chart_microwave_mode_logic_begin_state_outports_mode);
  V85_rlt_enter_microwave_mode_logic_rltCheckEntryStateConsistency_0 = (((
  V86_rlt_enter_microwave_mode_logic_rlt_state_2_states___root >= 1) and (
  V86_rlt_enter_microwave_mode_logic_rlt_state_2_states___root <= 3)) or (
  V86_rlt_enter_microwave_mode_logic_rlt_state_2_states___root = 4));
  V86_rlt_enter_microwave_mode_logic_rlt_state_2_states___root = (if (not (
  V88_chart_microwave_mode_logic_begin_state_states___root = 4)) then 4 else 
  V88_chart_microwave_mode_logic_begin_state_states___root);
  V87_chart_microwave_mode_logic_rlt_evtInitStep = (true -> (if (pre true) then 
  false else (pre V87_chart_microwave_mode_logic_rlt_evtInitStep)));
  V88_chart_microwave_mode_logic_begin_state_states___root = (0 -> (pre 
  V91_chart_microwave_mode_logic_final_state_states___root));
  V89_chart_microwave_mode_logic_begin_state_outports_mode = (0 -> (pre 
  V97_microwave_microwave_mode_logic_mode));
  V90_chart_microwave_mode_logic_begin_state_outports_steps_remaining = (0 -> 
  (pre V93_chart_microwave_mode_logic_steps_remaining));
  V91_chart_microwave_mode_logic_final_state_states___root = (if 
  V87_chart_microwave_mode_logic_rlt_evtInitStep then 
  V86_rlt_enter_microwave_mode_logic_rlt_state_2_states___root else (if ((not 
  ...
  V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root));
  V93_chart_microwave_mode_logic_steps_remaining = (if 
  V87_chart_microwave_mode_logic_rlt_evtInitStep then 
  V90_chart_microwave_mode_logic_begin_state_outports_steps_remaining else (if 
  ...
  ;
  V94_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_MINUTES__QUOTIENT = ((
  V93_chart_microwave_mode_logic_steps_remaining div 1) div 60);
  V95_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT = (((
  V93_chart_microwave_mode_logic_steps_remaining div 1) - (((
  V93_chart_microwave_mode_logic_steps_remaining div 1) div 60) * 60)) div 10);
  V96_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__REMAINDER = (((
  V93_chart_microwave_mode_logic_steps_remaining div 1) - (((
  V93_chart_microwave_mode_logic_steps_remaining div 1) div 60) * 60)) - ((((
  V93_chart_microwave_mode_logic_steps_remaining div 1) - (((
  V93_chart_microwave_mode_logic_steps_remaining div 1) div 60) * 60)) div 10) 
  * 10));
  V97_microwave_microwave_mode_logic_mode = (if 
  V87_chart_microwave_mode_logic_rlt_evtInitStep then (if (not (
  V88_chart_microwave_mode_logic_begin_state_states___root = 4)) then 1 else 
  V89_chart_microwave_mode_logic_begin_state_outports_mode) else (if ((not 
  V81_rlt_eval_microwave_mode_logic_rlt_fired_1) and ((
  V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root >= 1) and (
  V83_rlt_eval_microwave_mode_logic_rlt_state_3_states___root <= 3))) then (if 
  V69_rlt_eval_microwave_mode_logic_ON_rlt_fired_6 then (if (not (
  ...
  V84_rlt_eval_microwave_mode_logic_rlt_state_3_outports_mode));
  V98_MWI_FcnMaxI_In16 = ((pre V43_rlt__Arrow3) - 1);
  V99_MWI_FcnMaxI_In15 = ((pre V44_rlt__Arrow2) - 1);
  V100_MWI_FcnMaxI_In13 = ((pre V41_rlt__Arrow5) - 1);
  V101_MWI_FcnMaxI_In12 = ((pre V42_rlt__Arrow4) - 1);
  V102_MWI_FcnMaxI_In11 = ((pre V45_rlt__Arrow1) - 1);
  V103_MWI_FcnMaxI_In1 = ((pre V46_rlt__Arrow) - 1);
  V104_p3 = (true -> ((if (not V17_SETUP) then (if (V103_MWI_FcnMaxI_In1 > 0) 
  then V103_MWI_FcnMaxI_In1 else 0) else 639) > 0));
  V105_p4 = (true -> ((if (not V18_COOKING) then (if (V102_MWI_FcnMaxI_In11 > 0
  ) then V102_MWI_FcnMaxI_In11 else 0) else 639) > 0));
  V106_p5 = (true -> ((if (not V19_SUSPENDED) then (if (V101_MWI_FcnMaxI_In12 > 
  0) then V101_MWI_FcnMaxI_In12 else 0) else 639) > 0));
  V107_p6 = (true -> ((not V17_SETUP) or ((if (not (not V17_SETUP)) then (if (
  V100_MWI_FcnMaxI_In13 > 0) then V100_MWI_FcnMaxI_In13 else 0) else 639) > 0))
  );
  V108_p7 = (true -> ((not V18_COOKING) or ((if (not (not V18_COOKING)) then 
  (if (V98_MWI_FcnMaxI_In16 > 0) then V98_MWI_FcnMaxI_In16 else 0) else 639) > 
  0)));
  V109_p8 = (true -> ((not V19_SUSPENDED) or ((if (not (not V19_SUSPENDED)) 
  then (if (V99_MWI_FcnMaxI_In15 > 0) then V99_MWI_FcnMaxI_In15 else 0) else 
  639) > 0)));
  V110_p9 = (true -> ((not V18_COOKING) or DOOR_CLOSED));
  V111_p10 = (true -> ((not V18_COOKING) or ((if (not (not V18_COOKING)) then 
  (if (V98_MWI_FcnMaxI_In16 > 0) then V98_MWI_FcnMaxI_In16 else 0) else 639) > 
  0)));
  V112_p11 = ((not KP_CLEAR) or (not V18_COOKING));
  V113_p12 = (
  ...
  V96_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__REMAINDER + (
  V95_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT * 10)) + (
  V94_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_MINUTES__QUOTIENT * 60)) * 
  1))));
  V116_p15 = (
  V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock or (
  V94_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_MINUTES__QUOTIENT = 0));
  V117_p16 = ((not (
  V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock and 
  KP_CLEAR)) or (
  V94_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_MINUTES__QUOTIENT = 0));
  ...
  V94_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_MINUTES__QUOTIENT = (pre 
  V95_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT)))));
  V119_p18 = (((not (
  V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock and (not 
  KP_CLEAR))) or ((not (((((((((KP_1 or KP_2) or KP_3) or KP_4) or KP_5) or 
  ...
  V121_p20 = (
  V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock or (
  V95_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT = 0));
  V122_p21 = ((not (
  V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock and 
  KP_CLEAR)) or (
  V95_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT = 0));
  ...
  (not (pre KP_7)))) or (KP_8 and (not (pre KP_8)))) or (KP_9 and (not (pre 
  KP_9)))) or (KP_0 and (not (pre KP_0)))))) or (
  V95_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT = (pre 
  V96_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__REMAINDER))));
  V124_p23 = (true -> (((not (
  V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock and (not 
  KP_CLEAR))) or (not ((((((((((KP_1 and (not (pre KP_1))) or (KP_2 and (not 
  ...
  V126_p25 = (
  V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock or (
  V96_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__REMAINDER = 0));
  V127_p26 = ((not (
  V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock and 
  KP_CLEAR)) or (
  V96_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__REMAINDER = 0));
  ...
  (pre KP_2)))) and ((not (KP_1 and (not (pre KP_1)))) and (not (KP_0 and (not 
  (pre KP_0)))))))))) or (
  V96_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__REMAINDER = 5))));
  V134_p33 = (true -> ((not (
  V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock and (not 
  ...
  (pre KP_3)))) and ((not (KP_2 and (not (pre KP_2)))) and ((not (KP_1 and (not 
  (pre KP_1)))) and (not (KP_0 and (not (pre KP_0))))))))))) or (
  V96_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__REMAINDER = 6))));
  V135_p34 = (true -> ((not (
  V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock and (not 
  ...
  (pre KP_2)))) and ((not (KP_1 and (not (pre KP_1)))) and (not (KP_0 and (not 
  (pre KP_0)))))))))))) or (
  V96_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__REMAINDER = 7))));
  V136_p35 = (true -> ((not (
  V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock and (not 
  ...
  (pre KP_3)))) and ((not (KP_2 and (not (pre KP_2)))) and ((not (KP_1 and (not 
  (pre KP_1)))) and (not (KP_0 and (not (pre KP_0))))))))))))) or (
  V96_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__REMAINDER = 8))));
  V137_p36 = (true -> ((not (
  V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock and (not 
  ...
  (pre KP_2)))) and ((not (KP_1 and (not (pre KP_1)))) and (not (KP_0 and (not 
  (pre KP_0)))))))))))))) or (
  V96_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__REMAINDER = 9))));
  V138_p37 = (true -> ((not (
  V26_rlt_condact_resetmicrowave_microwave_KEYPAD_PROCESSING_rlt_clock and (not 
  KP_CLEAR))) or (((((((((((KP_1 and (not (pre KP_1))) or (KP_2 and (not (pre 
  KP_2)))) or (KP_3 and (not (pre KP_3)))) or (KP_4 and (not (pre KP_4)))) or (
  ...
  (pre KP_7)))) or (KP_8 and (not (pre KP_8)))) or (KP_9 and (not (pre KP_9)))) 
  or (KP_0 and (not (pre KP_0)))) or (
  V96_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__REMAINDER = (pre 
  V96_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__REMAINDER)))));
  V139_rltTruncByConv2 = ((
  V96_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__REMAINDER >= 0) and 
  (V96_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__REMAINDER <= 256));
  V140_rltTruncByConv1 = ((
  V95_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT >= 0) and (
  V95_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT <= 256));
  V141_rltTruncByConv = ((
  V94_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_MINUTES__QUOTIENT >= 0) 
  and (V94_microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_MINUTES__QUOTIENT <= 
  256));
  --%PROPERTY OK=true;
