...
let
  OK = (true -> ((not V17_SETUP) or ((if (not (not V17_SETUP)) then (if (
  ...
  * 10));
  ...
  V103_p7 = (true -> ((not V18_COOKING) or ((if (not (not V18_COOKING)) then 
  (if (V97_MWI_FcnMaxI_In16 > 0) then V97_MWI_FcnMaxI_In16 else 0) else 639) > 
  0)));
  V104_p8 = (true -> ((not V19_SUSPENDED) or ((if (not (not V19_SUSPENDED)) 
  then (if (V98_MWI_FcnMaxI_In15 > 0) then V98_MWI_FcnMaxI_In15 else 0) else 
  639) > 0)));
  V105_p9 = (true -> ((not V18_COOKING) or DOOR_CLOSED));
  V106_p10 = (true -> ((not V18_COOKING) or ((if (not (not V18_COOKING)) then 
  (if (V97_MWI_FcnMaxI_In16 > 0) then V97_MWI_FcnMaxI_In16 else 0) else 639) > 
  0)));
  V107_p11 = ((not KP_CLEAR) or (not V18_COOKING));
  V108_p12 = (
