...
let
  OK = (V71_env => ((((((((not V70_erreur_ticket3i) and (0 <= V62_p1)) and (
  V62_p1 <= 3)) and (0 <= V63_p2)) and (V63_p2 <= 3)) and (0 <= V64_p3)) and (
  V64_p3 <= 3)) and (((V62_p1 + V63_p2) + V64_p3) <= 9)));
  ...
  V71_env = (V164_X -> (V164_X and (pre V71_env)));
