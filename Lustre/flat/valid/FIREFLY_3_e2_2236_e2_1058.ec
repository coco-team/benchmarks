...
let
  ...
  (if e5 then (if V116_garde5 then (pre 0) else (pre V54_shared)) else (if e7 
  then (if V118_garde7 then ((pre V54_shared) + 2) else (pre V54_shared)) else 
  (if e8 then (if V119_garde8 then (((pre V54_shared) + (pre V53_exclusive)) + 
