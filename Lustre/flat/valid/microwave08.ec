...
let
  OK = (true -> ((if (not V19_SUSPENDED) then (if (V100_MWI_FcnMaxI_In12 > 0) 
  then V100_MWI_FcnMaxI_In12 else 0) else 639) > 0));
  ...
  * 10));
  ...
  V103_p6 = (true -> ((not V17_SETUP) or ((if (not (not V17_SETUP)) then (if (
  V99_MWI_FcnMaxI_In13 > 0) then V99_MWI_FcnMaxI_In13 else 0) else 639) > 0)));
  V104_p7 = (true -> ((not V18_COOKING) or ((if (not (not V18_COOKING)) then 
  (if (V97_MWI_FcnMaxI_In16 > 0) then V97_MWI_FcnMaxI_In16 else 0) else 639) > 
  0)));
  V105_p8 = (true -> ((not V19_SUSPENDED) or ((if (not (not V19_SUSPENDED)) 
  then (if (V98_MWI_FcnMaxI_In15 > 0) then V98_MWI_FcnMaxI_In15 else 0) else 
  639) > 0)));
  V106_p9 = (true -> ((not V18_COOKING) or DOOR_CLOSED));
  V107_p10 = (true -> ((not V18_COOKING) or ((if (not (not V18_COOKING)) then 
  (if (V97_MWI_FcnMaxI_In16 > 0) then V97_MWI_FcnMaxI_In16 else 0) else 639) > 
  0)));
  V108_p11 = ((not KP_CLEAR) or (not V18_COOKING));
  V109_p12 = (
