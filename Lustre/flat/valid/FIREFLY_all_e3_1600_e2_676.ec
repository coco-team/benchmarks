...
let
  ...
  e5 then (if V117_garde5 then (pre 0) else (pre V54_shared)) else (if e7 then 
  (if V119_garde7 then ((pre V54_shared) + 2) else (pre V54_shared)) else (if 
  e8 then (if V120_garde8 then (((pre V54_shared) + (pre V53_exclusive)) + 1) 
