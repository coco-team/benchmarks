...
let
  OK = (V55_env => (((((true -> ((((V51_invalid + V52_dirty) + V53_exclusive) + 
  V54_shared) = (pre (((V51_invalid + V52_dirty) + V53_exclusive) + V54_shared)
  ))) and ((((V51_invalid + V52_dirty) + V53_exclusive) + V54_shared) = 
  V160_First)) and ((((V51_invalid + V52_dirty) + V53_exclusive) + V54_shared) 
  <= V56_procs)) and (V51_invalid >= 0)) and (V51_invalid <= V56_procs)));
  ...
  (if e5 then (if V117_garde5 then (pre 0) else (pre V54_shared)) else (if e7 
  then (if V119_garde7 then ((pre V54_shared) + 2) else (pre V54_shared)) else 
  (if e8 then (if V120_garde8 then (((pre V54_shared) + (pre V53_exclusive)) + 
  ...
  V160_First = (i_invalid -> (pre V160_First));
  --%PROPERTY OK;
