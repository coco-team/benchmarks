...
let
  OK = ((not ((V11_mode = 1) or (V11_mode = 2))) or ((
  V103_chart_CruiseController_ModeLogic_mode_logic_setDesiredSpeed = 1) = 
  V109_cruise_controller_CruiseController_SetDesiredSpeed_setDesiredSpeed));
  V11_mode = (if 
