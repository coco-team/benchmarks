...
let
  ...
  V67_X1 = (1 -> (if e01 then (if V138_g01 then ((pre V67_X1) - 1) else (pre 
  V67_X1)) else (pre V67_X1)));
  V68_X2 = (0 -> (if e01 then (if V138_g01 then ((pre V68_X2) + 1) else (pre 
  V68_X2)) else (if e02 then (if V139_g02 then ((pre V68_X2) - 1) else (pre 
  V68_X2)) else (if e12 then (if V149_g12 then ((pre V68_X2) + 1) else (pre 
  V68_X2)) else (pre V68_X2)))));
  V69_X3 = (0 -> (if e02 then (if V139_g02 then ((pre V69_X3) + 1) else (pre 
  V69_X3)) else (if e03 then (if V140_g03 then ((pre V69_X3) - 1) else (pre 
  V69_X3)) else (pre V69_X3))));
  V70_X4 = (0 -> (if e03 then (if V140_g03 then ((pre V70_X4) + 1) else (pre 
  V70_X4)) else (if e04 then (if V141_g04 then ((pre V70_X4) - 1) else (pre 
  V70_X4)) else (if e05 then (if V142_g05 then ((pre V70_X4) - 1) else (pre 
  V70_X4)) else (pre V70_X4)))));
  V71_X5 = (0 -> (if e04 then (if V141_g04 then ((pre V71_X5) + 1) else (pre 
  V71_X5)) else (if e06 then (if V143_g06 then ((pre V71_X5) - 1) else (pre 
  V71_X5)) else (pre V71_X5))));
  V72_X6 = (0 -> (if e06 then (if V143_g06 then ((pre V72_X6) + 1) else (pre 
  V72_X6)) else (if e07 then (if V144_g07 then ((pre V72_X6) - 1) else (pre 
  V72_X6)) else (if e08 then (if V145_g08 then ((pre V72_X6) - 1) else (pre 
  V72_X6)) else (if e09 then (if V146_g09 then ((pre V72_X6) - 1) else (pre 
  V72_X6)) else (pre V72_X6))))));
  V73_X7 = (0 -> (if e08 then (if V145_g08 then ((pre V73_X7) + 1) else (pre 
  V73_X7)) else (if e10 then (if V147_g10 then ((pre V73_X7) - 1) else (pre 
  V73_X7)) else (pre V73_X7))));
  V74_X8 = (0 -> (if e09 then (if V146_g09 then ((pre V74_X8) + 1) else (pre 
  V74_X8)) else (if e11 then (if V148_g11 then ((pre V74_X8) - 1) else (pre 
  V74_X8)) else (pre V74_X8))));
  V75_X9 = (0 -> (if e05 then (if V142_g05 then ((pre V75_X9) + 1) else (pre 
  V75_X9)) else (if e07 then (if V144_g07 then ((pre V75_X9) + 1) else (pre 
  V75_X9)) else (if e10 then (if V147_g10 then ((pre V75_X9) + 1) else (pre 
  V75_X9)) else (if e11 then (if V148_g11 then ((pre V75_X9) + 1) else (pre 
  V75_X9)) else (if e12 then (if V149_g12 then ((pre V75_X9) - 1) else (pre 
  V75_X9)) else (pre V75_X9)))))));
  V76_erreur = (if (V67_X1 >= 2) then true else false);
  V138_g01 = ((pre V67_X1) >= 1);
  V139_g02 = ((pre V68_X2) >= 1);
  V140_g03 = ((pre V69_X3) >= 1);
  V141_g04 = ((pre V70_X4) >= 1);
  V142_g05 = ((pre V70_X4) >= 1);
  V143_g06 = ((pre V71_X5) >= 1);
  V144_g07 = ((pre V72_X6) >= 1);
  V145_g08 = ((pre V72_X6) >= 1);
  V146_g09 = ((pre V72_X6) >= 1);
  V147_g10 = ((pre V73_X7) >= 1);
  V148_g11 = ((pre V74_X8) >= 1);
  V149_g12 = ((pre V75_X9) >= 1);
