...
let
  OK = (V75_env => ((((not V74_erreur) and (true -> (((((V69_exclusive + 
  V70_shared) + V71_shared_dirty) + V72_dirty) + V73_invalid) = (pre ((((
  V69_exclusive + V70_shared) + V71_shared_dirty) + V72_dirty) + V73_invalid)))
  )) and (((((V69_exclusive + V70_shared) + V71_shared_dirty) + V72_dirty) + 
  V73_invalid) = V185_First)) and (V69_exclusive >= 0)));
  ...
  = 0));
  V141_g02 = (((pre V73_invalid) >= 1) and ((((((pre V72_dirty) - (pre 
  V70_shared)) + 1) + (pre V69_exclusive)) + (pre V71_shared_dirty)) >= 1));
