...
let
  ...
  (if e5 then (if V106_garde5 then (pre 0) else (pre V51_shared)) else (if e7 
  then (if V108_garde7 then ((pre V51_shared) + 2) else (pre V51_shared)) else 
  (if e8 then (if V109_garde8 then (((pre V51_shared) + (pre V50_exclusive)) + 
